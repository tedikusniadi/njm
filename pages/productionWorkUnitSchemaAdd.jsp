...
<html>
<head>
	<title>Work Unit Schema >> Add</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Accounting Setting > Accounting Schema > Work Unit Schema > Add</td>
				...
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F70 - Work Unit Schema</h1>
					  	...
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/accountingschemapreedit.htm?id=${work_unit_schema_add.schema.id}'/>"><span>List</span></a>
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="work_unit_schema_add">
