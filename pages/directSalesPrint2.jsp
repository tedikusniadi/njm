                                ...
                                <td colspan="6" class="CSS">
                                  <table width="100%"  border="0" cellpadding="3" cellspacing="0" bordercolor="#000000" style="border:1px solid black;">
                                    ...
                                    <tr class="CSS1" style="font-weight:normal;">
                                      ...
                                      <td class="borderRightBottom">&nbsp;<c:out value='${item.barang}'/></td>
                                      <td align="center" class="borderRightBottom">&nbsp;<c:out value='${item.uom}'/></td>
                                      <td align="right" class="borderRightBottom">&nbsp;<fmt:formatNumber value='${item.jumlah}' pattern=',##0.00'/>&nbsp;</td>
                                      <td align="right" class="borderRightBottom">&nbsp;<fmt:formatNumber value='${item.harga}' pattern=',##0.00'/>&nbsp;</td>
                                      <td align="right" class="borderBottom">&nbsp;<fmt:formatNumber value='${item.jumlah*item.harga}' pattern=',##0.00'/>&nbsp;</td>
                                    </tr>   
									</c:forEach>                                    
									<tr class="CSS1">
