...
<html>
<head>
	<title>Transport Outsource Route Price >> Add</title>
	...
	<script type="text/javascript">
		function save()
		{		
			document.addForm.action = "<c:url value='/page/transportoutsourceroutepriceadd.htm'/>";
			document.addForm.submit();
		}
		
		function savenew()
		{		
			document.addForm.action = "<c:url value='/page/transportoutsourceroutepriceaddnew.htm?id=${price.route.id}'/>";
			document.addForm.submit();
		}
				...
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">D10 - Transport Outsource Route Price</h1>
					  	...
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/transportoutsourceroutepreedit.htm?id=${price.route.id}'/>"><span>List</span></a>
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="price">
                                ...
                                <tr>
									<td width="32%" nowrap="nowrap" align="right">Shipment Fee :</td>
