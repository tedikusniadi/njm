...
<html>
<head>
	<title>Master Cost Schema >> Edit</title>
	...
	<script type="text/javascript">
		function save()
		{		
			document.addForm.action = "<c:url value='/page/transportoutsourcemastercostaccountingschemaedit.htm'/>";
					...
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="masterCostSchema">
                                ...
                                <tr>
									<td width="28%" align="right" nowrap="nowrap">Name :</td>
						  		  <td width="51%"><form:input path='name' disabled='true' cssClass='input-disabled' size='50'/></td>
                                    <td width="21%">&nbsp;</td>
								</tr>
                                <tr>
									<td width="28%" align="right" nowrap="nowrap">Accounting Schema :</td>
			  		  <td>
