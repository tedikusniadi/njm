...
<div id="se-containers">
	...
	<div id="se-navigator">
        ...
        <tr>
            <td width="60%">Tools > Audit Trail</td>
			...
			<div id="r13">
				<div id="r14">
					...
					<!-- main contents goes here -->
						...
						<h1 class="page-title">T30 - Audit Trail</h1>
						...
						<div class="item-navigator">
							...
							<tr>
								...
								<td width="77%" align="right" height="20"><a href="javascript:step('first');">First</a> | <a href="javascript:step('prev');">Prev</a> | Page <c:out value="${filterCriteria.page}"/> of <c:out value="${filterCriteria.totalPage}"/> | <a href="javascript:step('next');">Next</a> | <a href="javascript:step('last');">Last</a></td>
							</tr>
							</table>
					  	</div>
                        <table class="table-list" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <th width="18%" scope="col" align="left">Date &amp; Time</th>
                            <th width="17%" scope="col" align="left">Menu</th>
                            <th width="19%" scope="col" align="left">ID</th>
                            <th width="12%" scope="col" align="left">Action</th>
                            <th width="34%" scope="col" align="left">Person in Charge</th>
                        </tr>
