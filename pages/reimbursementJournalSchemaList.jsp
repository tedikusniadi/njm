...
<html>
<head>
	<title>Reimbursement Journal Schema</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">	
		...
		<tr>
			<td width="60%">Financial Accounting > Accounting Setting > Reimbursement Journal Schema > List</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
							  ...
							  <table border="0" cellpadding="0" cellspacing="0" width="99%" align="center">
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
										<a class="item-button-new" href="<c:url value='/page/reimbursementjournalschemapreadd.htm' />"><span>New Schema</span></a>
						...
						<table width="90%" cellpadding="0" cellspacing="0" class="table-list">
						<tr>
						...
						<tr>
						 	<td class="tools">
                            	 <c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/reimbursementjournalschemapreedit.htm?id=${schema.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test='${access.delete}'>
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/reimbursementjournalschemadelete.htm?id=${schema.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
						 	</td>
						 	<td>${schema.code}</td>
							<td>${schema.name}</td>
