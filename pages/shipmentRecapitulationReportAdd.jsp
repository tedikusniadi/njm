...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Transport Outsource > Transport Outsource Reports > Shipment Recapitulation</td>
...
<script type="text/javascript">
	function generate()
	{
		document.reportForm.action = "<c:url value='/page/shipmentrecapitulationreportview.htm'/>";
