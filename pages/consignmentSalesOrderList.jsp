...
<html>
<head>
	<title>Consignment Sales Order >> Home</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Sales > Consignment Order > Consignment Sales Order</td>
							...
							<tr>
							  ...
							  <div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/consignmentsalesorderpreadd1.htm'/>"><span>New Consignment Sales Order</span></a>
                                        </c:if>
							  ...
							  <td width="46%" align="right" height="20"><a href="javascript:step('first');">First</a> | <a href="javascript:step('prev');">Prev</a> | Page 
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/consignmentsalesorderpreedit.htm?id=${order.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
							</td>
