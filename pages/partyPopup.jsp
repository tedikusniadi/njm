				...
				<div id="r14">
					<div id="se-contents">
								...
								<form id="filterForm" name="filterForm" method="post">
									<table width="100%" cellspacing="0" cellpadding="0" align="center">
										<tr>
											...
											<td align="left"><input type="button" value="Search" style="WIDTH:60px; HEIGHT:25px" alt="Search" onclick="search('<c:url value='/page/popuppartyview.htm?target=${target}'/>');" class="btn" /></td>
										</tr>
									</table>
								</form>
							</td>
						...
						<tr>
							...
							<td width="66%" align="right" height="20"><a href="javascript:step('first','<c:url value='/page/popuppartyview.htm?target=${target}&name=${filterCriteria.name}&partyRole=${filterCriteria.partyRole}&type=${filterCriteria.type}'/>');">First</a> | <a href="javascript:step('prev','<c:url value='/page/popuppartyview.htm?target=${target}&name=${filterCriteria.name}&partyRole=${filterCriteria.partyRole}&type=${filterCriteria.type}'/>');">Prev</a> | Page <c:out value="${filterCriteria.page}"/> of <c:out value="${filterCriteria.totalPage}"/> | <a href="javascript:step('next','<c:url value='/page/popuppartyview.htm?target=${target}&name=${filterCriteria.name}&partyRole=${filterCriteria.partyRole}&type=${filterCriteria.type}'/>');">Next</a> | <a href="javascript:step('last','<c:url value='/page/popuppartyview.htm?target=${target}&name=${filterCriteria.name}&partyRole=${filterCriteria.partyRole}&type=${filterCriteria.type}'/>');">Last</a></td>
						</tr>
						</table>
