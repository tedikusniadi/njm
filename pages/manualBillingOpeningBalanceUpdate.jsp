...
<html>
<head>
	<title>Manual Billing (Opening Balance) &gt;&gt; Edit</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Account Receivable > Manual Billing (Opening Balance) > Edit</td>
					...
					<div id="se-contents">
						...
						<h1 class="page-title">F82 - Manual Billing (Opening Balance) </h1>
					  	...
					  	<div class="toolbar">
                            ...
                            <c:if test="${manual_billing_openingbalance_edit.pph == null and manual_billing_openingbalance_edit.status != 'PAID' and not empty manual_billing_openingbalance_edit.journalEntry}">
								<a class="item-button-cancel" href="<c:url value='/page/pphpreadd.htm?id=${manual_billing_openingbalance_edit.id}'/>"><span>PPH</span></a>
                            </c:if>
                             <c:if test='${access.edit}'>
								<a class="item-button-credit-memo" href="<c:url value='/page/creditmemopreadd1.htm?id=${manual_billing_openingbalance_edit.id}'/>"><span>Credit Memo</span></a>
                            </c:if>
                            <c:if test='${access.print}'>
								<a class="item-button-print" href="<c:url value='/page/billingprintoption.htm?id=${manual_billing_openingbalance_edit.id}'/>"><span>Print</span></a>
                            </c:if>
					  	</div>
					  
						<div class="main-box">
							<form:form id="editForm" name="editForm" method="post" modelAttribute="manual_billing_openingbalance_edit">
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                	<td width="538" valign="top" align="left">
                                        ...
                                        <tr>
                                            <td width="30%" nowrap="nowrap" align="right">ID :</td>
                                       	  	<td width="70%"><input value="${manual_billing_openingbalance_edit.code}" class='input-disabled' size='25'/></td>
                                        </tr>
                                        <tr>
                                            <td width="30%" nowrap="nowrap" align="right">Legend :</td>
                                       	  	<td width="70%"><input value="${manual_billing_openingbalance_edit.legend}" class='input-disabled' size='30'/></td>
                                        </tr>
                                        <tr>
                                            <td nowrap="nowrap" align="right">Company :</td>
                                            <td>
                                                <form:select id="org" path="organization" cssClass="combobox-ext" disabled='true'>
                                                   <form:option value='${manual_billing_openingbalance_edit.organization.id}' label='${manual_billing_openingbalance_edit.organization.firstName} ${manual_billing_openingbalance_edit.organization.lastName} ${manual_billing_openingbalance_edit.organization.middleName}' />
                                                </form:select>
                                            </td>
                                        </tr>
                                        <tr>
                                          ...
                                          <td>
                                                <form:select id="address" path="taxAddress" cssClass="combobox-ext" disabled='true'>
                                                    <form:option value='${manual_billing_openingbalance_edit.taxAddress.id}' label='${manual_billing_openingbalance_edit.taxAddress.address}' />
                                                </form:select>										  
										  </td>
                                        </tr>
                                        <tr>
                                          ...
                                          <td>
										        <form:select id="accounts" path="bankAccount" cssClass="combobox-ext" disabled='true'>
                                                    <form:option value='' label='${manual_billing_openingbalance_edit.bankAccount.code}' />
                                                </form:select>	
										  </td>
                                        </tr>
                                        <tr>
                                            <td nowrap="nowrap" align="right">Date :</td>
                                            <td><input class="input-disabled" disabled size="15" value="<fmt:formatDate value='${manual_billing_openingbalance_edit.date}' pattern='dd-MM-yyyy'/>"/></td>
                                        </tr>
                                        <tr>
                                            <td nowrap="nowrap" align="right">Billing Type :</td>
                                       	  	<td><input value="${manual_billing_openingbalance_edit.billingType.name}" class='input-disabled' size='25'/></td>
                                        </tr>
                                        <tr>
                                            <td nowrap="nowrap" align="right">Customer :</td>
                                            <td>
                                                <form:select id="customer" path="customer" cssClass="combobox-ext" disabled='true'>
                                                    <form:option value='${manual_billing_openingbalance_edit.customer.id}' label='${manual_billing_openingbalance_edit.customer.firstName} ${manual_billing_openingbalance_edit.customer.lastName} ${manual_billing_openingbalance_edit.customer.middleName}' />
                                                </form:select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">Credit Term :</td>
                                            <td><input size="7" class="input-disabled" disabled value="${manual_billing_openingbalance_edit.creditTerm.term}"/>&nbsp;Days</td>
                                        </tr>
                                        <tr>
                                            <td align="right">Tax :</td>
                                            <td>
                                                <form:select path='tax' disabled='true'>
                                                    <form:option value='${manual_billing_openingbalance_edit.tax.id}' label='${manual_billing_openingbalance_edit.tax.taxId}'/>
                                                </form:select>
                                                &nbsp;
                                                <input size="7" id="taxRate" class="input-disabled" disabled value="<fmt:formatNumber value='${manual_billing_openingbalance_edit.tax.taxRate}' pattern=',##0.00'/>"/>
                                            </td>
                                        </tr>
                                                                                <%-- <tr>
                                            ...
                                            <td>
                                                <form:select path='extTax1' disabled='true'>
                                                    <form:option value='${manual_billing_openingbalance_edit.extTax1.id}' label='${manual_billing_openingbalance_edit.extTax1.taxId}'/>
                                                </form:select>
                                                &nbsp;
                                                <input size="7" id="taxRate" class="input-disabled" disabled value="${manual_billing_openingbalance_edit.extTax1.taxRate}"/>
                                            </td>
                                        </tr>
                                                                                <tr>
                                            ...
                                            <td>
                                                <form:select path='extTax2' disabled='true'>
                                                    <form:option value='${manual_billing_openingbalance_edit.extTax2.id}' label='${manual_billing_openingbalance_edit.extTax2.taxId}'/>
                                                </form:select>
                                                &nbsp;
                                                <input size="7" id="taxRate" class="input-disabled" disabled value="${manual_billing_openingbalance_edit.extTax2.taxRate}"/>
                                            </td>
                                        </tr> --%>
                                        <tr>
                                            ...
                                            <td>
                                                <form:select path='currency' disabled='true'>
                                                    <form:option value='${manual_billing_openingbalance_edit.currency.id}' label='${manual_billing_openingbalance_edit.currency.symbol}'/>
                                                </form:select>
                                                &nbsp;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form:select id="taxcode" path="taxNumber.invoiceTax" cssClass="combobox">
                                                    <c:if test='${not empty manual_billing_openingbalance_edit.taxNumber.invoiceTax}'>
                                                        <form:option value='${manual_billing_openingbalance_edit.taxNumber.invoiceTax.id}' label='${manual_billing_openingbalance_edit.taxNumber.invoiceTax.code}' />
                                                    </c:if>
                                                </form:select>
                                                <c:if test='${manual_billing_openingbalance_edit.taxNumber.invoiceTax == null}'>
                                                &nbsp;
                                                <img src="assets/icons/list_extensions.gif" onclick="javascript:openpopup('<c:url value='/page/popupinvoicetaxview.htm?target=taxcode&organization=${manual_billing_openingbalance_edit.organization.id}'/>');" style="CURSOR:pointer;" title="Invoice Tax Code" />
                                                </c:if>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">Rounding :</td>
                                            <td><input class='input-disabled' value="<fmt:formatNumber value='${manual_billing_openingbalance_edit.rounding}' pattern=',##0.00'/>" disabled size='10'/></td>
                                        </tr>
                                        <%-- <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:select id="signer" path="signer" cssClass="combobox-ext" disabled='true'>
                                                    <c:if test='${not empty manual_billing_openingbalance_edit.signer}'>
                                                        <form:option value='${manual_billing_openingbalance_edit.signer.id}' label='${manual_billing_openingbalance_edit.signer.firstName} ${manual_billing_openingbalance_edit.signer.lastName} ${manual_billing_openingbalance_edit.signer.middleName}' />
                                                    </c:if>
                                                </form:select>
                                            </td>
                                        </tr>
    					    					...
    					    					<fieldset>
                                                    ...
                                                    <tr>
                                                    	<td width="42%" align="right">Credit Memo :</td>
                                               	  		<td width="58%">
                                   	  					  <c:forEach items='${manual_billing_openingbalance_edit.creditMemos}' var='memo'>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<c:url value='/page/pphpreedit.htm?id=${manual_billing_openingbalance_edit.pph.id}'/>"><c:out value='${manual_billing_openingbalance_edit.pph.code}'/></a></td>
                                                    </tr>
                                                    <tr>
                                                    	<td align="right">Journal :</td>
                                                        <td><a href="<c:url value='/page/journalentrypreedit.htm?id=${manual_billing_openingbalance_edit.journalEntry.id}'/>"><c:out value='${manual_billing_openingbalance_edit.journalEntry.code}'/></a></td>
                                                    </tr>
                                                    </table>
                                                </fieldset>
                                          	</td>
   	    								...
   	    								<fieldset>
                                               	<legend><strong>Receipt Information</strong></legend>
                                                    ...
                                                    <tr>
                                                    	<td width="55%">&nbsp;</td>
                                                        <td width="1%">&nbsp;</td>
                                                      	<td width="45%" align="right"><strong><font size="+1">${manual_billing_openingbalance_edit.status}</font></strong></td>
                                                    </tr>
                                                    <tr>
                                                    	<td>Unpaid Amount</td>
                                                        <td width="1%">:</td>
                                        ...
                                        <tr>
                                        	<td valign="top" align="left" colspan="2">
                                            	<fieldset>
                                                    ...
                                                    <tr>
                                                    	<td>&nbsp;</td>
                                                        <td align="center"><strong>Amount (<c:out value='${manual_billing_openingbalance_edit.currency.symbol}'/>)</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="35%">
			  								<form:select path='customerbillingAddress' cssClass='combobox-ext' disabled='true'>
                                            	<option><c:out value='${manual_billing_openingbalance_edit.customerbillingAddress.address}'/></option>
                                            </form:select>
                               	  	  	</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                        	<form:select path='customerTaxAddress' cssClass='combobox-ext' disabled='true'>
                                            	<option><c:out value='${manual_billing_openingbalance_edit.customerTaxAddress.address}'/></option>
                                            </form:select>
                                        </td>
                                    </tr>
                                    <tr>
                                    	<td width="13%" align="right">Sales : </td>
                                  		<td width="38%">
						  					<form:select id="sales" path="sales" cssClass="combobox-ext" disabled='true'>
                                                <c:if test='${not empty manual_billing_openingbalance_edit.sales}'>
                                                    <form:option value='${manual_billing_openingbalance_edit.sales.id}' label='${manual_billing_openingbalance_edit.sales.firstName} ${manual_billing_openingbalance_edit.sales.lastName} ${manual_billing_openingbalance_edit.sales.middleName}' />
                                                </c:if>
                                            </form:select>
                                      </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form:select id="representative" path="representative" cssClass="combobox-ext" disabled='true'>
                                                <c:if test='${not empty manual_billing_openingbalance_edit.representative}'>
                                                    <form:option value='${manual_billing_openingbalance_edit.representative.id}' label='${manual_billing_openingbalance_edit.representative.firstName} ${manual_billing_openingbalance_edit.representative.lastName} ${manual_billing_openingbalance_edit.representative.middleName}' />
                                                </c:if>
                                            </form:select>
                                        </td>
                                    </tr>
		                            <tr>
                                        ...
                                        <td>
                                            <form:select id="contactPerson" path="customerContactPerson" cssClass="combobox-ext" disabled='true'>
                                                <form:option value='' label='${manual_billing_openingbalance_edit.customerContactPerson.firstName} ${manual_billing_openingbalance_edit.customerContactPerson.middleName} ${manual_billing_openingbalance_edit.customerContactPerson.lastName}' />
                                            </form:select>	
                                        </td>
                                    </tr>							
                                    </table>
                                ...
                                <div id="line" dojoType="ContentPane" label="Line Item" class="tab-pages" refreshOnShow="true" selected='true'>
                                    ...
                                    <tbody>
                                    <c:forEach items="${manual_billing_openingbalance_edit.lineItems}" var="line" varStatus='status'>
                                    <tr>
                                    ...
                                    <tr>
										<td width="41%" nowrap="nowrap" align="right">Collector Name :</td>
                                        	...
                                        	<form:select id="collector" path='collectingStatus.collector' cssClass='combobox-ext'>
                                            	<c:if test='${not empty manual_billing_openingbalance_edit.collectingStatus.collector}'>
                                                	<form:option value='${manual_billing_openingbalance_edit.collectingStatus.collector.id}' label='${manual_billing_openingbalance_edit.collectingStatus.collector.firstName} ${manual_billing_openingbalance_edit.collectingStatus.collector.middleName} ${manual_billing_openingbalance_edit.collectingStatus.collector.lastName}'/>
                                                </c:if>
                                            </form:select>
                                            &nbsp;
											<img src="assets/icons/list_extensions.gif" onclick="javascript:openpopup('<c:url value='/page/popupcollectorview.htm?target=collector&organization=${manual_billing_openingbalance_edit.organization.id}'/>');" style="CURSOR:pointer;" title="Collector" />
                                        </td>
									</tr>
                                    <tr>
										<td width="41%" nowrap="nowrap" align="right">Billing Acceptance Date :</td>
							  	  		<td width="59%"><input id="collectingStatus.acceptanceDate" name="collectingStatus.acceptanceDate" value="${manual_billing_openingbalance_edit.collectingStatus.acceptanceDate}" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
									</tr>
                                    <tr>
										<td width="41%" nowrap="nowrap" align="right">Billing Due Date :</td>
							  	  		<td width="59%"><input value="<fmt:formatDate value='${manual_billing_openingbalance_edit.collectingStatus.dueDate}' pattern='dd-MM-yyyy'/>" class='input-disabled' size='20'/></td>
									</tr>
                                    </table>
                                </div>
                                <div id="event" dojoType="ContentPane" label="Collecting Event" class="tab-pages" refreshOnShow="true">
                                    <div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
                                        	<a class="item-button-new" href="<c:url value='/page/billingcollectingeventpreadd.htm?id=${manual_billing_openingbalance_edit.id}'/>"><span>New Event</span></a>
                                        </c:if>
                                    ...
                                    <c:forEach items="${manual_billing_openingbalance_edit.events}" var="event">
                                    <tr>
                                    	<td class="tools">
						...
						<div class="info">Created by : <c:out value='${manual_billing_openingbalance_edit.createdBy.firstName} ${manual_billing_openingbalance_edit.createdBy.middleName} ${manual_billing_openingbalance_edit.createdBy.lastName}'/> (<fmt:formatDate value='${manual_billing_openingbalance_edit.createdDate}' pattern='dd-MM-yyyy HH:mm:ss'/>) | Last update by : <c:out value='${manual_billing_openingbalance_edit.updatedBy.firstName} ${manual_billing_openingbalance_edit.updatedBy.middleName} ${manual_billing_openingbalance_edit.updatedBy.lastName}'/> (<fmt:formatDate value='${manual_billing_openingbalance_edit.updatedDate}' pattern='dd-MM-yyyy HH:mm:ss'/>)</div>	
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	function save()
	{		
		document.editForm.action = "<c:url value='/page/manualbillingopeningbalanceedit.htm'/>";
