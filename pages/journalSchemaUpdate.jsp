...
<html>
<head>
	<title>Journal Schema >> Edit</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Accounting Setting > Journal Schema > Edit</td>
				...
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F06 - Journal Schema</h1>
					  	...
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/standardjournalschemaview.htm'/>"><span>List</span></a>
