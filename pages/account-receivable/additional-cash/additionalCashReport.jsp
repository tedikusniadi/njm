...
<html>
<head>
	<title>Additional Cash Report</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<div class="area" dojoType="Container" id="quick_link_container">
			...
			<tr>
				<td width="60%">Financial Accounting > Account Receivables > AR Report > Additional Cash Report </td>
		...
		<div id="r12">
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">
							<h1 class="page-title">F43 - Additional Cash Report<br>
							</h1>
						
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/additionalcashreportprepare.htm'/>"><span>Back</span></a>
								<a class="item-button-print" href="javascript:window.print();"><span>Print</span></a>
                            	<a class="item-button-export-xls" href="<c:url value='/page/additionalcashreportexcel.xls?org=${organization.id}&from='/><fmt:formatDate value='${from}' pattern='dd-MM-yyyy' />&to=<fmt:formatDate value='${to}' pattern='dd-MM-yyyy' />"><span>Export</span></a>
					  		</div>
						</div>
						
						<div class="main-box">
                            <div class="main_container">
                            	<div class="report"><strong>ADDITIONAL CASH REPORT</strong></div>
                            	</br>
                                <div class="report">
                                   <table width="498">	
                                    <tr>	
                                ...
                                <tr style="height: 30px">
                                  ...
                                  <th width="70" align="left" style="border-bottom:1px solid black;border-top:1px solid black;">Jumlah</th>
                                ...
                                <td align="left"><c:out value='${report.number}'/></td>
                                <td align="left"><fmt:formatNumber value='${report.total}' pattern='#,###.00'/></td>
