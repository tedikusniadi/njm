			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                        ...
                        <div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute='additional_cash'>
...
<script type="text/javascript">
	...
	$(function(){
		...
		var $dialog = $('<div></div>').dialog({autoOpen: false,title: 'PENAMABAHAN CASH',modal:true,buttons: {Close: function() {$(this).dialog('close');}}});
		$('.b_save').click(function(e)
		{
			if(validation())
			{
				$.ajax({
					url:"<c:url value='/page/additionalcashadd.htm'/>",
