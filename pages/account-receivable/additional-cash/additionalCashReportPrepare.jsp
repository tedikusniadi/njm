...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/additionalcashreport.htm'/>";
			document.reportForm.submit();
		}
		
		function resetform()
		{
			var url = "<c:url value='/page/additionalcashreportprepare.htm'/>";
			window.location = url;
		}
	</script>
</head>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F43 - Additional Cash Report</h1>
						`
					  	<div class="toolbar">
