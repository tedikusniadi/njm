					...
					<div id="se-contents">
						...
						<div class="toolbar">
                            ...
                            <c:if test='${access.print}'>
                            	<a class="item-button-print" href="<c:url value='/page/prepaymentcashprint.htm?id=${prepayment_edit.id}'/>"><span>Print</span></a>
			    			</c:if>
                        </div>
                                ...
                                <tr>
                                	<td width="56%" align="left" valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:select id="unitSalesOrder" path="unitSalesOrder" cssClass="combobox-ext" disabled="true">
                                                    <c:if test='${not empty prepayment_edit.unitSalesOrder}'>
                                                        <form:option value='${prepayment_edit.unitSalesOrder.id}' label='${prepayment_edit.unitSalesOrder.code}' />
                                                    </c:if>
                                                </form:select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <form:select id="bankAccount" path="bankAccount" cssClass="combobox-ext" disabled="true">
                                                    <c:if test='${not empty prepayment_edit.bankAccount}'>
                                                        <form:option value='${prepayment_edit.bankAccount.id}' label='${prepayment_edit.bankAccount.bankName}' />
                                                    </c:if>
                                                </form:select>
                                            </td>
                                        </tr>
