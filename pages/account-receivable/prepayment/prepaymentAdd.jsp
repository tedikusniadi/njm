					...
					<div id="se-contents">
                        ...
                        <div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute='prepayment_add'>
                                	...
                                	<td width="53%" align="left" valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	...
                                            	<img src="assets/icons/add_row.png" onclick="javascript:addCustomerInstant('customer');" style="CURSOR:pointer;" title="Customer" />
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <%-- <input type="hidden" value="${currency.id}" name="currency"/> --%>
							</form:form>
						</div>
					</div>
				</div>
