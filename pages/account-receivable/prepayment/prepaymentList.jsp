...
<head>
	...
	<%@ include file="/filter/prepaymentFilter.jsp"%>
                            ...
                            <tr>
                            	<td width="35%" height="30" align="left" valign="middle">
                            		<div class="toolbar-clean">
                                		<a class="item-button-new" href="<c:url value='/page/prepaymentpreadd.htm'/>"><span>New Prepayment</span></a>
                        ...
                        <tr>
                             <td class="tools">
                                <c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/prepaymentpreedit.htm?id=${payment.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
