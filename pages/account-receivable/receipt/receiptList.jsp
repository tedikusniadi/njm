			...
			<div id="r13">
				<div id="r14">
					...
					<!-- main contents goes here -->
						...
						<div class="item-navigator">
                            ...
                            <tr>
                            	<td width="35%" height="30" align="left" valign="middle">															
                            		...
                            		<c:if test="${filterCriteria.receiptFrom == 'UNIT'}">
                            			<c:if test='${access.add}'>
                                			<a class="item-button-new" href="<c:url value='/page/receiptpreadd.htm'/>"><span>New Receipt</span></a>
                                		</c:if>
                                	</c:if>
                        ...
                        <tr>
                             <td class="tools">
                                <a class="item-button-edit" href="<c:url value='/page/receiptpreedit.htm?id=${payment.id}'/>" title="Edit"><span>Edit</span></a>
                                <c:if test="${access.delete and empty payment.clearReceipt and payment.journalEntry.entryStatus != 'POSTED'}">
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/receiptdelete.htm?id=${payment.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
                             </td>
