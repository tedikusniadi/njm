...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			var date = document.getElementById('dateToId').value;
			if(date == '' || date == null)
			{
			...
			document.reportForm.action = "<c:url value='/page/recaptransactionbillingreportview.htm'/>";
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post">
								...
								<tr>
                                    ...
                                    <td>
                                    	<select id='leasing' name=leasing class='combobox-medium'><option value="0">--Leasing--</option>
                                    	</select>
                                ...
                                <tr>
                                	<td align="right">Main Dealer :</td>
                                    <td>
                                    	<select id='mainDealer' name='mainDealer' class='combobox-ext'>
                      						<option value="0">--Main Dealer--</option>
                      					</select>
                      					<img src="assets/icons/list_extensions.gif" onclick="javascript:opensupplierpersonal('mainDealer');" style="CURSOR:pointer;" title="Pelanggan" />
                                    </td>
                                </tr> -->
                                <tr>
