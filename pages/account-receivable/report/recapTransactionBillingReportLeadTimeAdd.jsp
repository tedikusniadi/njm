...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/recaptransactionbillingreportleadtimeview.htm'/>";
					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post">
                                ...
                                <tr>
                                    <td align="right">Status Kwitansi : </td>
                                    <td>
                                        <select id='status' name='status' cssClass='combobox-ext'>
