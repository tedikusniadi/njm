...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/cashiersparepartreportview.htm'/>";
		...
		function openShift()
		{
			...
			openpopup("<c:url value='/page/popupshiftmanagementview.htm?target=shift&organization='/>"+org.value);
		}
	</script>
</head>
					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post">
								...
								<tr>
                                    <td><div align="right">Shift :</div></td>
                                    <td>
                                        <select id="shift" name="shift" class="combobox-ext">
                                        	<option value="0"><c:out value='All Shifts'/></option>
                                        </select>
                                        <img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="javascript:openShift();" style="CURSOR:pointer;" title="Shift Management" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                    	...
                                    	<!-- <input type="checkbox" name="dayBefore" value="true">Tampilkan Saldo Sebelumnya</input> -->
                                    </td>
                                </tr>
				  				</table>
							</form>
