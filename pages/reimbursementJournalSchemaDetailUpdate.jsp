...
<html>
<head>
	<title>Reimbursement Journal Schema Detail >> Edit</title>
	...
	<script type="text/javascript">
		function save()
		{
			document.addForm.action = "<c:url value='/page/reimbursementjournalschemadetailedit.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Accounting Setting > Reimbursement Journal Schema Detail > Edit</td>
						...
						<div class="main-box">
							<form:form name="addForm" method="post" modelAttribute="reimbursement">
                                ...
                                <tr>
                                  ...
                                  <td width="1%">:</td>
                               	  <td width="81%"><form:input path="name" cssClass="inputbox" disabled='true'/></td>
                                </tr>
                                <tr>
       				  ...
       				  <td>
                                        <form:select id="org" path="organization" cssClass="combobox-ext" disabled='true'>
                                        	<option><c:out value='${reimbursement.organization.firstName} ${reimbursement.organization.middleName} ${reimbursement.organization.lastName}'/></option>
                                        </form:select>
                                    </td>
                                </tr>
                                <tr>
       				  ...
       				  <td>
                                        <form:select id="account" path="account" cssClass="combobox-ext" disabled='true'>
                                        	<option><c:out value='${reimbursement.account.code} ${reimbursement.account.name}'/></option>
                                        </form:select>
                                    </td>
                                </tr>
                                <tr>
