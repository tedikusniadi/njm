...
<head>
	...
	<script type="text/javascript">
		function generate()
		{ 
			document.reportForm.action = "<c:url value='/page/crossdepositreportview.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%"> Financial Accounting &gt; Cash Bank Management &gt; Report &gt; Cross Deposit Report </td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F42 - Cross Deposit Report</h1>
...
--%>								
                                ...
                                <tr>
                                    <td><div align="right">Payer :</div></td>
                                    <td>
                                        <select id="payer" name="payer" class="combobox-ext">
                                        </select>
                                        &nbsp;
                                        <img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="javascript:openpopup('<c:url value='/page/popupcompanystructurerolebasedview.htm?target=payer'/>');" style="CURSOR:pointer;" title="Company Structure" />
                                    </td>
                                </tr>
                                <tr>
                                    <td><div align="right">Payee :</div></td>
                                    <td>
                                        <select id="payee" name="payee" class="combobox-ext">
                                        </select>
                                        &nbsp;
                                        <img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="javascript:openpopup('<c:url value='/page/popupcompanystructurerolebasedview.htm?target=payee'/>');" style="CURSOR:pointer;" title="Company Structure" />
                                    </td>
                                </tr>                                
                                <tr>
