...
<head>
	...
	<%@ include file="/filter/transferOrderFilter.jsp"%>
								...
								<td width="70%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/transferorderpreadd.htm?transferType=UNIT'/>"><span>New Transfer Order</span></a>
											<%-- <a class="item-button-new" href="<c:url value='/page/transferorderpreadd.htm?transferType=SPAREPART'/>"><span>New Sparepart Transfer Order</span></a> --%>
                                        </c:if>
