						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="goodsReceipt_add">
                                ...
                                <tr>
                                	...
                                	<td><input class="input-disabled" size="22" value="${item.warehouseTransactionItem.product.types}" disabled/></td>
                                	<td><input class="input-disabled" size="25" value="${item.warehouseTransactionItem.product.typeNames}" disabled/></td>
                                	<td><input class="input-disabled" size="12" value="${item.warehouseTransactionItem.product.colors}" disabled/></td>
	...
	$(function(){
		$('.item-button-next').click(function(e){
			...
			for(var idx=len-1;idx>=0;idx--)
			{
				...
				if(t_section.rows[idx].cells[6].childNodes[1].value == null || t_section.rows[idx].cells[6].childNodes[1].value == '')
				{
			...
			$("#addForm").attr("action","<c:url value='/page/goodsreceiptpreadd3.htm'/>");
			$("#addForm").submit();
		});
	});
