...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			document.filterForm.action = "<c:url value='/page/accountreceivablesbillingreportcollectorview.htm'/>";
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F40 - Billing Collector Recapitulation </h1>
