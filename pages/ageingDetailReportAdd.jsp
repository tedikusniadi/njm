...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			document.reportForm.action = "<c:url value='/page/ageingdetailreportview.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Account Receivables > Ageing Detail </td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F27 - Ageing Detail</h1>
