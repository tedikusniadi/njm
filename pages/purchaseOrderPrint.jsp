...
<div id="se-containers">
	...
	<div id="se-navigator">
		<div class="area" dojoType="Container" id="quick_link_container">
			...
			<tr>
				<td width="60%">
				Procurement &gt; Purchase Order &gt; Edit &gt; Print
				</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">			
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/purchaseorderpreedit.htm?id=${purchaseOrder_edit.id}'/>"><span>Back</span></a>
								...
								<td colspan="6">
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										...
										<tr>
											...
											<th align="center" style="border-right:solid 1px black; border-top:solid 1px black; border-bottom:solid 1px black;" colspan="2">PRICE</th>
											<th align="center" style="border-right:solid 1px black; border-top:solid 1px black; border-bottom:solid 1px black;" colspan="2">AMOUNT</th>
										</tr>
										</thead>
										</tbody>
											...
											<tr>
												<td width="15%" style="border-bottom:solid 1px black; border-left:solid 1px black; border-right:solid 1px black;">&nbsp;<c:out value='${item.product.code}'/></td>
												<td width="25%" style="border-bottom:solid 1px black; border-right:solid 1px black;">&nbsp;<c:out value='${item.product.name}'/></td>
												<td width="10%" style="border-bottom:solid 1px black; border-right:solid 1px black;" align="center"><fmt:formatNumber value='${item.quantity}' pattern=',##0.00'/></td>
												<td width="10%" style="border-bottom:solid 1px black; border-right:solid 1px black;" align="center"><c:out value='${item.productPrice.product.unitOfMeasure.measureId}'/></td>
												<td width="15%" style="border-bottom:solid 1px black;" align="right"><fmt:formatNumber value='${item.money.amount}' pattern=',##0.00'/></td>
												<td width="5%" style="border-bottom:solid 1px black; border-right:solid 1px black;" align="right"><c:out value='${item.money.currency.name}'/>&nbsp;</td>
												<td width="15%" style="border-bottom:solid 1px black;" align="right"><fmt:formatNumber value='${item.money.amount*item.quantity}' pattern=',##0.00'/></td>
												<td width="5%"style="border-bottom:solid 1px black; border-right:solid 1px black;" align="right"><c:out value='${item.money.currency.name}'/>&nbsp;</td>
											</tr>
											<c:set var='t_amt' value='${t_amt+(item.money.amount*item.quantity)}'/>
											</c:forEach>
											<tr>
												<td colspan="6" align="right" style="border-right:solid 1px black;">Sub total&nbsp;</td>
												<td align="right"><fmt:formatNumber value='${t_amt}' pattern=',##0.00'/></td>
												<td align="right" style="border-right:solid 1px black;"><c:out value='${purchaseOrder_edit.requisition.currency.name}'/>&nbsp;</td>
											</tr>
											...
											<tr>
												<td colspan="6" align="right" style="border-right:solid 1px black;"><c:out value='${purchaseOrder_edit.tax.taxName}'/>&nbsp;<fmt:formatNumber value='${purchaseOrder_edit.tax.taxRate}' pattern='##0'/> %&nbsp;</td>
												<td align="right" style="border-top:solid 1px black;"><fmt:formatNumber value='${t_amt*purchaseOrder_edit.tax.taxRate*0.01}' pattern=',##0.00'/></td>
												<td align="right" style="border-right:solid 1px black; border-top:solid 1px black;"><c:out value='${purchaseOrder_edit.requisition.currency.name}'/>&nbsp;</td>
											</tr>
											<c:set var='tax_1' value='${t_amt*purchaseOrder_edit.tax.taxRate*0.01}'/>
											</c:if>
											<c:if test='${not empty purchaseOrder_edit.extTax1}'>
											<tr>
												<td colspan="6" align="right" style="border-right:solid 1px black;"><c:out value='${purchaseOrder_edit.extTax1.taxName}'/>&nbsp;<fmt:formatNumber value='${purchaseOrder_edit.extTax1.taxRate}' pattern='##0'/> %&nbsp;</td>
												<td align="right" style="border-top:solid 1px black;"><fmt:formatNumber value='${t_amt*purchaseOrder_edit.extTax1.taxRate*0.01}' pattern=',##0.00'/></td>
												<td align="right" style="border-right:solid 1px black; border-top:solid 1px black;"><c:out value='${purchaseOrder_edit.requisition.currency.name}'/>&nbsp;</td>
											</tr>
											...
											<tr>
												<td colspan="6" align="right" style="border-right:solid 1px black;"><c:out value='${purchaseOrder_edit.extTax2.taxName}'/>&nbsp;<fmt:formatNumber value='${purchaseOrder_edit.extTax2.taxRate}' pattern='##0'/> %&nbsp;</td>
												<td align="right" style="border-top:solid 1px black;"><fmt:formatNumber value='${t_amt*purchaseOrder_edit.extTax2.taxRate*0.01}' pattern=',##0.00'/></td>
												<td align="right" style="border-right:solid 1px black; border-top:solid 1px black;"><c:out value='${purchaseOrder_edit.requisition.currency.name}'/>&nbsp;</td>
											</tr>
											<c:set var='tax_3' value='${t_amt*purchaseOrder_edit.extTax2.taxRate*0.01}'/>
											</c:if>
											<tr>
												<td colspan="6" align="right" style="border-right:solid 1px black;">Grand Total&nbsp;</td>
												<td align="right" style="border-top:solid 1px black; border-bottom:solid 1px black;"><fmt:formatNumber value='${t_amt+tax_1+tax_2+tax_3}' pattern=',##0.00'/></td>
												<td align="right" style="border-right:solid 1px black; border-top:solid 1px black; border-bottom:solid 1px black;"><c:out value='${purchaseOrder_edit.requisition.currency.name}'/>&nbsp;</td>
											</tr>
											<tr>
												<td colspan="4">
											...
											<tr><td colspan="8">&nbsp;</td></tr>
											<tr><td colspan="8" align="center">If you have any questions about your order, please contact <c:out value='${purchaseOrder_edit.createdBy.firstName} ${purchaseOrder_edit.createdBy.lastName} ${purchaseOrder_edit.createdBy.middleName}'/></td></tr>
										</tbody>
									</table>
									</td>
									<td colspan="2">&nbsp;</td>
