...
<html>
<head>
	<title>Inter From Journal</title>
	<%@ include file="/common/sirius-header.jsp"%><!-- /top menu -->
	<script type="text/javascript" src="assets/dialog.js"></script>
	<%@ include file="/filter/interFromJournalEntryFilter.jsp"%>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Financial Accounting > Journal Entrys > Inter From Journal</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F45 - Inter From Journal</h1>
							...
							<tr>
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
										<a class="item-button-new" href="<c:url value='/page/interjournalfrompreaddlist.htm'/>"><span>New Entry</span></a>
						...
						<tr>
							<td class="tools">
                            	<c:if test="${access.edit}">
									<a class="item-button-edit" href="<c:url value='/page/interjournalfrompreedit.htm?id=${journal.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
								<c:if test="${journal.entryTo.entryStatus != 'POSTED' and access.delete}">
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/interjournalfromdelete.htm?id=${journal.id}'/>');" title="Del"><span>Del</span></a>
								</c:if>
							</td>
