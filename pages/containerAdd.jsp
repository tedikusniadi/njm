...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Company Administration > Facility > Grid > Container > Add</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="container">
								<table width="100%" style="border:none">
                                <tr>
									<td width="20%" nowrap="nowrap" align="right">Code :</td>
								  	<td width="80%"><form:input path='code' size="48"/></td>
								</tr>
                                <tr>
                                ...
                                <tr>
									...
									<td>
										<form:select id="containerType" path="containerType" cssClass="combobox">
