			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">			
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/directpurchaseorderpreedit.htm?id=${purchaseOrder_edit.id}'/>"><span>Back</span></a>
						...
						<div class="main-box">
							<div class="main_container">
                                ...
                                <tr>
                                    ...
                                    <td align="right" valign="middle" class="border_Right"><fmt:formatNumber value='${item.money.amount}' pattern=',##0.00'/></td>
                                    <td align="right" valign="middle" class="border_Right">&nbsp;</td>
                                    <td align="right" valign="middle" class="border_Right"><fmt:formatNumber value='${item.money.amount*item.quantity}' pattern=',##0.00'/></td>
                                    <td align="left" valign="top" class="">&nbsp;</td>
                                    <td align="left" valign="top" class="">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td align="center" valign="middle" class="border_Right">&nbsp;</td>
                                  <td align="center" valign="middle" class="border_Right">&nbsp;</td>
                                  <td align="center" valign="top" class="border_Right font9 tebal">Procurement Manager</td>
