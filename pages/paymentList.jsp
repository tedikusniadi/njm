...
<div id="se-containers">
	...
	<div id="se-navigator">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td width="60%">Financial Accounting > Accounting Payable > Payment</td>
                            ...
                            <tr>
                            	<td width="35%" height="30" align="left" valign="middle">															
                            		<div class="toolbar-clean">
                                		<a class="item-button-new" href="<c:url value='/page/paymentpreadd.htm'/>"><span>New Payment</span></a>
                        ...
                        <tr>
                             <td class="tools">
                                ...
                                <c:if test="${access.delete and payment.clearPayment == null and payment.journalEntry.entryStatus != 'POSTED'}">
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/paymentdelete.htm?id=${payment.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
                             </td>
                             ...
                             <td>
                             	<strong>
                                	<c:if test='${payment.cleared}'>CLEAR</c:if>
                                    <c:if test="${!payment.cleared and payment.paymentInformation.paymentMethodType == 'CLEARING'}">CLEARING</c:if>
                                	<c:if test="${!payment.cleared and payment.paymentInformation.paymentMethodType != 'CLEARING'}">ACTIVE</c:if>
                                </strong>
                        	</td>
                        </tr>
                        </c:forEach>
