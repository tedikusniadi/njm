...
<html>
<head>
	<title><spring:message code="supplier.home.htmltitle"/></title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
        ...
        <tr>
            <td width="60%"><spring:message code="supplier.home.linkhelp"/></td>
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
										<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/salesapproverpreadd.htm' />"><span><spring:message code="new"/></span></a>
							   			</c:if>
                        ...
                        <tr>
                            <td class="tools">
                            	<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/salesapproverpreedit.htm?id=${data.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                            </td>
