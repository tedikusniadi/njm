								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/unitinvoiceverificationpreadd.htm'/>"><span><spring:message code="new"/></span></a>
											<%-- <a class="item-button-new" href="<c:url value='/page/unitinvoiceverificationfromfilepreadd.htm'/>"><span>From File</span></a> --%>
                                        </c:if>
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/unitinvoiceverificationpreedit.htm?id=${manual.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test='${access.delete and empty manual.applications and empty manual.purchaseOrder.receipts}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/unitinvoiceverificationdelete.htm?id=${manual.id}'/>');" title="Del"><span>Del</span></a>
                                </c:if>
							</td>
