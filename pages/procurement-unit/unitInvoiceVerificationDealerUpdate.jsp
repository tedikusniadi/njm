                                	...
                                	<td width="59%">
										...
										<fieldset>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="crossDistrictAmount" name="rounding" value="<fmt:formatNumber value='${adapter.verification.crossDistrictAmount}' pattern=',##0.00'/>" class="input-disabled" disabled style="text-align:right" size="13"/></td>
                                                <td><input id="crossDistrictAmountDef" value="<fmt:formatNumber value='${adapter.verification.crossDistrictAmount}' pattern=',##0.00'/>" class="input-disabled" disabled style="text-align:right" size="13"/></td>
                                            </tr>
                                            <tr>
