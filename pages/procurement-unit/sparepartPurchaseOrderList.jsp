								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/sparepartpurchaseorderpreadd1.htm'/>"><span>New Purchase Order</span></a>
                                        </c:if>
						...
						<tr>
							<th width="1%"><div style="width:45px"></div></th>
                          	...
                          	<th width="15%">Supplier</th>
		  	  	  	  	  	...
		  	  	  	  	  	<th width="10%" align="right">Amont</th>
		  	  	  	  	  	<th width="6%" align="center">Curr</th>
	  	  	  	  	  	  	<th width="25%">Note</th>
						</tr>
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/sparepartpurchaseorderpreedit.htm?id=${order.requisition.purchaseOrder.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test='${access.delete and empty order.requisition.purchaseOrder.components and empty order.requisition.purchaseOrder.receipts}'>
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/sparepartpurchaseorderdelete.htm?id=${order.requisition.purchaseOrder.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
							</td>
							...
							<td align="right"><fmt:formatNumber value='${order.total}' pattern="#,###"/></td>
							<td align="center"><c:out value='${order.requisition.purchaseOrder.currency.symbol}'/></td>
