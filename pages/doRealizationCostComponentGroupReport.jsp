...
<html>
<head>
	<title>Sales Cost Component Report</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Procurement > Report > Sales Cost Component</td>
...
<script type="text/javascript">
	$(function(){
		...
		$('.item-button-generate-report').click(function(){
			...
			document.reportForm.action = "<c:url value='/page/dorealizationcostcomponentgroupreportview.htm'/>";
