...
<html>
<head>
	<title>Advance Trial Balance Filter</title>
	...
	<script type="text/javascript">
		function generate()
		{
			document.reportForm.action = "<c:url value='/page/trialbalanceadvancereportview.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Reports > Financial Accounting > Accounting > Advance Trial Balance</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">RF64 - Advance Trial Balance Report</h1>
