...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			document.reportForm.action = "<c:url value='/page/receiptsummarycashbankreportview.htm'/>";
		...
		function resetform()
		{
			...
			var vehicle = document.getElementById('methodType');
			
			for(var idx=vehicle.options.length;idx>=0;idx--)
				vehicle.remove(vehicle.selectedIndex);
				
			var vehicleType = document.getElementById('account');
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Account Receivables > Report &gt; Receipt Summary Per Cash/Bank Account </td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F34 - Receipt Summary Per Cash/Bank Account </h1>
