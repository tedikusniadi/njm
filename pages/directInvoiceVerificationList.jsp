...
<html>
<head>
	<title>Advance Pertamina Verification >> Home</title>
...
<div id="se-containers">
	...
	<%@ include file="/filter/directInvoiceVerificationFilter.jsp"%>
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Financial Accounting > Account Payable > Advance Pertamina Verification</td>
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/directinvoiceverificationpreadd1.htm'/>"><span>New Verification</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/directinvoiceverificationpreedit.htm?id=${ver.id}'/>"  title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test='${access.delete and empty ver.applications}'>
                                    <a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/directinvoiceverificationdelete.htm?id=${ver.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
							</td>
							<td><c:out value='${ver.code}'/></td>
							<td><fmt:formatDate value='${ver.date}' pattern='dd-MM-yyyy'/></td>
							<td><c:out value='${ver.organization.firstName} ${ver.organization.middleName} ${ver.organization.lastName}'/></td>
                            <td><a href="<c:url value='/page/${ver.purchaseOrder.uri}?id=${ver.purchaseOrder.id}'/>"><c:out value='${ver.purchaseOrder.code}'/></a></td>
