...
<html>
<head>
	<title>Standard Sales Order >> Home</title>
	<%@ include file="/common/sirius-header.jsp"%>
	<script type="text/javascript" src="assets/dialog.js"></script>
	<%@ include file="/filter/standardSalesOrderFilter.jsp"%>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Sales > Sales Order > Standard Sales Order</td>
								...
								<td width="50%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/standardsalesorderpreadd.htm'/>"><span>New Standard Sales Order</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/standardsalesorderpreedit.htm?id=${order.salesOrder.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test="${access.delete and order.salesOrder.approvable.approvalDecision.approvalDecisionStatus != 'APPROVE_AND_FINISH'}">
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/standardsalesorderdelete.htm?id=${order.salesOrder.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
							</td>
							...
							<td align="right"><fmt:formatNumber value="${order.total+order.salesOrder.rounding}" pattern=',##0.00'/></td>
