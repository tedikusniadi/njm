			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="editForm" name="editForm" method="post" modelAttribute="mailAddress_edit" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form:select id="org" path="organization" cssClass="combobox-ext input-disabled">
                                        	<form:option value="${mailAddress_edit.organization.id}" label="${mailAddress_edit.organization.name}"/>
                                        </form:select>
                                    </td>
                                </tr>
 								</table>
...
$(function(){
	$('.item-button-save').click(function()
	{
		if(validation())
		{
			...
			xhr.open('POST', "<c:url value='/page/sendmailaddressedit.htm'/>");
