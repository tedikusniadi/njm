...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">SPBU > Receipt > Add</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="SPBUReceipt_add">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form:select id="org" path="organization" cssClass="combobox-ext">
                                            <c:if test='${not empty SPBUReceipt_add.organization}'>
                                                <form:option value='${SPBUReceipt_add.organization.id}' label='${SPBUReceipt_add.organization.firstName} ${SPBUReceipt_add.organization.lastName} ${SPBUReceipt_add.organization.middleName}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td><input id="date" name="date" value="<fmt:formatDate value='${SPBUReceipt_add.date}' pattern='MM/dd/yyyy'/>" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
                                    <td><form:errors path='date' cssClass='errors'/></td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">Tank :</td>
                                    <td>
                                        <form:select id="tank" path="tank" cssClass="combobox-ext">
                                            <c:if test='${not empty SPBUReceipt_add.tank}'>
                                                <form:option value='${SPBUReceipt_add.tank.id}' label='${SPBUReceipt_add.tank.name}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
                                        <img src="assets/icons/list_extensions.gif" onclick="opentank();" style="CURSOR:pointer;" title="Tank" />
                                    </td>
                                    <td><form:errors path='tank' cssClass='error'/></td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">Receive Date :</td>
                                    <td><input id="receiveDate" name="receiveDate" value="<fmt:formatDate value='${SPBUReceipt_add.receiveDate}' pattern='MM/dd/yyyy'/>" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
                                    <td><form:errors path='receiveDate' cssClass='error'/></td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">Shift :</td>
                                    <td>
                                        <form:select id="shift" path="shift">
                                ...
                                <div id="mainTab" dojoType="TabContainer" style="width:100% ; height: 250px;">
              						<div id="line" dojoType="ContentPane" label="Line Item" class="tab-pages" refreshOnShow="true">
                                        ...
                                        <tbody>
                                        <c:forEach items='${SPBUReceipt_add.items}' var='item' varStatus='status'>
                                        <tr>
                                            <td><form:input path='items[${status.index}].time' size='8'/></td>
                                            <td><form:input path='items[${status.index}].doNo' size='10'/></td>
                                            <td><form:input path='items[${status.index}].soNo' size='10'/></td>
                                            <td><form:input path='items[${status.index}].receive' cssStyle='text-align:right;' size='8'/></td>
                                            <td><form:input path='items[${status.index}].startLevel' cssStyle='text-align:right;' size='8'/></td>
                                            <td><form:input path='items[${status.index}].startVolume' cssStyle='text-align:right;' size='8'/></td>
                                            <td><form:input path='items[${status.index}].endLevel' cssStyle='text-align:right;' size='8'/></td>
                                            <td><form:input path='items[${status.index}].endVolume' size='8'/></td>
                                            <td><input readonly="readonly" style="text-align:right;" value="<fmt:formatNumber value='${item.endVolume-item.startVolume-item.receive}'/>" size='8'/></td>
                                        </tr>
                                        </c:forEach>
                                        </tbody>
                                        <tfoot>
