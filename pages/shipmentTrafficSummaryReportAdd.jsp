...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Transport Outsource > Transport Outsource Reports > Traffic Summary</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">D20 - Traffic Summary Report</h1>
                    	...
                    	<div class="main-box">
							<form:form name="reportForm" id="reportForm" method="post" modelAttribute='trafic'>
...
<script type="text/javascript">
	function generate()
	{
		document.reportForm.action = "<c:url value='/page/shipmenttrafficreportsummaryview.htm'/>";
