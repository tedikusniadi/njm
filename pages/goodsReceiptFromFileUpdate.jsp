						...
						<h1 class="page-title">${pageTitle}</h1>
					  	...
					  	<div class="toolbar">
                            ...
                            <c:if test='${access.print}'>
                            	<a class="item-button-print" href="<c:url value='/page/goodsreceiptfromfileprint.htm?id=${goodsReceipt_edit.id}'/>"><span>Print</span></a>
                            </c:if>
					  	</div>
                                        ...
                                        <tr>
                                          	...
                                          	<td width="74%">
                                          		<form:select path='warehouseTransaction.transactionSource' disabled='true' cssClass="input-disabled">
                                                    ...
                                                    <form:option value='SALES_RETURN' label='SALES RETURN'/>
                                                </form:select>
                                            </td>
                                        </tr>
                                        <tr>
