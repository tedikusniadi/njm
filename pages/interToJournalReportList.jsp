				...
				<div id="r14">
					<div id="se-contents">
						...
						<div class="area" dojoType="Container" id="quick_link_container">
							...
							<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/intertojournalreportpre.htm'/>"><span>Back</span></a>
								<a class="item-button-print" href="javascript:window.print();"><span>Print</span></a>
								<a class="item-button-export-xls" href="<c:url value='/page/intertojournalreportexcelview.xls'/>"><span>Export</span></a>
							</div>
						</div>
						...
						<div class="main-box">
                            ...
                            <table width="100%">
                            <tr>
                            	<th width="27%" align="left">Source</th>
                            ...
                            <tr>
                                ...
                                <td align="left"><fmt:formatDate value='${journal.entryFrom.entryDate}' pattern='dd-MM-yyyy'/></td>
                                <td align="left">${journal.entryFrom.code}</td>
                                <td align="left">${journal.entryFrom.note}</td>
                                <td align="right">
                                	<c:if test="${journal.postingType == 'DEBET'}">
                                    	<fmt:formatNumber value='${journal.amount * journal.entryFrom.exchange.rate}' groupingUsed='true' pattern=',##0.00'/>
                                    </c:if>
                                </td>
                                <td align="right">
