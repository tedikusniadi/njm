					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post">
                                ...
                                <td>
                                    <select id="supplier" name="supp" class="combobox-ext">
                                    </select>
                                    &nbsp;
                                    <img src="assets/icons/list_extensions.gif" class="img_sup" style="CURSOR:pointer;"/>
                                </td>
                            </tr>
                                <tr>
...
<script type="text/javascript">
	$(function(){
		$('.img_sup').click(function(){
			...
			openpopup("<c:url value='/page/popupsupplierview.htm?target=supplier&organization='/>"+$('#org').val());
		});
		...
		$('.item-button-generate-report').click(function(){
			...
			document.reportForm.action = "<c:url value='/page/pertaminaprocurementreportview.htm'/>";
