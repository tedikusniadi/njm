			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">			
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/accountreceivablesbillingreportcollectorprepare.htm'/>"><span>Back</span></a>
								<a class="item-button-print" href="javascript:window.print();"><span>Print</span></a>
								<a href="javascript:step('first','<c:url value='/page/accountreceivablesbillingreportcollectorview.htm'/>');">First</a> | <a href="javascript:step('prev','<c:url value='/page/accountreceivablesbillingreportcollectorview.htm'/>');">Prev</a> | Page <c:out value="${filterCriteria.page}"/> of <c:out value="${filterCriteria.totalPage}"/> | <a href="javascript:step('next','<c:url value='/page/accountreceivablesbillingreportcollectorview.htm'/>');">Next</a> | <a href="javascript:step('last','<c:url value='/page/accountreceivablesbillingreportcollectorview.htm'/>');">Last</a>
					  		</div>
						</div>
						<div class="main-box">
							<div class="main_container">
								...
								<tr>
									...
									<td  width="96%" colspan="6" align="right" class="CSS3">Tanda Terima Invoice Ke Collector</td>
									<td width="2%" colspan="2">&nbsp;</td>
								</tr>
								...
								<tr>
									...
									<td colspan="6" valign="top">
										<table width="100%" cellpadding="6" cellspacing="0" align="left" border="0" style="CSS1">
											<tr>
												<td width="10%">Collector</td>
												<td width="3%">:</td>
												<td width="24%" colspan="3"><c:if test='${empty collector}'>All Customers</c:if><c:out value="${collector.firstName} ${collector.middleName} ${collector.lastName}"/></td>
												<td width="45%">&nbsp;</td>
												<td width="3%">Hal</td>
												<td width="3%">:</td>
									...
									<table class="CSS1" border="0" cellpadding="0" cellspacing="0" width="100%">
										...
										<tr>
											...
											<tr>
												...
												<td style="border-bottom:solid 1px black; border-right:solid 1px black;" align="left">&nbsp;<c:out value='${line.billing.taxNumber.code}-${line.billing.taxNumber.invoiceTax.code}'/></td>
