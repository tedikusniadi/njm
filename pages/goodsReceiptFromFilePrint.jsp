			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">			
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/goodsreceiptfromfilepreedit.htm?id=${goodsReceipt_edit.id}'/>"><span>Back</span></a>
						...
						<div class="main-box">
							<div class="main_container">
								...
								<tr>
									...
									<td width="52%" colspan="3" align="left" class="CSS1"  valign="middle"><strong><c:out value='${profile.organization.name}'/></strong><br/>
										<c:out value='${profile.organization.fixAddress}'/>
									</td>
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										...
										<tr>
											...
											<tr>
												...
												<td width="35%"  class="border-bottom border-right">&nbsp;&nbsp;<c:out value='${line.warehouseTransactionItem.product.name}'/></td>
