...
<html>
<head>
	<title>GL Register Report</title>
			...
			<div id="r13">
				<div id="r14">
					...
					<div class="area" dojoType="Container" id="quick_link_container">
						...
						<div class="toolbar">
							<a class="item-button-back" href="<c:url value='/page/glregisterreportpre.htm'/>"><span>Back</span></a>
							<a class="item-button-print" href="javascript:window.print();"><span>Print</span></a>
							<a class="item-button-export-xls" href="<c:url value='/page/glregisterreportexcelview.xls'/>"><span>Export</span></a>
						</div>
					</div>
