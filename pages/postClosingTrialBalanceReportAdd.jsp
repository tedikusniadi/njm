...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			document.reportForm.action = "<c:url value='/page/postclosingtrialbalancereportview.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Reports > Financial Accounting > Accounting > Post Closing Trial Balance</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">RF63 - Post Closing Trial Balance Report</h1>
