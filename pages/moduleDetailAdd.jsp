...
<div class="main-box" style="height:370px">
	<form:form id="addForm" name="addForm" action="page/moduledetailadd.htm" method="post" modelAttribute="moduleDetail">
	<sessionConversation:insertSessionConversationId attributeName='moduleDetail'/>
	<table style="border:none">
	<tr>
		<td align="right">URI :</td>
		<td><form:input path="uri" size="75" id="uri"/></td>
	</tr>
	<tr>
		<td align="right">Group :</td>
		<td><input value="${moduleDetail.module.name}" disabled size="75" class="input-disabled"/></td>
	</tr>
	<tr>
