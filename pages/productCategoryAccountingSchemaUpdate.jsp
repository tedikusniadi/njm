...
<html>
<head>
	<title>Product Category Accounting Schema >> Edit</title>
					...
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="categorySchema">
                                ...
                                <tr>
									<td width="30%" align="right" nowrap="nowrap">Accounting Schema :</td>
							  <td width="69%">
					  <form:select id="accountingSchema" path="accountingSchema" cssClass="combobox-ext" disabled='true'>
								...
								<tr>
									...
									<td>
										<form:select id="category" path="category" cssClass="combobox-ext" disabled='true'>
