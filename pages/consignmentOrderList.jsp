...
<html>
<head>
	<title>Consignment Order >> Home</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Sales > Consignment > Consignment Order</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">S13 - Consignment Order</h1>
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
							  			<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/consignmentorderpreadd.htm'/>"><span>New Consignment Order</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/consignmentorderpreedit.htm?id=${order.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
							</td>
							<td>${order.code}</td>
                            ...
                            <td><c:out value='${order.salesPerson.firstName} ${order.salesPerson.middleName} ${order.salesPerson.lastName}'/></td> 
						</tr>
						</c:forEach>
                        </tbody>
                        <tfoot>
