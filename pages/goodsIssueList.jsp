...
<head>
	...
	<%@ include file="/filter/goodsIssueFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/goodsissuepreadd1.htm'/>"><span>New Goods Issue</span></a>
                                        </c:if>
						...
						<c:forEach items="${issues}" var="rec">
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/goodsissuepreedit.htm?id=${rec.id}'/>"  title="Edit"><span>Edit</span></a>
                                <c:if test='${access.delete and rec.warehouseTransaction.deleteable}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/goodsissuedelete.htm?id=${rec.id}'/>');" title="Del"><span>Del</span></a>
                                </c:if>
							</td>
							<td>${rec.code}</td>
							<td><fmt:formatDate value='${rec.date}' pattern='dd-MM-yyyy'/></td>
							<td><c:out value='${rec.warehouseTransaction.issuedFrom}'/></td>
