...
<html>
<head>
	<title>Clear Payment Print</title>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">			
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/receiptpreedit.htm?id=${clear_edit.id}'/>"><span>Back</span></a>
							...
							<div class="main_container">
									...
									<td width="46%">
										<table>
											<tr>
												<td>Bayar Kepada<td>
												<td>:</td>
												<td><c:out value='${clearPayment_edit.payment.supplier.firstName} ${clearPayment_edit.payment.supplier.lastName} ${clearPayment_edit.payment.supplier.middleName}'/></td>
											</tr>
											<tr>
												<td><c:out value="${clearPayment_edit.payment.paymentInformation.paymentMethodType == 'CASH' ? 'Cash' : 'Bank / no rek'}"/><td>
												<td>:</td>
												<td><c:out value="${clearPayment_edit.payment.paymentInformation.bankAccount.accountNo}"/></td>
											</tr>
										</table>
									</td>
									<td width="24%">&nbsp;</td>
									<td width="26%">
										<table>
											<tr>
												<td>No. Bukti<td>
												<td>:</td>
												<td><c:out value="${clearPayment_edit.code}"/></td>
											</tr>
											<tr>
												<td>Tanggal<td>
												<td>:</td>
												<td><fmt:formatDate value='${clearPayment_edit.date}' pattern='dd-MM-yyyy'/></td>
											</tr>
										</table>
									</td>
									<td width="2%" colspan="2">&nbsp;</td>
								...
								<tr>
									...
									<td colspan="3" width="96%" align="center" class="CSS3" align="middle">
										<strong>BUKTI PENGELUARAN <c:out value="${clearPayment_edit.payment.paymentInformation.paymentMethodType == 'CASH' ? 'CASH' : 'BANK'}"/></strong>
									</td>
									<td width="2%" colspan="2">&nbsp;</td>
								</tr>
								...
								<td colspan="3">
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										...
										<tr>
											...
											<c:forEach items='${clearPayment_edit.payment.applications}' var='app'>
											<tr>
												<td colspan="3" style="border-right:solid 1px black;">&nbsp;<c:out value='${app.payable.code}'/></td>
												<td colspan="6" style="border-right:solid 1px black;">&nbsp;</td>
												<td colspan="2" align="right"><fmt:formatNumber value='${app.paid}' pattern=',##0.00'/>&nbsp;</td>
											</tr>
											</c:forEach>
											<tr>
												<td width="12%" valign="top" style="border-bottom:double 3px black;"><c:out value="${clearPayment_edit.payment.paymentInformation.paymentMethodType == 'CASH' ? 'CASH' : 'BANK'}"/></td>
												<td width="2%" valign="top" style="border-bottom:double 3px black;">&nbsp;:&nbsp;</td>
												<td width="16%" valign="top" style="border-bottom:double 3px black; border-right:solid 1px black;"><c:out value="${clearPayment_edit.payment.paymentInformation.bankAccount.bankName}"/></td>
												...
												<c:if test="${clearPayment_edit.payment.paymentInformation.paymentMethodType != 'CASH'}">	
													<c:out value="${clearPayment_edit.payment.paymentInformation.reference}"/>
												</c:if>												
												</td>
												...
												<c:if test="${clearPayment_edit.payment.paymentInformation.paymentMethodType != 'CASH'}">
													<fmt:formatDate value='${clearPayment_edit.payment.paymentInformation.dueDate}' pattern='dd-MM-yyyy'/>
												</c:if>
												</td>
											...
											<tr>
												...
												<td valign="top" style="border-bottom:double 3px black; border-right:solid 1px black;"></td>
												...
												<td valign="top" style="border-bottom:double 3px black;" colspan="2" align="right"><fmt:formatNumber value='${clearPayment_edit.payment.paymentInformation.amount}' pattern=',##0.00'/>&nbsp;</td>
											</tr>
											<tr>
