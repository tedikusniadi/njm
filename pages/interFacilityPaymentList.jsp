...
<html>
    <head>
        <title>Loan Payment >> Home</title>
        <%@ include file="/common/sirius-header.jsp"%>
        <style type="text/css" media="screen"><!-- @import url("assets/sirius.css"); --></style>
        <script type="text/javascript" src="assets/dialog.js"></script>
    	<%@ include file="/filter/interFacilityPaymentFilter.jsp"%>
    </head>
<body>
...
<div id="se-containers">
	...
	<div id="se-navigator">	
		...
		<tr>
			<td width="60%">Financial Accounting > Cash Bank Management > Inter Facility Transaction > Loan Payment</td>
					...
					<div id="se-contents">
							  ...
							  <table border="0" cellpadding="0" cellspacing="0" width="99%" align="center">
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
										<a class="item-button-new" href="<c:url value='/page/interfacilitypaymentpreadd1.htm' />"><span>New Payment</span></a>
						...
						<tr>
							<th width="5%"><div style="width:40px"></div></th>
			  	  	  	  	<th width="12%">ID</th>
	  	  	  	  	  	  	<th width="7%">Date</th>
  	  	  	  	  	 	  	<th width="21%">Payer</th>
  	  	  	  	  	  	  	<th width="20%">Payee</th>
                   	  	 	<th width="14%">Payer Bank</th>
  	  	  	  	  	  	  	<th width="12%">Payee Bank</th>
						...
						<tr>
						 	<td class="tools">
                            	 <c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/interfacilitypaymentpreedit.htm?id=${payment.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test="${access.delete and payment.clearing == null and (payment.journalEntry == null or payment.journalEntry.entryStatus == 'BATCHED')}">
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/interfacilitypaymentdelete.htm?id=${payment.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
						 	</td>
                            ...
                            <td><c:out value='${payment.payable.payerBankAccount.bankName}'/></td>
                            <td><c:out value='${payment.payable.payeeBankAccount.bankName}'/></td>
