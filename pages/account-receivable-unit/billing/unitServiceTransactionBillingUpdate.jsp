				...
				<div id="r14">
					<div id="se-contents">
						<h1 class="page-title">${pageTitle}</h1>
					  	<div class="toolbar">
							<a class="item-button-back" href="<c:url value='/page/unitservicetransactionbillingview.htm'/>"><span><spring:message code='back'/></span></a>
					  		<a class="item-button-print" href="<c:url value='/page/unitservicetransactionbillingprint.htm?id=${adapter.billing.id}'/>"><span>Kwitansi</span></a>
					  	</div>
						<div class="main-box">
                                             ...
                                             <tr>
                                                <td align="right" colspan="2">
                                                	<c:forEach items='${adapter.billing.payments}' var='application'>
														<a href="<c:url value='/page/unitservicetransactionreceiptpreedit.htm?id=${application.receipt.id}'/>">${application.receipt.code}</a><br/>
													</c:forEach>
												</td>
                                            </tr>
                                            </table>
                                		...
                                		<fieldset>
                                            ...
                                            <table width="" style="border:none"  align="right">
                                             <tr>
                                                ...
                                                <td><input id="totalAmount" value="<fmt:formatNumber value='${adapter.billing.unitServiceTransaction.amount}' pattern=',##0.00'/>" size="15" style="text-align:right" class="input-disabled" disabled/></td>
                                            </tr>
                                            </table>
                                        </fieldset>
                                  </td>
                                ...
                                <div id="line" dojoType="ContentPane" label="Barang" class="tab-pages" refreshOnShow="true">
                                    ...
                                    <tbody>
	                                    <tr>
	                                        ...
	                                        <td><c:out value='${adapter.billing.unitServiceTransaction.code}'/></td>
	                                        <td><input style="text-align:right;" size="25" class='input-disabled' value="<fmt:formatNumber value='${adapter.billing.unitServiceTransaction.amount}' pattern=',##0.00'/>" disabled/></td>
	                                    </tr>
                                    </tbody>
