                        ...
                        <tr>
                        	<td align="left">
                              ...
                              <tr align="left" valign="top" class="CSS1">
                                <td>Organization</td>
                                <td width="1%">:&nbsp;</td>
                                <td width="35%"><c:out value='${billing_edit.organization.salutation} ${billing_edit.organization.firstName} ${billing_edit.organization.middleName} ${billing_edit.organization.lastName}'/></td>
                                <td colspan="2">Term of Payment </td>
                                <td width="35%" align="left">:&nbsp;&nbsp;<c:out value='${billing_edit.creditTerm.term}'/>&nbsp;days </td>
                              </tr>
                              <tr align="left" valign="top" class="CSS1">
                                <td>Customer</td>
                                <td>:&nbsp;</td>
                                        ...
                                        <legend> For Bank transfer / clearing, please refer to </legend>
                                          <table border="0" cellpadding="0" cellspacing="0" width="100%" class="CSS1">
                                            <tr>
                                              ...
                                              <td width="68%">:&nbsp;<c:out value='${billing_edit.bankAccount.bankName}'/>&nbsp;</td>
                                            </tr>
                                            <tr>
                                ...
                                <td colspan="6" class="CSS">
                                  <table width="100%"  border="0" cellpadding="3" cellspacing="0" bordercolor="#000000" style="border:1px solid black;">
                                    ...
                                    <tr class="CSS1" style="font-weight:normal;">
                                      ...
                                      <td align="center" class="borderRightBottom"><c:out value='${line.uom}'/></td>
                                      <td align="right" class="borderRightBottom">&nbsp;<fmt:formatNumber value='${line.quantity}' pattern=',##0.00'/>&nbsp;</td>
