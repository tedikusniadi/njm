						...
						<div class="main-box">
							<div class="main_container">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td colspan="7"><div align="center" class="CSS3" valign="middle"><strong>KWITANSI</strong></div></td>
                                  </tr>
                                  <tr>
                                  	<td width="1%">&nbsp;</td>
                                  ...
                                  <tr>
                                  	<td width="1%">&nbsp;</td>
                                    <td>Uang Sejumlah</td>
                                    <td colspan="5">: Rp. <fmt:formatNumber value='${salesOrderAdapter.poPrepayment}' pattern=',##0.00'/></td>
                                  </tr>
                                  <tr>
                                  	<td width="1%">&nbsp;</td>
                                    <td>Terbilang</td>
                                    <td colspan="5">: ### <c:out value='${said_prepayment}'/> ###</td>
                                  </tr>
                                  <tr>
                                  	<td width="1%">&nbsp;</td>
                                    <td>Keterangan</td>
                                    <td colspan="5">: DP PO</td>
                                  </tr>
                                  <tr>
                                  	<td width="1%">&nbsp;</td>
                                    <td>&nbsp;</td>
