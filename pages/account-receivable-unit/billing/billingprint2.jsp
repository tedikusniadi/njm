			...
			<div id="r13">
				<div id="r14">
					...
					<!-- main contents goes here -->
						...
						<!-- Top toolbar -->
					  	<div class="toolbar">
							<a class="item-button-back" href="<c:url value='/page/billingprint.htm?id=${billing_edit.id}&invType=2'/>"><span>Back</span></a>
					...
					<div class="main-box">
					  <div class="main_container">
                        <div style="margin-left:20px;font-size:16px;font-weight:bold;"></div>
						
					<table  border="0" cellpadding="0" cellspacing="0" align="center" class="stdWidth">
						  <tr>
							<td width="878">
                  <table style="border:none" border="0" align="right" width="100%">
                        <tr>
                                <td width="60%" class="CSS1" valign="top">&nbsp;</td>
                                <td width="15%" class="CSS1" valign="top" align="right"><c:out value='${lembar}'/></td>
                                <td width="25%" class="CSS1" valign="top" align="left"><c:out value='${keterangan}'/></td>
                        </tr>
                   </table>
              </td>
						  </tr>
             ...
             <tr>
                        <td colspan="2" class="border-top" height="20" valign="middle">
                               &nbsp;&nbsp; Kode dan Nomor Seri Faktur Pajak : <c:out value='${billing_edit.taxNumber.code}${billing_edit.taxNumber.invoiceTax.code}'/>
                        </td>           
						</tr>
							  <tr>
									<td colspan="2">
                                        ...
                                        <tr>
                                          	<td class="CSS1" valign="top">&nbsp;&nbsp;Alamat</td>
                                          	<td class="CSS1" valign="top">:</td>
                                          	<td class="CSS1">${adapter.taxAddress}</td>
                                        </tr>
                                        <tr>
							  	...
							  	<tr>
									<td colspan="2" align="left" valign="top">
                                        ...
                                        <tr>
                                          <td width="25%" class="CSS1">&nbsp;&nbsp;Nama</td>
                                          <td width="1%" class="CSS1">:</td>
                                          <td colspan="74%" class="CSS1"><c:out value='${billing_edit.customer.salutation} ${billing_edit.customer.firstName} ${billing_edit.customer.middleName} ${billing_edit.customer.lastName}'/></td>

                                        </tr>
                                        <tr>
                                          <td class="CSS1" valign="top">&nbsp;&nbsp;Alamat</td>
                                          <td class="CSS1" valign="top">:</td>
                                          <td colspan="4" class="CSS1"><c:out value='${billing_edit.customerTaxAddress.address}'/></td>
                                        </tr>
                                        <tr>

                                          <td class="CSS1">&nbsp;&nbsp;N.P.W.P</td>
                                          <td class="CSS1">:</td>
                                          <td width="57%" class="CSS1">${billing_edit.customer.taxCode}</td>
                                          <td width="17%" class="CSS1" colspan="3">&nbsp;</td>
                                        </tr>
                                        </table>
                              		</td>
							  	</tr>
							  <tr>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" topmargin="0"  class="border-bottom border-top">
                                     ...
                                     <td colspan="3" valign="top">
                                        <table width="880" border="0" cellpadding="0" cellspacing="0" topmargin="0">
                                          ...
                                          <c:forEach items="${billing_edit.lineItems}" var="line" varStatus='status'>
                                                <tr height="15">
                                                        <td width="51" class="border-right" align="center" valign="top">
                                                                <font class="CSS1"><c:out value="${status.index+1}"/></font>
                                                                &nbsp;
                                                        </td>
                                                        <td width="528" class="border-right" align="left" valign="top">
                                  ...
                                  <tr>
                                    ...
                                    <td class="border-bottom" align="right"><font class="CSS1"><fmt:formatNumber value='${adapter.totalLineAmountMinusDiscount}' pattern=',##0.00'/></font>&nbsp;&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td colspan="2" class="border-bottom border-right">&nbsp;<font class="CSS1">Dikurangi Potongan Harga</font> </td>
                                    <td class="border-bottom" align="right"><font class="CSS1"><fmt:formatNumber value='${adapter.totalDiscount}' pattern=',##0.00'/></font>&nbsp;&nbsp;</td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td class="border-bottom" align="right"><font class="CSS1"><fmt:formatNumber value='${adapter.totalLineAmountMinusDiscount - adapter.totalDiscount}' pattern=',##0.00'/></font>&nbsp;&nbsp;</td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td  align="right"><font class="CSS1"><fmt:formatNumber value='${adapter.defTaxAmount}' pattern=',##0.00'/></font>&nbsp;&nbsp;</td>
                                  </tr>
                                </table>				
                        </td>
			<tr>
       ...
       <td colspan="2">
        &nbsp;
				...
				<td width="48%" bordercolor="#000000" style=" border-left: hidden;" valign="bottom">
                  ...
                  <tr>
                        <td align="center" nowrap="nowrap" valign="bottom" height="20">
                            ...
                            <c:if test='${postal.selected}'>
                              <c:forEach items='${postal.geographics}' var='geo'>
                                <c:if test='${geo.geographic.geographicType.id == 2}'> ${geo.geographic.name},
                                 <fmt:formatDate value='${billing_edit.date}' pattern='dd MMMM yyyy'/>
                                </c:if>
                              </c:forEach>
                            </c:if>
                          	</c:forEach>
