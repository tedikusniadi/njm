...
<!-- BEGIN OF BODY SIMPLE INVOICE TAX SUMMARY -->
<body>
...
<div id="se-containers">
	...
	<div id="r11">
			...
			<div id="r13">
				<div id="r14">
					...
					<div class="main-box">
                        ...
                        <tr>
                            	<td height="35" colspan="2" align="center" style="border-top:1px solid black;font-size:18px;font-weight:bold">FAKTUR PAJAK</td>
                        </tr>
                        <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" topmargin="0"  class="border-bottom border-top">
                                  <tr>
                                    <td width="51" align="center" valign="middle" class="border-bottom border-right" style="WIDTH:50px;"><br><font class="CSS">No.<br>Urut</font><br><br></td>
                                  ...
                                  <tr>
                                        <td colspan="3">
                                                ...
                                                <c:forEach items="${adapter.grouped}" var="line" varStatus='status'>
                                                        <tr class="CSS1" style="font-weight:normal;" height="15">
                                                              <td valign="top" width="51" class="border-right" align="center" valign="top">&nbsp;<font class="CSS1"><c:out value="${status.index+1}"/></font></td>
                                                              <td valign="top" width="528" class="border-right" valign="top">&nbsp;<font class="CSS1"><c:out value='${line.name}'/>&nbsp;x&nbsp;<fmt:formatNumber value='${line.quantity}' pattern='0'/></font></td>
                                                              <td valign="top" width="300" align="right" class="borde-bottom" valign="top">&nbsp;<font class="CSS1"><fmt:formatNumber value='${line.amount}' pattern=',##0.00'/></font>&nbsp;&nbsp;</td>
                                                        </tr>
		...
		<tr>
			<td align="center" nowrap="nowrap" class="CSS1" height="20" >
            ...
            <tr>
                <td height="35" valign="bottom" align="center"><c:out value='${billing_edit.activeRole.partyRoleType.name}'/></td>
            </tr>
			</table>
