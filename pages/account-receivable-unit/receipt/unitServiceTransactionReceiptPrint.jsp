			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">			
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/unitservicetransactionreceiptpreedit.htm?id=${receipt_edit.id}'/>"><span>Back</span></a>
							...
							<div class="main_container">
									...
									<td width="46%">
										<table>
											<tr>
												<td>Terima Dari<td>
												<td>:</td>
												<td><c:out value="${receipt_edit.customer.firstName} ${receipt_edit.customer.lastName} ${receipt_edit.customer.middleName}"/></td>
											</tr>
											<tr>
												<td><c:out value="${receipt_edit.receiptInformation.paymentMethodType == 'CASH' ? 'Cash' : 'Bank / no rek'}"/><td>
												<td>:</td>
												<td><c:out value="${receipt_edit.receiptInformation.bankAccount.accountNo}"/></td>
											</tr>
										</table>
									</td>
									<td width="24%">&nbsp;</td>
									<td width="26%">
										<table>
											<tr>
												<td>No. Bukti<td>
												<td>:</td>
												<td><c:out value="${receipt_edit.code}"/></td>
											</tr>
											<tr>
												<td>Tanggal<td>
												<td>:</td>
												<td><fmt:formatDate value='${receipt_edit.date}' pattern='dd-MM-yyyy'/></td>
											</tr>
										</table>
									</td>
									<td width="2%" colspan="2">&nbsp;</td>
								...
								<tr>
									...
									<td colspan="3" width="96%" align="center" class="CSS3" align="middle">
										<strong>BUKTI PENERIMAAN <c:out value="${receipt_edit.receiptInformation.paymentMethodType == 'CASH' ? 'CASH' : 'BANK'}"/></strong>
									</td>
									<td width="2%" colspan="2">&nbsp;</td>
								</tr>
								...
								<td colspan="3">
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										...
										<tr>
											...
											<tr>
												<td width="12%" valign="top" style="border-bottom:double 3px black;"><c:out value="${receipt_edit.receiptInformation.paymentMethodType == 'CASH' ? 'Cash' : 'Bank'}"/></td>
												<td width="2%" valign="top" style="border-bottom:double 3px black;">&nbsp;:&nbsp;</td>
												<td width="16%" valign="top" style="border-bottom:double 3px black; border-right:solid 1px black;"><c:out value="${receipt_edit.receiptInformation.bankAccount.bankName}"/></td>
												...
												<c:if test="${receipt_edit.receiptInformation.paymentMethodType != 'CASH'}">	
													<c:out value="${receipt_edit.receiptInformation.reference}"/>
												</c:if>
												</td>
												...
												<td width="14%" valign="top" style="border-bottom:double 3px black; border-right:solid 1px black;">
												<c:if test="${receipt_edit.receiptInformation.paymentMethodType != 'CASH'}">
													<fmt:formatDate value='${receipt_edit.receiptInformation.dueDate}' pattern='dd-MM-yyyy'/>
												</c:if>
											...
											<tr>
												...
												<td valign="top" style="border-bottom:double 3px black; border-right:solid 1px black;"><c:out value="${receipt_edit.organization.lastName}"/></td>
												...
												<td valign="top" style="border-bottom:double 3px black;" colspan="2" align="right"><fmt:formatNumber value='${receipt_edit.receiptInformation.amount}' pattern=',##0.00'/>&nbsp;</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td valign="top" style="border-right:solid 1px black; border-bottom:solid 1px black;"><c:out value='${receipt_edit.createdBy.firstName} ${receipt_edit.createdBy.lastName} ${receipt_edit.createdBy.middleName}'/></td>
