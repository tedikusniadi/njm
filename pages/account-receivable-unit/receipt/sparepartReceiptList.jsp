                        ...
                        <tr>
                             <td class="tools">
                                <c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/sparepartreceiptpreedit.htm?id=${payment.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test="${access.delete and empty payment.clearReceipt and payment.journalEntry.entryStatus != 'POSTED'}">
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/sparepartreceiptdelete.htm?id=${payment.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
                             </td>
