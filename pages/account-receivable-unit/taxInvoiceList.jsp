...
<head>
	...
	<%@ include file="/filter/taxInvoiceFilter.jsp"%>
</head>
<body>
<div id="se-r00">
	<div id="se-r01">&nbsp;</div>
					...
					<div id="se-contents">
							...
							<tr>
								<td width="30%" height="30" align="left" valign="middle">
                                	<div class="toolbar-clean">
                                		<a class="item-button-new" href="<c:url value='/page/taxinvoicepreadd1.htm'/>"><span>New</span></a>
                                		<a class="item-button-export-xls" href="javascript:exportAll();" title="Export All"><span>Export All</span></a>
                        ...
                        <tr>
                            ...
                            <th width="12%">No Faktur</th>
                          	...
                          	<th width="12%">Surat Jalan</th>
                          	<th width="65%">Note</th>
                        </tr>
                        <c:forEach items="${invoices}" var="inv">
                        <tr>
                        	<td class="tools">
                        		<a class="item-button-edit" href="<c:url value='/page/taxinvoicepreedit.htm?id=${inv.id}'/>" title="Edit"><span>Edit</span></a>
                        		<a class="item-button-export-xls" href="<c:url value='/page/taxinvoiceexport.csv?id=${inv.id}'/>" title="Export"><span>Export</span></a>
	                            <c:if test='${access.delete}'>
	                                <a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/taxinvoicedelete.htm?id=${inv.id}'/>');" title="Delete"><span>Delete</span></a>
	                            </c:if>
                        	</td>
                        	<td>${inv.code}</td>
                        	<td><fmt:formatDate value="${inv.date}" pattern="dd-MM-yyyy"/></td>
                        	<td>${inv.deliveryOrder.code}</td>
                        	<td>${inv.note}</td>
                        </tr>
                        </c:forEach>
