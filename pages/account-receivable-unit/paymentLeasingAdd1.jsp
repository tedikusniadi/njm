...
<head>
	...
	<%@ include file="/filter/paymentLeasingAddFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                        ...
                        <tr>
                        	<td class="tools">
                        		<a class="item-button-edit" href="<c:url value='/page/paymentleasingpreprocesstwo.htm?id=${leas.id}'/>" title="Edit"><span>Edit</span></a>
                        	</td>
