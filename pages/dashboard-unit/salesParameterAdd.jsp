			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="salesParameter_add">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form:select id="org" path="organization" cssClass="combobox-ext">
                                            <c:if test='${not empty salesParameter_add.organization}'>
                                                <form:option value='${salesParameter_add.organization.id}' label='${salesParameter_add.organization.name}' />
                                            </c:if>
                                        </form:select>
...
$(function()
{
	...
	{
		$.ajax({
			url:"<c:url value='/page/salesparameteradd.htm'/>",
