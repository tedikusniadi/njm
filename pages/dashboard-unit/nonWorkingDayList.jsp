...
<head>
	...
	<%@ include file="/filter/nonWorkingDayFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/nonworkingdaypreadd.htm'/>"><span><spring:message code="new"/></span></a>
                                        </c:if>
						...
						<c:forEach items="${nonworkings}" var="non">
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/nonworkingdaypreedit.htm?id=${non.id}'/>" title="Edit"><span>Edit</span></a>
								</c:if>
							</td>
							<td><fmt:formatDate value='${non.date}' pattern='dd-MM-yyyy'/></td>
                            <td>${non.note}</td>
						</tr>
						</c:forEach>
