...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Transport Outsource > Transport Outsource Reports > Traffic Detail</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">D21 - Traffic Detail Report</h1>
...
<script type="text/javascript">
	function generate()
	{
		document.reportForm.action = "<c:url value='/page/shipmenttrafficreportdetailview.htm'/>";
