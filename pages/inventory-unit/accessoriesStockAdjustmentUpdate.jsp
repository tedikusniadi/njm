				...
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
                            ...
                            <c:if test="${item.inventoryItem.product.serial}">
                            <tr>
                            	<td>&nbsp;</td>
                            	<th>&nbsp;</th>
                            	<th>Serial</th>
                            	...
                            	<tr>
                            		...
                            		<td class="tools">
										<c:if test='${access.edit}'>
		                                	<a class="item-button-edit" href="<c:url value='/page/accessoriesstockadjustmentitemdetailpreedit.htm?id=${detail.id}'/>" title="Edit"><span>Edit</span></a>
		                                </c:if>
...
<script type="text/javascript">
	$(function(){
		...
		$('.b_save').click(function(e){
			...
			$.ajax({
				url:"<c:url value='/page/accessoriesstockadjustmentedit.htm'/>",
