...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/grsparepartleadtimereportview.htm'/>";
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post" modelAttribute="sparepartGRLeadTimeCriteria">
