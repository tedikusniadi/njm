...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			if(name == '' || name == null)
			{
				alert('Please input Product Name first, you can use export feature to view all data later !!!');
				return;
			}

			document.reportForm.action = "<c:url value='/page/sparepartproductpricereportview.htm'/>";
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post" modelAttribute="sparepartPriceCriteria">
								...
								<tr>
                                    ...
                                    <td><input id="productName" name="productName" size='25'/></td>
                                </tr>
                                <!-- <tr>
