				...
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">${pageTitle }</h1>
					  	...
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/sparepartstockadjustmentview.htm'/>"><span><spring:message code='list'/></span></a>
...
<script type="text/javascript">
	$(function(){
		...
		$('.b_save').click(function(e){
			...
			{
				$.ajax({
					url:"<c:url value='/page/sparepartstockadjustmentadd.htm'/>",
					...
					success : function(json) {
						if(json)
						{
							...
							{
								$dialog.dialog('close');
								window.location="<c:url value='/page/sparepartstockadjustmentview.htm'/>";
							}
							else
							{
								$dialog.empty();
	...
	function addLineItem()
	{
		...
		if(tbl)
		{
			...
			if(t_section)
			{
				...
				row.insertCell(5).appendChild(genQuality(index));
				row.insertCell(6).appendChild(genBrand(index));
	...
	function genQuality(index)
	{
		var tipe = document.createElement("input");
		tipe.type = "text";
		tipe.id = "quality["+index+"]";
