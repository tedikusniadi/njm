...
<head>
	...
	<%@ include file="/filter/productStandardPriceSparepartFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
								...
								<td width="60%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/productstandardpricepreadd.htm?type=BUYING&from=SPAREPART'/>"><span>New Purchase Price</span></a>
											<a class="item-button-new" href="<c:url value='/page/productstandardpricepreadd.htm?type=SELLING&from=SPAREPART'/>"><span>New Selling Price</span></a>
                                        	<a class="item-button-new" href="<c:url value='/page/productstandardpricesparepartuploadpreadd.htm'/>"><span>Import From File</span></a>
                                        </c:if>
						...
						<c:if test="${price.product.productCategory.id == '2'}">
...
$(function(){
	$(".upload-price").click(function(){
		var url="<c:url value='/page/productstandardpricesparepartupload.htm'/>";
		...
		$dialog.dialog('option','title','Import Sparepart Price');
