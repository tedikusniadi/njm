								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/goodsreceiptmanualpreadd1.htm'/>"><span><spring:message code='new'/></span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
                                ...
                                <c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/goodsreceiptmanualdelete.htm?id=${rec.id}'/>');" title="Del"><span>Del</span></a>
                                </c:if>
							</td>
