...
<head>
	...
	<%@ include file="/filter/goodsReceiptItemVerificationAdd1Filter.jsp"%>
</head>
<body>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/goodsreceiptitemverificationpreadd2.htm?id=${det.id}'/>" title="Edit"><span>Edit</span></a>
							</td>
                            <td>${det.goodsReceiptItem.warehouseTransactionItem.product.types}</td>
                            <td>${det.goodsReceiptItem.warehouseTransactionItem.product.typeNames}</td>
							<td>${det.goodsReceiptItem.warehouseTransactionItem.product.colors}</td>
							<td>${det.serial}</td>
							<td>${det.serialExt1}</td>
                            <td>${det.year}</td>
						</tr>
						</c:forEach>
