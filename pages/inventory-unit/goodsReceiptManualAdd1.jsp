			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<tr>
							<td class="tools"><a class="item-button-edit" href="<c:url value='/page/goodsreceiptmanualpreadd2.htm?id=${rec.id}'/>" title="Edit"><span>Edit</span></a></td>
                        ...
                        <tr>
							...
							<td></td>
							<td></td>
							<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;<c:out value='${item.product.name}'/></td>
