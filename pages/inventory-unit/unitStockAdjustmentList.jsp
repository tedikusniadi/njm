...
<head>
	...
	<%@ include file="/filter/unitStockAdjustmentFilter.jsp"%>
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/unitstockadjustmentpreaddone.htm'/>"><span>New Stock Adjustment</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
	                            <c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/unitstockadjustmentpreedit.htm?id=${ad.id}'/>"  title="Edit"><span>Edit</span></a>
                                </c:if>
                                <%-- <c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/unitstockadjustmentdelete.htm?id=${ad.id}'/>');" title="Del"><span>Del</span></a>
                                </c:if> --%>
							</td>
							<td>${ad.code}</td>
