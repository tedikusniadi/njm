				...
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">${pageTitle }</h1>
					  	...
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/unitstockadjustmentview.htm'/>"><span>List</span></a>
	                            ...
	                            <c:forEach items='${adjustment_add_detail.items}' var='item' varStatus='status'>
		                            <tr>
		                            	<td colspan="4">
		                            		...
		                            		<strong><c:out value='${item.product.code} - ${item.product.name} [${item.product.types} - ${item.product.typeNames} - ${item.product.colors}]'/></strong>
		                            	</td>
		                            ...
		                            <c:if test="${item.product.serial}">
			                            ...
			                            <c:if test="${item.product.productCategory.id=='1'}">
				                            <tr>
				                            	<td>&nbsp;</td>
				                            	<td><input type="text" size='20' id='serial[${value}]' value='Mesin' name="items[${status.index}].details[${detailStatus.index}].serial" onclick="emptyValue(this);" title="Mesin"/>&nbsp;</td>
				                            	<td><input type="text" size='20' id='serial2[${value}]' value='Rangka' name="items[${status.index}].details[${detailStatus.index}].serialExt1" onclick="emptyValue(this);" title="Rangka"/>&nbsp;</td>
