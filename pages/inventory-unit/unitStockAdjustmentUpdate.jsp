					...
					<div id="se-contents">
						...
						<h1 class="page-title">${pageTitle}</h1>
					  	...
					  	<div class="toolbar">
							...
							<a class="item-button-save b_save" style="cursor: pointer;"><span><spring:message code='save'/></span></a>
					  	</div>
                            	...
                            	<tr>
                            		...
                            		<td class="tools">
										<c:if test='${access.edit}'>
		                                	<a class="item-button-edit" href="<c:url value='/page/unitstockadjustmentitemdetailpreedit.htm?id=${detail.id}'/>" title="Edit"><span>Edit</span></a>
		                                </c:if>
                            		...
                            		<td><c:out value='${detail.serial} ${detail.serialExt1}'/></td>
...
<script type="text/javascript">
	$(function(){
		...
		$('.b_save').click(function(e){
			...
			$.ajax({
				url:"<c:url value='/page/unitstockadjustmentedit.htm'/>",
