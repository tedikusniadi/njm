				...
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">${pageTitle}</h1>
					  	...
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/accessoriesstockadjustmentpreedit.htm?id=${adjustment_detail_edit.stockAdjustmentItem.stockAdjustment.id}'/>"><span>List</span></a>
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="adjustment_detail_edit">
								...
								<tr>
									<td width="20%" nowrap="nowrap" align="right">Serial :</td>
...
<script type="text/javascript">
	$(function(){
		...
		$('.b_save').click(function(e){
			...
			$.ajax({
				url:"<c:url value='/page/accessoriesstockadjustmentitemdetailedit.htm'/>",
				...
				success : function(json) {
					if(json)
					{
						...
						{
							$dialog.dialog('close');
							window.location="<c:url value='/page/accessoriesstockadjustmentpreedit.htm?id='/>"+json.id;
						}
						else
						{
							$dialog.empty();
