...
<head>
	...
	<%@ include file="/filter/productSparepartDiscountFilter.jsp"%>
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/productsparepartdiscountpreadd.htm'/>"><span>New</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/productsparepartdiscountpreedit.htm?id=${discount.id}'/>" title="Edit"><span>Edit</span></a>
								</c:if>
								<c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page//productsparepartdiscountdelete.htm?id=${discount.id}'/>');" title="Delete"><span>Del</span></a>
								</c:if>
							</td>
							<td><c:out value='${discount.organization.name}'/></td>
							<td><c:out value='${discount.categoryType}'/></td>
                            <td><fmt:formatNumber value='${discount.amount}' pattern='#,###'/>%</td>
						</tr>
						</c:forEach>
