...
<head>
	...
	<%@ include file="/filter/productOtherPriceServiceFilter.jsp"%>
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/noticeandservicepreadd.htm?service=true'/>"><span><spring:message code="new"/></span></a>
                                        </c:if>
