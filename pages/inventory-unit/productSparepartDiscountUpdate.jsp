			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="editForm" name="addForm" method="post" modelAttribute="discount_edit">
								<table width="100%" style="border:none">
			 					<tr>
									<td align="right">Organization :</td>
									<td><input disabled='true' class='input-disabled' size='45' value="${discount_edit.organization.name}"/></td>
								</tr>
			 					<tr>
									<td align="right">Tipe Unit :</td>
									<td><input disabled='true' class='input-disabled' size='45' value="${discount_edit.categoryType}"/></td>
								</tr>
                                <tr>
...
<script type="text/javascript">
	$(function(){
		$('.item-button-save').click(function(){
			...
			{
				$.ajax({
					url:"<c:url value='/page/productsparepartdiscountedit.htm'/>",
