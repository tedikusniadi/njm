...
<html>
<head>
	<title>Clear Receipt Print</title>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">			
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/clearreceiptpreedit.htm?id=${clear_edit.id}'/>"><span>Back</span></a>
							...
							<div class="main_container">
									...
									<td width="46%">
										<table>
											<tr>
												<td>Terima Dari<td>
												<td>:</td>
												<td><c:out value='${clear_edit.receipt.customer.firstName} ${clear_edit.receipt.customer.lastName} ${clear_edit.receipt.customer.middleName}'/></td>
											</tr>
											<tr>
												<td><c:out value="${receipt_edit.receiptInformation.paymentMethodType == 'CASH' ? 'Cash' : 'Bank / no rek'}"/><td>
												<td>:</td>
												<td><c:out value="${clear_edit.receiptInformation.bankAccount.accountNo}"/></td>
											</tr>
										</table>
									</td>
									<td width="24%">&nbsp;</td>
									<td width="26%">
										<table>
											<tr>
												<td>No. Bukti<td>
												<td>:</td>
												<td><c:out value="${clear_edit.code}"/></td>
											</tr>
											<tr>
												<td>Tanggal<td>
												<td>:</td>
												<td><fmt:formatDate value='${clear_edit.date}' pattern='dd-MM-yyyy'/></td>
											</tr>
										</table>
									</td>
									<td width="2%" colspan="2">&nbsp;</td>
								...
								<tr>
									...
									<td colspan="3" width="96%" align="center" class="CSS3" align="middle">
										<strong>BUKTI PENERIMAAN <c:out value="${clear_edit.receipt.receiptInformation.paymentMethodType == 'CASH' ? 'CASH' : 'BANK'}"/></strong>
									</td>
									<td width="2%" colspan="2">&nbsp;</td>
								</tr>
								...
								<td colspan="3">
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										...
										<tr>
											...
											<c:forEach items='${clear_edit.receipt.applications}' var='app'>
											<tr>
											...
											<tr>
												<td width="12%" valign="top" style="border-bottom:double 3px black;"><c:out value="${clear_edit.receipt.receiptInformation.paymentMethodType == 'TRANSFER' ? 'Bank' : 'Cash'}"/></td>
												<td width="2%" valign="top" style="border-bottom:double 3px black;">&nbsp;:&nbsp;</td>
												<td width="16%" valign="top" style="border-bottom:double 3px black; border-right:solid 1px black;"><c:out value="${clear_edit.receipt.receiptInformation.bankAccount.bankName}"/></td>
												...
												<c:if test="${clear_edit.receipt.receiptInformation.paymentMethodType != 'CASH'}">	
													<c:out value="${clear_edit.receipt.receiptInformation.reference}"/>
												</c:if>
												</td>
												<td width="10%" valign="top" style="border-bottom:double 3px black;">&nbsp;Tgl cek/giro</td>
												<td width="2%"valign="top" style="border-bottom:double 3px black;">&nbsp;:&nbsp;</td>
												<td width="14%"style="border-bottom:double 3px black; border-right:solid 1px black;">
												<c:if test="${clear_edit.receipt.receiptInformation.paymentMethodType != 'CASH'}">
													<fmt:formatDate value='${clear_edit.receipt.receiptInformation.dueDate}' pattern='dd-MM-yyyy'/>
												</c:if>
												</td>
												<td width="22%" style="border-bottom:double 3px black;" colspan="2"></td>
											</tr>
											<tr>
												<td valign="top" style="border-bottom:double 3px black;">Produk</td>
												<td valign="top" style="border-bottom:double 3px black;">&nbsp;:&nbsp;</td>
												<td valign="top" style="border-bottom:double 3px black; border-right:solid 1px black;"><c:out value="${clear_edit.organization.lastName}"/></td>
												...
												<td valign="top" align="right" style="border-bottom:double 3px black;">Jumlah&nbsp;</td>
												<td valign="top" style="border-bottom:double 3px black;" colspan="2" align="right"><fmt:formatNumber value='${clear_edit.receipt.receiptInformation.amount}' pattern=',##0.00'/>&nbsp;</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td valign="top" style="border-right:solid 1px black; border-bottom:solid 1px black;"><c:out value='${clear_edit.createdBy.firstName} ${clear_edit.createdBy.lastName} ${clear_edit.createdBy.middleName}'/></td>
