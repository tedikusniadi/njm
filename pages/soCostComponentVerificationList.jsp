...
<html>
<head>
	<title>SO Cost Component Verification >> Home</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
        ...
        <tr>
            <td width="60%">Financial Accounting > Accounting Payable > SO Cost Component Verification</td>
						...
						<div class="item-navigator">
                            ...
                            <td width="30%" height="30" align="left" valign="middle">
                                <div class="toolbar-clean">
                                    <a class="item-button-new" href="<c:url value='/page/socostcomponentverificationpreadd1.htm' />"><span>New Verification</span></a>
                        ...
                        <tr>
                            <td class="tools">
                            	<c:if test='${access.edit}'>
	                                <a class="item-button-edit"  href="<c:url value='/page/socostcomponentverificationpreedit.htm?id=${verification.id}'/>"  title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test='${access.delete and empty verification.applications}'>
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/socostcomponentverificationdelete.htm?id=${verification.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
                            </td>
                            ...
                            <td><fmt:formatNumber value="${verification.amount+verification.taxAmount}" pattern=',##0.00'/></td>
                            <td><c:out value="${verification.component.currency.symbol}" /></td>
                        </tr>
                        </c:forEach>
