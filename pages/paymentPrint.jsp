			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                    	<div class="area" dojoType="Container" id="quick_link_container">
                            <div class="toolbar">
                                <a class="item-button-back" href="<c:url value='/page/paymentpreedit.htm?id=${adapter.payment.id}'/>"><span>Back</span></a>
							...
							<div class="main_container">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <td width="25%">: <c:out value='${adapter.payment.code}'/></td>
                                  </tr>
                                  <tr>
                                    <td colspan="3"><c:out value='${profile.organization.fixAddress}'/></td>
                                    <td>&nbsp;</td>
                                    <td>Tanggal</td>
                                    <td>: <fmt:formatDate value='${adapter.payment.date}' pattern='dd MMMM yyyy'/></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="5">: <c:out value='${adapter.payment.supplier.name}'/></td>
                                  </tr>
                                  <tr>
                                    <td>Bank/No Rek</td>
                                    <td colspan="5">: <c:out value='${adapter.payment.paymentInformation.bankAccount.accountNo}'/></td>
                                  </tr>
                                  <tr>
                                    <td colspan="6">&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Uang Sejumlah</td>
                                    <td colspan="5">: Rp. <fmt:formatNumber value='${adapter.payment.paymentInformation.amount}' pattern='#,###'/></td>
                                  </tr>
                                  <tr>
                                    <td>Terbilang</td>
                                  ...
                                  <tr>
                                    <td>Keterangan</td>
                                    <td colspan="5">:
                                    	<c:if test="${adapter.payment.paymentInformation.referenceType == 'NOTADEBET'}">
	                                    	Nota Debit
	                                    </c:if>
                                    </td>
                                  </tr>
