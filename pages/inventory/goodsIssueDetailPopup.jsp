...
<html>
	...
	<script type="text/javascript">
		...
		function searchs()
		{
			var url = "<c:url value='/page/onhandquantitypopupserialview.htm?mode=search&id=${id}&target=${target}'/>";
		...
		function resets()
		{
			window.location = "<c:url value='/page/onhandquantitypopupserialview.htm?id=${id}&target=${target}'/>";
		}
				...
				<div id="r14">
					<div id="se-contents">
						...
						<tr>
							...
							<td width="66%" align="right" height="20"><a href="javascript:step('first','<c:url value='/page/onhandquantitypopupserialview.htm?id=${id}&target=${target}'/>');">First</a> | <a href="javascript:step('prev','<c:url value='/page/onhandquantitypopupserialview.htm?id=${id}&target=${target}'/>');">Prev</a> | Page <c:out value="${filterCriteria.page}"/> of <c:out value="${filterCriteria.totalPage}"/> | <a href="javascript:step('next','<c:url value='/page/onhandquantitypopupserialview.htm?id=${id}&target=${target}'/>');">Next</a> | <a href="javascript:step('last','<c:url value='/page/onhandquantitypopupserialview.htm?id=${id}&target=${target}'/>');">Last</a></td>
						</tr>
						</table>
						...
						<tr>
							<td align="right"><a href="javascript:step('first','<c:url value='/page/onhandquantitypopupserialview.htm?id=${id}&target=${target}'/>');">First</a> | <a href="javascript:step('prev','<c:url value='/page/onhandquantitypopupserialview.htm?id=${id}&target=${target}'/>');">Prev</a> | Page <c:out value="${filterCriteria.page}"/> of <c:out value="${filterCriteria.totalPage}"/> | <a href="javascript:step('next','<c:url value='/page/onhandquantitypopupserialview.htm?id=${id}&target=${target}'/>');">Next</a> | <a href="javascript:step('last','<c:url value='/page/onhandquantitypopupserialview.htm?id=${id}&target=${target}'/>');">Last</a></td>
						</tr>
						</table>
				    </div>
				</div>
