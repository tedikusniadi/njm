...
<html>
<head>
	<title>Stock Adjustment >> Home</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Inventory > Warehouse Management > Stock Adjustment</td>
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/stockadjustmentpreaddone.htm'/>"><span>New Stock Adjustment</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
	                            <c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/stockadjustmentpreedit.htm?id=${ad.id}'/>"  title="Edit"><span>Edit</span></a>
                                </c:if>
                                <!--
