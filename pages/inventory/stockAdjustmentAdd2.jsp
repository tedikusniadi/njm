                            ...
                            <tbody>
	                            ...
	                            <c:forEach items='${adjustment_add_detail.items}' var='item' varStatus='status'>
		                            ...
		                            <c:if test="${item.product.serial}">
			                            ...
			                            <c:if test="${item.product.featureApplicability.productFeature.name=='Unit'}">
				                            <tr>
				                            	<td>&nbsp;</td>
				                            	<td><input type="text" size='20' id='serial[${value}]' value='Mesin' name="serial" onclick="emptyValue(this);" title="Mesin"/>&nbsp;</td>
				                            	<td><input type="text" size='20' id='serial2[${value}]' value='Rangka' name="serialExt1" onclick="emptyValue(this);" title="Rangka"/>&nbsp;</td>
				                                <td><input type="text" size='20' id='year[${value}]' value='Tahun' name="year" onclick="emptyValue(this);" title="Tahun"/>&nbsp;</td>
