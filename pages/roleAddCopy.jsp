...
<head>
	...
	<script type="text/javascript">
		function edit()
		{
			document.addForm.action = "<c:url value='/page/roleaddcopy.htm'/>";
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form name="addForm" method="post" modelAttribute="role_add_copy">
								...
								<c:forEach items="${role_add_copy.accessibleModules}" var="module" varStatus="status">
								<tr>
                                ...
                                <c:forEach items="${role_add_copy.newModules}" var="module" varStatus="status">
								<tr>
								...
								<c:forEach items="${role_add_copy.organizations}" var="organization" varStatus="status">
								<tr>
                                ...
                                <c:forEach items="${role_add_copy.newOrganizations}" var="organization" varStatus="status">
								<tr>
