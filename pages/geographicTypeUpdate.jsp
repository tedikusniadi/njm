...
<html>
<head>
	<title>Geographic Type >> Edit</title>
	<style type="text/css" media="screen"><!-- @import url("assets/sirius.css"); --></style>
	<script type="text/javascript" src="assets/main.js"></script>
	<script type="text/javascript">
		function save()
		{			
			document.addForm.action = "<c:url value='/page/geotypeedit.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Company Administration > General Setting > Geographic Type > Edit</td>
					...
					<div id="se-contents">
						...
						<div class="main-box">
							<c:if test="${not empty message}">
					 		...
					 		<form:form cssClass="edit-form" id="addForm" name="addForm" method="post" modelAttribute="geographicType_edit">
