...
<html>
<head>
	<title>AP Register Summary</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<div class="area" dojoType="Container" id="quick_link_container">
			...
			<tr>
				<td width="60%">Financial Accounting > Account Payable > Report > AP Register Summary </td>
		...
		<div id="r12">
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">
							<h1 class="page-title">F48 - AP Register Summary<br>
							</h1>
						
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/apregistersummarypre.htm'/>"><span>Back</span></a>
								<a class="item-button-print" href="javascript:window.print();"><span>Print</span></a>
                            	<a class="item-button-export-xls" href="<c:url value='/page/apregistersummaryexcell.xls'/>"><span>Export</span></a>
					  		</div>
						</div>
						...
						<div class="main-box">
                            <div class="main_container">
                                ...
                                <thead>
                                <tr>
                                    <th width="10%" style="border-bottom:1px solid black;border-top:1px solid black;">Date</th>
                                    <th width="58%" align="left" style="border-bottom:1px solid black;border-top:1px solid black;">Ref. No</th>
                                    <th width="7%" align="center" style="border-bottom:1px solid black;border-top:1px solid black;">Curr </th>
                                    <th width="9%" align="right" style="border-bottom:1px solid black;border-top:1px solid black;">Rate</th>
                                  	<th align="right" style="border-bottom:1px solid black;border-top:1px solid black;">Amount Rp</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="left"><c:out value='${verification.code}'/></td>
                                ...
                                <tfoot>
                                <tr>
                                    <td colspan="4" align="left" style="border-bottom:1px solid black;"><strong>Total for <c:out value='${report.supplier.code} - ${report.supplier.firstName} ${report.supplier.middleName} ${report.supplier.lastName}'/> </strong></td>
