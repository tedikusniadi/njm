						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="customer">
 								...
 								<tr>
                                    ...
                                    <td align="right">:</td>
                                    <td>
                                        <form:select path="customer" id="customer" class="combobox-ext">
 								...
 								<tr>
                                    ...
                                    <td align="center">:</td>
									<td><input id="plate" name="plateNo" value="${customer.plateNo}"/></td>
 								</tr>
			 					<tr>
									...
									<td>
										<select id="unitType" name="unitType" class="combobox-medium">
											<option>${customer.unitType}</option>
										</select>
 								...
 								<tr>
                                    ...
                                    <td align="center">:</td>
									<td><input id="serialExt1" name="serialExt1" value="${customer.serialExt1}"/></td>
 								</tr>
 								<tr>
 									<td align="right">Tahun</td>
                                    <td align="center">:</td>
									<td><input id="year" name="year" value="${customer.year}"/></td>
 								</tr>
 								</table>
 							</form:form>
						</div>
...
<script type="text/javascript">
	...
	$(function()
	{
		$('.item-button-save').click(function()
		{
			...
			{
				$.ajax({
					url:"<c:url value='/page/customertransactionedit.htm'/>",
