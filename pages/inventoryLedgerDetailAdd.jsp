                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form:select id="product" path="product" cssClass="combobox-ext">
                                            <c:if test='${not empty criteria.product}'>
                                                <form:option value='${criteria.product.id}' label='${criteria.product.code} ${criteria.product.name}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
                                        <img src="assets/icons/list_extensions.gif" onclick="javasctipt:openprod();" style="CURSOR:pointer;" title="Product" />
                                    </td>
                                </tr>
                                <tr>
...
<script type="text/javascript">
	...
	function openprod() {
		...
		openProductByCategory('product', cat.value);
	}
</script>