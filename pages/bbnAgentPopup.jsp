			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<c:forEach items="${sales}" var="agent">
						<tr>
					  		<td class="tools">
					  			<a class="item-button-ok" href="javascript:setclient('${agent.id}','${agent.name}')"  title="Pilih"><span>Pilih</span></a>
					  		</td>
							<td><c:out value='${agent.code}'/></td>
...
<script type="text/javascript">
	...
	function _reset()
	{
		window.location="<c:url value='/page/popupbbnagentview.htm?target=${target}&organization=${filterCriteria.organization}'/>";
	}
</script>