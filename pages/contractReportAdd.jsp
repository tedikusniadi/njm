...
<html>
<head>
	<title>Contract Recapitulation Report</title>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/contractreportview.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Transport Outsource > Transport Outsource Reports > Contract Recapitulation</td>
