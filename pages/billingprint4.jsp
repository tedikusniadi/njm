...
<!-- BEGIN OF BODY INVOICE TAX SUMMARY -->
<body>
...
<div id="se-containers">
	...
	<div id="r11">
					...
					<div class="main-box">
                        ...
                        <tr>
							  ...
							  <tr>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" topmargin="0" class="border-top border-bottom">
                                  <tr>
                                     ...
                                     <td colspan="3" valign="top">
                                        <table width="880" border="0" cellpadding="0" cellspacing="0" topmargin="0">
                                                ...
                                                <tr class="CSS1" style="font-weight:normal;" height="15">
                                                      <td valign="top" width="51" align="center" class="border-right">&nbsp;<font class="CSS1"><c:out value="${status.index+1}"/></font></td>
                                                      <td valign="top" width="528" class="border-right">&nbsp;<font class="CSS1"><c:out value='${line.name}'/>&nbsp;x&nbsp;<fmt:formatNumber value='${line.quantity}' pattern='0'/></font></td>
                                                      <td valign="top" width="300" align="right">&nbsp;<font class="CSS1"><fmt:formatNumber value='${line.amount}' pattern=',##0.00'/></font>&nbsp;&nbsp;</td>
                                                </tr>
                                  ...
                                  <tr>
                                  	<td colspan="2" class="border-bottom border-right">&nbsp;&nbsp;<font class="CSS1"><s>Harga Jual</s>/Penggantian/<s>Uang Muka</s>/<s>Termin</s>*) </font></td>
        ...
        <tr>
                <td align="center" nowrap="nowrap" class="CSS1" height="20" valign="bottom">
