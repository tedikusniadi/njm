...
<html>
<head>
	<title>Route Recapitulation Report</title>
	...
	<script type="text/javascript">
		function generate()
		{
			document.reportForm.action = "<c:url value='/page/routerecapitulationreportview.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Transport Outsource > Transport Outsource Reports > Route Recapitulation</td>
					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post">
                                ...
                                <tr>
                                    <td><div align="right">Route :</div></td>
                                    <td>
                                        <select id="route" name="route" class="combobox-ext">
                                        </select>
                                        &nbsp;
                                        <img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="javascript:openpopup('<c:url value='/page/popuptransportoutsourcedestinationview.htm?target=route'/>');" style="CURSOR:pointer;" title="Transport outsource route" />
                                    </td>
                                </tr>
                                <tr>
