...
<html>
<head>
	<title>Receipt Summary Per Customer</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<div class="area" dojoType="Container" id="quick_link_container">
			...
			<tr>
				<td width="60%">
					Financial Accounting > Account Receivables > Report &gt; Receipt Summary Per Customer </td>
		...
		<div id="r12">
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">
							<h1 class="page-title">F28 - Receipt Summary Per Customer <br>
							</h1>
						
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/receiptsummaryreportprepare.htm'/>"><span>Back</span></a>
								<a class="item-button-print" href="javascript:window.print();"><span>Print</span></a>
                            	<a class="item-button-export-xls" href="<c:url value='/page/receiptsummaryreportexport.xls?organization=${organization.id}&dateFrom='/><fmt:formatDate value='${dateFrom}' pattern='dd-MM-yyyy'/>&dateTo=<fmt:formatDate value='${dateTo}' pattern='dd-MM-yyyy'/>"><span>Export</span></a>
					  		</div>
					  </div>
						...
						<br>
							<div class="report"><strong>REPORT RECEIPT SUMMARY PER CUSTOMER</strong></div>
							<br>
	    					<table width="498">	
		   						<tr>	
					...
					<c:forEach items='${report}' var='receipt'>
					  ...
					  <tr>
						<td colspan="6" align="right"><strong>Total for &nbsp;<c:out value='${receipt.customer.firstName}'/>&nbsp;<c:out value='${receipt.customer.middleName}'/>&nbsp;<c:out value='${receipt.customer.lastName}'/> : </strong></td>
