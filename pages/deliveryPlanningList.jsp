...
<html>
<head>
	<title>Delivery Planning >> Home</title>
	<%@ include file="/common/sirius-header.jsp"%>
	<script type="text/javascript" src="assets/dialog.js"></script>
	<%@ include file="/filter/deliveryPlanningFilter.jsp"%>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Sales > Delivery Planning</td>
				...
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/deliveryplanningpreadd1.htm'/>"><span>New Delivery Planning</span></a>
                                        </c:if>
						...
						<tr>
                            ...
                            <td><c:out value='${plan.planable.customer.firstName} ${plan.planable.customer.middleName} ${plan.planable.customer.lastName}'/></td>
                            <td><a href="<c:url value='/page/${plan.planable.uri}?id=${plan.planable.id}'/>"><c:out value='${plan.planable.code}'/></a></td>
						</tr>
						</c:forEach>
