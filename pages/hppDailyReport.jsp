...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Sales > Report > HPP Daily</td>
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="date" inputId='date' formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/>
                                    </td>
                                </tr>
				  				</table>
							</form>
...
<script type="text/javascript">
	$(function(){
		$('.item-button-generate-report').click(function(){
			...
			document.reportForm.action = "<c:url value='/page/hppdailyreportview.htm'/>";
