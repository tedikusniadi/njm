			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                    	<div class="area" dojoType="Container" id="quick_link_container">
                            <div class="toolbar">
                                <a class="item-button-back" href="<c:url value='/page/unitinvoicemaindealerapprovaldetailpreedit.htm?id=${dealerApprovalDetail.id}'/>"><span>Back</span></a>
                                      ...
                                      <tr>
                                        <td width="220" height="120" valign="top" class="style1" style="border-left:solid 1px black;border-top:solid 1px black;"><table width="245" height="113" border="0" cellspacing="0" cellpadding="0">
                                          ...
                                          <tr>
                                            ...
                                            <td>:</td>
                                            <td><fmt:formatDate value='${dealerApprovalDetail.dealerApproval.date}' pattern='dd MMMM yyyy'/></td>
                                          </tr>
                                          <tr>
                                            <td>&nbsp;</td>
