...
<head>
	...
	<%@ include file="/filter/unitInvoiceMainDealerApprovalAddFilter.jsp"%>
...
$(document).ready(function(){
	$(".item-button-process").click(function()
	{
		...
		.html('Approval Invoice Main Dealer sebanyak '+total+', lanjutkan Approval ?');
		...
		$dialog_confirm.dialog({
			...
			buttons: {
				...
				{
					$( this ).dialog( "close" );
					document.formData.action="<c:url value='/page/unitinvoicemaindealerapprovalprocess.htm'/>";
