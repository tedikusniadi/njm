			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
										<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/unitsalesorderpreadd.htm'/>"><span><spring:message code='new'/></span></a>
										</c:if>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/unitsalesorderpreedit.htm?id=${order.unitSalesOrder.id}'/>" title="Edit"><span>Edit</span></a>
							</td>
