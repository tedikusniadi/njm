			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="paymentProgram_add">
								...
								<tr>
									...
									<td width="73%">
										<select id="org" name="organization" class="combobox-ext">
											<c:if test="${not empty paymentProgram_add.organization}">
												<option value="${paymentProgram_add.organization.id}">${paymentProgram_add.organization.code} ${paymentProgram_add.organization.name}</option>
											</c:if>
										</select>
										&nbsp;
										<img src="assets/icons/list_extensions.gif" onclick="openOrg('org');" style="CURSOR:pointer;" title="Company Structure" />
									</td>
								</tr>
								<tr>
									<td nowrap="nowrap" align="right">Program Name :</td>
									<td><input id="programName" name="name" size='30'/></td>
								</tr>
 								<tr>
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		...
		$.ajax({
			url:"<c:url value='/page/unitsalespaymentprogramadd.htm'/>",
