...
<head>
	...
	<%@ include file="/filter/unitSalesOrderCrossCompanyFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
										<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/unitsalesordercrosscompanypreadd.htm'/>"><span><spring:message code='new'/></span></a>
										</c:if>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/unitsalesordercrosscompanypreedit.htm?id=${order.unitSalesOrder.id}'/>" title="Edit"><span>Edit</span></a>
							</td>
							...
							<td><fmt:formatNumber value="${order.totalForCustomerDealer}" pattern=',##0.00'/></td>
							<td><c:out value='${order.unitSalesOrder.currency.symbol}'/></td>
							<td>${order.unitSalesOrder.unitPayment}</td>
							<td>${order.unitSalesOrder.status}</td>
							<td><c:out value='${order.unitSalesOrder.note}'/></td>
						</tr>
						</c:forEach>
