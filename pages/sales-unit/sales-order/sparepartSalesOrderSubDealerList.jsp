...
<head>
	...
	<%@ include file="/filter/sparepartSalesOrderSubDealerFilter.jsp"%>
								...
								<td width="70%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/sparepartsalesordersubdealerpreaddone.htm'/>"><span>New SPK Sub Dealer</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/sparepartsalesordersubdealerpreedit.htm?id=${order.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/sparepartsalesordersubdealerdelete.htm?id=${order.id}'/>');" title="Delete"><span>Del</span></a>
                                </c:if>
							</td>
