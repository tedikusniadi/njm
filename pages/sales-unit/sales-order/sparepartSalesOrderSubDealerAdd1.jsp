				...
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
                                ...
                                <tr>
									...
									<td>
										...
										<c:if test='${not empty sparepartSOSubdealer_add.organization}'>
											<form:option value='${sparepartSOSubdealer_add.organization.id}' label='${sparepartSOSubdealer_add.organization.name}' />
										</c:if>
										</form:select>
                                ...
                                <tr>
									...
									<td>
										...
										<c:if test='${not empty sparepartSOSubdealer_add.subDealer}'>
											<form:option value='${sparepartSOSubdealer_add.subDealer.id}' label='${sparepartSOSubdealer_add.subDealer.name}' />
										</c:if>
										</form:select>
									...
									<td>
										<form:select id="source" path="source" cssClass="combobox-ext">
                                           	<c:if test='${not empty sparepartSOSubdealer_add.source}'>
                                               	<form:option value='${sparepartSOSubdealer_add.source.id}' label='${sparepartSOSubdealer_add.source.name}' />
                                            </c:if>
										</form:select>
									...
									<td>
										<form:select id="destination" path="destination" cssClass="combobox-ext">
                                           	<c:if test='${not empty sparepartSOSubdealer_add.destination}'>
                                               	<form:option value='${sparepartSOSubdealer_add.destination.id}' label='${sparepartSOSubdealer_add.destination.name}' />
                                            </c:if>
										</form:select>
                            ...
                            <div id="unit" dojoType="ContentPane" label="Sparepart" class="tab-pages" refreshOnShow="true">
...
<script type="text/javascript">
	function save(_forward)
	{
		if(validation())
		{
			document.addForm.action = "<c:url value='/page/sparepartsalesordersubdealerpreaddtwo.htm?new='/>"+_forward;
