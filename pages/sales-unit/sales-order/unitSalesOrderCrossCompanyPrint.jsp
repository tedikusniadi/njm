			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                    	<div class="area" dojoType="Container" id="quick_link_container">
                            <div class="toolbar">
                                <a class="item-button-back" href="<c:url value='/page/unitsalesordercrosscompanypreedit.htm?id=${salesOrder_edit.id}'/>"><span>Back</span></a>
							...
							<div class="main_container">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td colspan="2" valign="top">/ <c:forEach items="${salesOrder_edit.customer.postalAddresses}" var="add"><c:out value='${add.address}'/></c:forEach></td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td>Discount</td>
                                    <td colspan="2">: <fmt:formatNumber value="${salesAdapter.discDealer+salesAdapter.program}" pattern='#,###'/></td>
                                    <td>&nbsp;</td>
                                    <td>Subsidi</td>
                                    <td>: <fmt:formatNumber value="${salesAdapter.subdictionLeasing+salesAdapter.mainDealer}" pattern='#,###'/></td>
                                  </tr>
                                  <tr>
                                    <td>Bayar Tunai</td>
