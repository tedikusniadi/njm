                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post">
                                ...
                                <tr>
									...
									<td>
										<select id="facility" name="facilityId" class="combobox-ext">
										</select>
                                ...
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="notYetBillingLeasing" value="true"/>Belum Billing Leasing</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="alreadyBillingLeasing" value="true"/>Sudah Billing Leasing</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="notYetBillingSubLeasing" value="true"/>Belum Billing Sub Leasing</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="alreadyBillingSubLeasing" value="true"/>Sudah Billing Sub Leasing</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="notYetBillingCustomer" value="true"/>Belum Billing Pelanggan</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="alreadyBillingCustomer" value="true"/>Sudah Billing Pelanggan</td>
                                </tr>
				  				</table>
							</form>
						</div>
...
<script type="text/javascript">
	function generate()
	{
		...
		document.reportForm.action = "<c:url value='/page/dailytransactionreporthonewview.htm'/>";
