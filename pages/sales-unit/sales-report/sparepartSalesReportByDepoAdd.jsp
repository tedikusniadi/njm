			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post" modelAttribute="sparepartSalesByDepoCriteria">
								...
								<tr>
                                    ...
                                    <td>
                                        <select id="year" name="year">
	 							  			...
	 							  			<c:forEach items="${sparepartSalesByDepoCriteria.years}" var="y">
...
<script type="text/javascript">
	function generate()
	{
		...
		document.reportForm.action = "<c:url value='/page/sparepartsalesbydeporeportview.htm'/>";
