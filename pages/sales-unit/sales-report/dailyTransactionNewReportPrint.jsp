...
<table id="tableData" width="100%" cellpadding="4" cellspacing="0" class="report-table">
	...
	<c:forEach items='${reports}' var='rep'>
		...
		<tr>
			<td colspan="78" nowrap="nowrap" style="border-bottom:1px solid black;border-right:1px solid black;border-left:1px solid black;"><strong><c:out value='${adap.organization}'/></strong></td>
		</tr>
