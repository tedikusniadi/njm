...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/bpkbreportview.htm'/>";
					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post" modelAttribute="criteria">
                                ...
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="received" value="true"/>BPKB yang sudah diterima</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="delivered" value="true"/>BPKB sudah diserahkan kekonsumen</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="notYetDelivered" value="true"/>BPKB belum diserahkan kekonsumen</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="deliveredLeasing" value="true"/>BPKB sudah diserahkan keleasing</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="notYetDeliveredLeasing" value="true"/>BPKB belum diserahkan keleasing</td>
                                </tr>
                                <tr>
