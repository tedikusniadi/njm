...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/unithistorydetailreportview.htm'/>";
					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post" modelAttribute="criteria">
								...
								<tr>
                                    <td><div align="right">No Mesin :</div></td>
                                    <td><input id="serial" name="serial" size="20"/></td>
                                </tr>
				  				</table>
							</form>
						</div>
