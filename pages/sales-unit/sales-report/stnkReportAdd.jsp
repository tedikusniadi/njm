...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/stnkreportview.htm'/>";
					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post" modelAttribute="criteria">
                                ...
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="received" value="true"/>STNK yang sudah diterima</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="delivered" value="true"/>Sudah diserahkan kekonsumen</td>
                                </tr>
                                <tr>
                                    <td align="right">&nbsp;</td>
                                    <td><input type="checkbox" name="notYetDelivered" value="true"/>Belum diserahkan kekonsumen</td>
                                </tr>
                                <tr>
