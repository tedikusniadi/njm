...
<thead>
	<tr>
        ...
        <th width="15%" align="left" nowrap="nowrap" style="border-bottom:1px solid black;border-top:1px solid black;">Tgl SJ</th>
        ...
        <th width="15%" align="left" nowrap="nowrap" style="border-bottom:1px solid black;border-top:1px solid black;">No Polisi</th>
        <th width="10%" align="left" nowrap="nowrap" style="border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;">No BPKB</th>
    </tr>
</thead>
<tbody>
<c:forEach items='${reports}' var='report'>
	...
	<c:forEach items='${report.datas}' var='data'>
		<tr>
	    	<td nowrap="nowrap" style="border-bottom:1px solid black;border-left:1px solid black;"><fmt:formatDate value="${data.salesOrderAdapter.unitSalesOrder.date}" pattern="dd-MM-yyyy"/></td>
	        ...
	        <td nowrap="nowrap" style="border-bottom:1px solid black;"><fmt:formatDate value="${data.salesOrderAdapter.unitSalesOrder.date}" pattern="dd-MM-yyyy"/></td>
	        ...
	        <td nowrap="nowrap" style="border-bottom:1px solid black;border-right:1px solid black;"><c:out value='${data.bpkbNumber}'/></td>
	    </tr>
	</c:forEach>
</c:forEach>
</tbody>
