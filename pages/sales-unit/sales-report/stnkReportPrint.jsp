...
<thead>
	<tr>
        ...
        <th width="10%" align="left" nowrap="nowrap" style="border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;">No STNK</th>
    </tr>
</thead>
<tbody>
<c:forEach items='${reports}' var='report'>
	...
	<c:forEach items='${report.datas}' var='data'>
		<tr>
	        ...
	        <td nowrap="nowrap" style="border-bottom:1px solid black;border-right:1px solid black;"><c:out value='${data.stnkNumber}'/></td>
	    </tr>
	</c:forEach>
</c:forEach>
</tbody>
