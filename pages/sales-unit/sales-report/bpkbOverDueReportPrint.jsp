...
<c:forEach items='${datas}' var='data'>
	<tr>
        ...
        <td nowrap="nowrap" style="border-bottom:1px solid black;"><c:out value='${data.bbnDetail.bbn.city.name}'/></td>
        <td nowrap="nowrap" style="border-bottom:1px solid black;border-right:1px solid black;"><fmt:formatDate value='${data.bbnDetail.bbn.date}' pattern='dd-MM-yyyy'/></td> 
    </tr>
</c:forEach>
</tbody>
</table>
