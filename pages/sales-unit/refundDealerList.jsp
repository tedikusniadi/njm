...
<head>
	...
	<%@ include file="/filter/refundDealerFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/refunddealerpreadd.htm'/>"><span><spring:message code="new"/></span></a>
                                        </c:if>
						...
						<c:forEach items="${refunds}" var="ref">
						<tr>
							<td>&nbsp;</td>
							<td><fmt:formatDate value='${ref.dateFrom}' pattern='dd-MM-yyyy'/></td>
                            <td>${ref.organization.name}</td>
							<td>${ref.leasing.name}</td>
                            <td><fmt:formatNumber value='${ref.amount}' pattern=',##0.00'/></td>
						</tr>
						</c:forEach>
