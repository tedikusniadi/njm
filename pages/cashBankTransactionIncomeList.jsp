...
<html>
<head>
	<title>Cash Bank Transaction Income</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Financial Accounting > Cash Bank Management > Cash/Bank Income</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F52 - Cash/Bank Income</h1>
						<div id="clears">&nbsp;</div>
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/cashbanktransactionincomepreadd.htm'/>"><span>New Income</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
                            	<a class="item-button-edit" href="<c:url value='/page/cashbanktransactionincomepreedit.htm?id=${trx.id}'/>"  title="Edit"><span>Edit</span></a>
								<c:if test="${access.delete and trx.deleteable}">
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/cashbanktransactionincomedelete.htm?id=${trx.id}'/>');" title="Del"><span>Del</span></a>
								</c:if>
							</td>
