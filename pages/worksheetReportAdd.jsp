...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			document.reportForm.action = "<c:url value='/page/worksheetreportview.htm'/>";
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">RF64 - Worksheet Report</h1>
                    	...
                    	<div class="main-box">
							<form:form name="reportForm" id="reportForm" method="post" modelAttribute="simpleAccountingReportAdapter">
