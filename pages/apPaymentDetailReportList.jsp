...
<div id="se-containers">
	...
	<div id="se-navigator">
		<div class="area" dojoType="Container" id="quick_link_container">
			...
			<tr>
				<td width="60%">Financial Accounting > Account Payable > Report > AP Payment Detail</td>
		...
		<div id="r12">
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">
							<h1 class="page-title">F53 - AP Payment Detail<br>
							</h1>
						
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/appaymentdetailpre.htm'/>"><span>Back</span></a>
								<a class="item-button-print" href="javascript:window.print();"><span>Print</span></a>
                            	<a class="item-button-export-xls" href="<c:url value='/page/appaymentdetailexcell.xls'/>"><span>Export</span></a>
					  		</div>
						</div>
						
						<div class="main-box">
                            <div class="main_container">
                            	<div class="report"><strong>REPORT AP PAYMENT DETAIL</strong></div>
                                ...
                                <tr>
                                    ...
                                    <th width="8%" align="left" style="border-bottom:1px solid black;border-top:1px solid black;">Type</th>
                           	  	  	<th width="24%" align="left" style="border-bottom:1px solid black;border-top:1px solid black;">No</th>
                           	  	  	<th width="10%" align="left" style="border-bottom:1px solid black;border-top:1px solid black;">Referensi</th>
                           	  	  	<th width="35%" align="left" style="border-bottom:1px solid black;border-top:1px solid black;">Description</th>
                           	  	  	<th width="15%" align="right" style="border-bottom:1px solid black;border-top:1px solid black;">Amount</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="left"><c:out value='${payment.paymentInformation.reference}'/></td>
	                                ...
	                                <c:forEach items='${payment.applications}' var='application'>
	                                <tr>
	                                    <td align="left">&nbsp;</td>
	                                    <td align="left">&nbsp;</td>
	                                    <td align="left">&nbsp;&nbsp;&nbsp;<c:out value='${application.payable.code}'/></td>
	                                    <td></td>
	                                    <td align="left">&nbsp;&nbsp;&nbsp;<c:out value='${application.payable.note}'/></td>
	                                    <td align="right"><fmt:formatNumber value='${application.paid+application.writeOff}' pattern=',##0.00'/></td>
	                                </tr>
	                                </c:forEach>
                                ...
                                <tr>
                                  	...
                                  	<td align="right" width="17%" style="border-top:1px solid black;"></td>
