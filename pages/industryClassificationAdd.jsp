...
<html>
<head>
	<title>Industry Classification >> Add</title>
	<style type="text/css" media="screen"><!-- @import url("assets/sirius.css"); --></style>
	
	<script type="text/javascript">
		function save()
		{			
			document.addForm.action = "<c:url value='/page/industryclassificationadd.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Company Administration > General Setting > Industry Classification > Add</td>
				...
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							...
							<form:form cssClass="edit-form" id="addForm" name="addForm" method="post" modelAttribute="partyClassificationType_add">
