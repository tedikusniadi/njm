...
<html>
<head>
	<title>Invoice Verification >> Edit</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Account Payable > Invoice Verification > Edit</td>
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="verification_edit">
                                ...
                                <tr>
                                	<td width="47%" align="left" valign="top">
                                   	  <table width="100%" style="border:none">
                                        <tr>
                                            <td width="22%" nowrap="nowrap" align="right">ID :</td>
                                          <td width="78%"><input value="${verification_edit.code}" class='input-disabled' size='25' disabled/></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input size="10" class="input-disabled" disabled value="<fmt:formatDate value='${verification_edit.date}' pattern='dd-MM-yyyy'/>"/></td>
                                        </tr>
                                        <tr>
                                            <td width="22%" nowrap="nowrap" align="right">Bill From :</td>
                                          <td width="78%"><input value="${verification_edit.supplier.firstName} ${verification_edit.supplier.middleName} ${verification_edit.supplier.lastName}" class='input-disabled' size='45'/></td>
                                        </tr>
                                        <tr>
                                            <td width="22%" nowrap="nowrap" align="right">Invoice :</td>
                                          	<td width="78%"><form:input path='invoice' size='30' cssClass='input-disabled' disabled='true'/></td>
                                        </tr>
                                        <tr>
                                          <td width="22%" nowrap="nowrap" align="right">Due Date :</td>
                                          <td width="78%"><input size="10" class="input-disabled" disabled value="<fmt:formatDate value='${verification_edit.dueDate}' pattern='dd-MM-yyyy'/>"/></td>
                                        </tr>
                                        <tr>
                                            <td width="22%" nowrap="nowrap" align="right">Currency :</td>
                                      		<td width="78%">
                       							<input value="${verification_edit.purchaseOrder.money.currency.symbol}" class='input-disabled' size='6'/>
                                                &nbsp;
                                                <input value="${verification_edit.purchaseOrder.money.exchangeType}" class='input-disabled' size='10'/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="24%" nowrap="nowrap" align="right">Tax 1 :</td>
                                            <td width="76%">
                                            	<input value="${verification_edit.purchaseOrder.tax.taxId}" class='input-disabled' size='6'/>
                                                &nbsp;
                                        ...
                                        <tr>
                                            ...
                                            <td width="76%">
                                            	<input value="${verification_edit.purchaseOrder.extTax1.taxId}" class='input-disabled' size='6'/>
                                                &nbsp;
                                        ...
                                        <tr>
                                            ...
                                            <td width="76%">
                                            	<input value="${verification_edit.purchaseOrder.extTax2.taxId}" class='input-disabled' size='6'/>
                                                &nbsp;
                                        ...
                                        <tr>
                                            <td width="22%" nowrap="nowrap" align="right">Note :</td>
                                          <td width="78%"><form:textarea path='note' cols='45' rows='5'/></td>
                                        </tr>
                                        </table>
                                    </td>
                   	  ...
                   	  <table style="border:none" width="100%">
                                        	...
                                        	<td width="51%" align="left" valign="top">
                                        		<fieldset>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        	<c:forEach items='${verification_edit.receipts}' var='receipt' varStatus='status'>
                                        	...
                                        	<td colspan="2" valign="top">
                                            	<fieldset>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input id="trx" style="text-align:right;" value="<fmt:formatNumber value='${verification_edit.rounding}' pattern=',##0.00'/>" size="15" class="input-disabled" disabled/></td>
                                                        <td><input id="trxdef" style="text-align:right;" value="<fmt:formatNumber value='${verification_edit.rounding}' pattern=',##0.00'/>" size="15" class="input-disabled" disabled/></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input id="deftotal" style="text-align:right;" value="<fmt:formatNumber value='${deftrx+(deftrx*verification_edit.purchaseOrder.tax.taxRate/100)+(deftrx*verification_edit.purchaseOrder.extTax1.taxRate/100)+(deftrx*verification_edit.purchaseOrder.extTax2.taxRate/100)+verification_edit.rounding}' pattern=',##0.00'/>" size="15" class="input-disabled" disabled/></td>
                                                    </tr>
                                                    </table>
                                                </fieldset>                                                
                                            </td>
                                ...
                                <tr>
                                    ...
                                    <th width="9%">Bought Qty</th>
                                    <th width="9%">Received Qty</th>
                                    <th width="5%">UoM</th>
                                    <th width="11%">Price/Unit</th>
                                    <th width="8%">Disc/Unit</th>                                    
                                    <th width="8%">Total</th>
                                </tr>
                                <c:forEach items="${verification_edit.receipts}" var="rec" varStatus='status'>
                                ...
                                <tr>
                                    ...
                                    <td><fmt:formatNumber value='${item.discountAmount}' pattern=',##0.00'/></td>
                                    <td><fmt:formatNumber value='${(item.warehouseTransactionItem.money.amount * item.receipted)-(item.discountAmount * item.receipted)}' pattern=',##0.00'/></td> 
                                </tr>
                                </c:forEach>
                                </c:forEach>
	...
	$(function(){
		...
		$('.item-button-save').click(function(){
			$.ajax({
				...
				{
					$dialog.empty();
					$dialog.html('Updating Invoice Verification data......');
					$dialog.dialog('open');
				},
