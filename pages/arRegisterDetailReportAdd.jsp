...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/arregisterdetaireportview.htm'/>";
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F37 - AR Register Detail</h1>
							...
							<form:form name="reportForm" id="reportForm" method="post" modelAttribute="criteria">
                                ...
                                <tr>
                                    ...
                                    <td width="72%">
                                        ...
                                        &nbsp;
                                        <img src="assets/icons/list_extensions.gif" onclick="javascript:opencustomer();" style="CURSOR:pointer;" title="Customer" />
                                    </td>
                                </tr>
                                <tr>
