...
<html>
<head>
	<title>Journal Entry Index >> Edit</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Accounting Setting > Journal Entry Index > Edit</td>
			...
			<div id="r13">
				<div id="r14">
					...
					<div class="main-box">
						...
						<form:form cssClass="edit-form" id="editForm" name="editForm" method="post" modelAttribute="journalEntryIndex_edit">
