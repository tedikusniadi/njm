                                ...
                                <tr>
									...
									<td>
										<form:select id="org" path="organization" cssClass="combobox-ext">
                                           	<c:if test='${not empty manual_billing_add.organization}'>
                                ...
                                <tr>
                                  	...
                                  	<td>
                                        <form:select id="taxAddress" path="taxAddress" cssClass="combobox-ext">
                                            <c:if test='${not empty manual_billing_add.taxAddress}'>
                                                <form:option value='${manual_billing_add.taxAddress.id}' label='${manual_billing_add.taxAddress.party.firstName} ${manual_billing_add.taxAddress.party.middleName} ${manual_billing_add.taxAddress.party.lastName}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
								...
								<tr>
									...
									<td>
										<form:select id="customer" path="customer" cssClass="combobox-ext">
                                           	<c:if test='${not empty manual_billing_add.customer}'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form:select id="customerContactPerson" path="customerContactPerson" cssClass="combobox-ext">
                                            <c:if test='${not empty manual_billing_add.customerContactPerson}'>
                                                <form:option value='${manual_billing_add.customerContactPerson.id}' label='${manual_billing_add.customerContactPerson.firstName} ${manual_billing_add.customerContactPerson.lastName} ${manual_billing_add.customerContactPerson.middleName}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
                                ...
                                <tr>
									...
									<td>
										...
										<form:select id="taxcode" path="taxNumber.invoiceTax" cssClass="combobox">
                                           	<c:if test='${not empty manual_billing_add.taxNumber.invoiceTax}'>
								...
								<tr>
                                    ...
                                    <td>
                                    	<form:select path='billingType'>
                                        	<form:option value='4' label='MANUAL'/>
                                        </form:select>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form:select id="activeRole" path="activeRole" cssClass="combobox-ext">
                                            <c:if test='${not empty manual_billing_add.activeRole}'>
                                                <form:option value='${manual_billing_add.activeRole.id}' label='${manual_billing_add.activeRole.fromRole.roleType.name}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
...
<script type="text/javascript">
	function save()
	{		
		document.addForm.action = "<c:url value='/page/manualbillingpreadd2.htm'/>";
