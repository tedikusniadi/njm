...
<head>
	...
	<script type="text/javascript">
		function save()
		{			
			document.addForm.action = "<c:url value='/page/productassociationadd.htm'/>";
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="association">
                                ...
                                <tr>
									<td width="20%" align="right" nowrap="nowrap">Valid From :</td>
							  	  	<td width="45%"><input id="from" name="from" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
                                  	<td width="35%">&nbsp;</td>
								</tr>
                                <tr>
									<td nowrap="nowrap" align="right">Valid To :</td>
									<td><input id="to" name="to" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
                                   <td width="35%">&nbsp;</td>
								</tr>
 								<tr>
 									<td align="right">Quantity :</td>
									<td><form:input path="quantity" size='15'/></td>
									<td width="35%">&nbsp;</td>
	 							</tr>
	 							<tr>
									...
									<td>
                                    	<form:select id="pro" path="product" cssClass="combobox">
                                       	...
                                       	&nbsp;
										<img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="javascript:openpopup('<c:url value='/page/popupproductview.htm?target=pro'/>');" style="CURSOR:pointer;" title="Product" />
                                    </td>
                                ...
                                <tr>
									...
									<td>
                                    	<form:select path="associationType" cssClass="combobox">
