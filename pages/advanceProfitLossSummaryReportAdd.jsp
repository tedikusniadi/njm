...
<html>
	<head>
		<title>Advance Profit and Loss Report >> Home</title>
		...
		<script type="text/javascript">
			function generate()
			{
				document.reportForm.action = "<c:url value='/page/advanceprofitlosssummaryreportview.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Reports > Financial Accounting > Accounting > Advance Profit Loss Summary</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title"> RF77 - Advance Profit and Loss Summary</h1>
							...
							<form:form name="reportForm" method="post" modelAttribute="filterCriteria">
                                ...
                                <tr>
									...
									<td valign="top">
                                        ...
                                        <c:forEach items='${filterCriteria.indexes}' var='index' varStatus='status'>
                                        <tr>
