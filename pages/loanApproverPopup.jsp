...
<html>
	<head>
	<title>Loan Approver >> Popup</title>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<tr>
							<td>
								<form id="filterForm" name="filterForm" method="post" action="/page/popuploanapproverview.htm?target=${target}">
						...
						<tr>
							...
							<td width="66%" align="right" height="20"><a href="javascript:step('first','<c:url value='/page/popuploanapproverview.htm?target=${target}'/>');">First</a> | <a href="javascript:step('prev','<c:url value='/page/popuploanapproverview.htm?target=${target}'/>');">Prev</a> | Page <c:out value="${filterCriteria.page}"/> of <c:out value="${filterCriteria.totalPage}"/> | <a href="javascript:step('next','<c:url value='/page/popuploanapproverview.htm?target=${target}'/>');">Next</a> | <a href="javascript:step('last','<c:url value='/page/popuploanapproverview.htm?target=${target}'/>');">Last</a></td>
						</tr>
						</table>
						...
						<tr>
							<td align="right"><a href="javascript:step('first','<c:url value='/page/popuploanapproverview.htm?target=${target}'/>');">First</a> | <a href="javascript:step('prev','<c:url value='/page/popuploanapproverview.htm?target=${target}'/>');">Prev</a> | Page <c:out value="${filterCriteria.page}"/> of <c:out value="${filterCriteria.totalPage}"/> | <a href="javascript:step('next','<c:url value='/page/popuploanapproverview.htm?target=${target}'/>');">Next</a> | <a href="javascript:step('last','<c:url value='/page/popuploanapproverview.htm?target=${target}'/>');">Last</a></td>
						</tr>
						</table>
				    </div>
				</div>
