...
<html>
<head>
	<title>Production Planning >> Home</title>
	<%@ include file="/common/sirius-header.jsp"%>
	<script type="text/javascript" src="assets/dialog.js"></script>
	<%@ include file="/filter/productionPlanningFilter.jsp"%>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Production > Production Planning</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/productionplanningpreadd.htm'/>"><span>New Planning</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/productionplanningpreedit.htm?id=${plan.id}'/>" title="Edit"><span>Edit</span></a>
                                <c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/productionplanningdelete.htm?id=${plan.id}'/>');" title="Del"><span>Del</span></a>
                                </c:if>
							</td>
							<td><c:out value='${plan.code}'/></td>
                            <td><c:out value='${plan.name}'/></td>
                            <td><c:out value='${plan.organization.firstName} ${plan.organization.middleName} ${plan.organization.lastName}'/></td>
