...
<html>
<head>
	<title>SO Cost Component Invoice Verification >> Add</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Account Payable > SO Cost Component Verification > Add</td>
				...
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F60 - SO Cost Component Verification </h1>
					  	...
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/socostcomponentverificationpreadd1.htm'/>"><span>List</span></a>
                                	...
                                	<td width="53%" align="left" valign="top">
                                        ...
                                        <tr>
                                            <td width="26%" nowrap="nowrap" align="right">Tax :</td>
                                          	<td width="74%">
                                            	<select>
                                                	<option><c:out value='${verification_add.component.tax.taxId}'/></option>
                                                </select>
                                                &nbsp;
                                                <input size="7" id="taxRate" class="input-disabled" value="<c:out value='${verification_add.component.tax.taxRate}'/>" disabled/>
                                       	  	</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                        	<td colspan="2" valign="top">
                                            	<fieldset>
                                                    ...
                                                    <tr>
                                                        <th width="43%">&nbsp;</th>
                                                        <th width="31%" align="center">Amount (<c:out value='${verification_add.component.currency.symbol}'/>)</th>
...
<script type="text/javascript">
	function save()
	{		
		document.addForm.action = "<c:url value='/page/socostcomponentverificationadd.htm'/>";
