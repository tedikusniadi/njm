...
<html>
<head>
	<title>Balance Sheet Summary Report</title>
	...
	<script type="text/javascript">
		function generate()
		{
			document.reportForm.action = "<c:url value='/page/balancesheetsummaryreportview.htm'/>";
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">RF78 - Balance Sheet Summary Report</h1>
