...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Company Administration > Facility</td>
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/facilitypreadd.htm'/>"><span>New Facility</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
                                <c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/facilitypreedit.htm?id=${fac.id}'/>"><span>Edit</span></a>
                                </c:if>
                                <c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/facilitydelete.htm?id=${fac.id}'/>');"><span>Del</span></a>
                                </c:if>
							</td>
                            <td><c:out value='${fac.code}'/></td>
							<td><c:out value='${fac.name}'/></td>
                            <td><c:out value='${fac.facilityType.name}'/></td>
                            <td><c:out value='${fac.owner.firstName} ${fac.owner.middleName} ${fac.owner.lastName}'/></td>
