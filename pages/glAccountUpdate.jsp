...
<div class="toolbar">
	<a class="item-button-delete" href="javascript:window.location = 'page/glaccountdelete.htm?id=${account.id}';"><span>Delete</span></a>
	<a class="item-button-save" href="javascript:document.editForm.submit();"><span>Save</span></a>
	<c:if test="${account.level == 'ACCOUNTGROUP'}">
		<a class="item-button-add-gl-child" href="javascript:displayContent('page/glaccountpreadd.htm?coa=${chartOfAccount}&parent=${account.id}');"><span>New GL Account</span></a>
	</c:if>
</div>

<div class="main-box" style="height:370px;overflow:scroll">
	<form:form id="editForm" name="editForm" action="page/glaccountedit.htm" method="post" modelAttribute="account">
