...
<head>
	...
	<script type="text/javascript">
		function save()
		{			
			document.addForm.action = "<c:url value='/page/spbunozzleadd.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">SPBU > Nozzle > Add</td>
			...
			<div id="r13">
				<div id="r14">
					...
					<!-- main contents goes here -->
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="nozzle_add">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;
                                        <img src="assets/icons/list_extensions.gif" onclick="javascript:opentank();" style="CURSOR:pointer;" title="Tank" />
                                    </td>
