...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/ledgersummaryreportview.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Account Receivables > Report &gt; AR Ledger Summary </td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">F31 - AR Ledger Summary</h1>
