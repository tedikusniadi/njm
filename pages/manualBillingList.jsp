...
<html>
<head>
	<title>Manual Billing >> Home</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Financial Accounting > Account Receivable > Manual Billing</td>
					...
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/manualbillingpreadd1.htm'/>"><span>New Manual Billing</span></a>
                                        </c:if>
						...
						<tr>
							<th width="7%"><div style="width:40px"></div></th>
  	  	  	  	  	  	  	<th width="17%">Billing No. (Legend) </th>
						...
						<tr>
							<td class="tools">
                            	<c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/manualbillingpreedit.htm?id=${bill.billing.id}'/>" title="Edit"><span>Edit</span></a>                                </c:if>
                                <c:if test='${access.delete and empty bill.billing.payments}'>
                                    <a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/manualbillingdelete.htm?id=${bill.billing.id}'/>');" title="Del"><span>Del</span></a>                                
                                </c:if>
                            </td>
							<td><c:out value='${bill.billing.legend}'/></td>
