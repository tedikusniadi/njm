						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="billing_add">
                                ...
                                <tr>
									...
									<td>
										<form:select id="org" path="organization" cssClass="combobox-ext">
                                           	<c:if test='${not empty billing_add.organization}'>
                                               	<form:option value='${billing_add.organization.id}' label='${billing_add.organization.firstName} ${billing_add.organization.lastName} ${billing_add.organization.middleName}' />
                                            </c:if>
										</form:select>
										&nbsp;
                                ...
                                <tr>
                                  	...
                                  	<td>
                                        <form:select id="taxAddress" path="taxAddress" cssClass="combobox-ext">
                                            <c:if test='${not empty billing_add.taxAddress}'>
                                                <form:option value='${billing_add.taxAddress.id}' label='${billing_add.taxAddress.party.firstName} ${billing_add.taxAddress.party.middleName} ${billing_add.taxAddress.party.lastName}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
								...
								<tr>
                                            ...
                                            <td><form:input path='doNo' size='30' maxlength='50' value=''/></td>
                                        </tr>
					<tr>
                                          	<td nowrap="nowrap" align="right">PO No :</td>
                                            <td><form:input path='poNo' size='30' maxlength='50' value=''/></td>
                                        </tr>
								<tr>
									...
									<td>
										<form:select id="customer" path="customer" cssClass="combobox-ext">
                                           	<c:if test='${not empty billing_add.customer}'>
                                               	<form:option value='${billing_add.customer.id}' label='${billing_add.customer.firstName} ${billing_add.customer.lastName} ${billing_add.customer.middleName}' />
                                            </c:if>
										</form:select>
										&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form:select id="customerContactPerson" path="customerContactPerson" cssClass="combobox-ext">
                                            <c:if test='${not empty billing_add.customerContactPerson}'>
                                                <form:option value='${billing_add.customerContactPerson.id}' label='${billing_add.customerContactPerson.firstName} ${billing_add.customerContactPerson.lastName} ${billing_add.customerContactPerson.middleName}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;
                                        <input size="7" id="tax2Rate" class="input-disabled" disabled/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;
                                        <input size="7" id="tax3Rate" class="input-disabled" disabled/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
									...
									<td>
										...
										<form:select id="taxcode" path="taxNumber.invoiceTax" cssClass="combobox">
                                           	<c:if test='${not empty billing_add.taxNumber.invoiceTax}'>
                                               	<form:option value='${billing_add.taxNumber.invoiceTax.id}' label='${billing_add.taxNumber.invoiceTax.code}' />
                                            </c:if>
										</form:select>
										&nbsp;
								...
								<tr>
                                    ...
                                    <td>
                                    	<form:select path='billingType'>
                                        	<form:option value='1' label='SHIPMENT'/>
                                            <form:option value='2' label='DELIVERY ORDER REALIZATION'/>
                                            <form:option value='3' label='CONSIGNMENT SALES ORDER'/>
                                        </form:select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <form:select id="signer" path="signer" cssClass="combobox-ext">
                                            <c:if test='${not empty billing_add.signer}'>
                                                <form:option value='${billing_add.signer.id}' label='${billing_add.signer.firstName} ${billing_add.signer.lastName} ${billing_add.signer.middleName}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form:select id="activeRole" path="activeRole" cssClass="combobox-ext">
                                            <c:if test='${not empty billing_add.activeRole}'>
                                                <form:option value='${billing_add.activeRole.id}' label='${billing_add.activeRole.fromRole.roleType.name}' />
                                            </c:if>
                                        </form:select>
                                        &nbsp;
                                ...
                                <tr>
								 ...
								 <tr>
									...
									<td><form:textarea path="note2" cols="55" rows="7"/></td>
								</tr>
							</table>
							</form:form>
						</div>
...
<script type="text/javascript">
    ...
    document.addForm.action = "<c:url value='/page/billingpreaddtwo.htm'/>";
