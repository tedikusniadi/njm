...
<head>
	...
	<script type="text/javascript">
		function save()
		{		
			document.addForm.action = "<c:url value='/page/maintenanceadd.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Transport Outsource > Transport Management > Vehicle Management > Vehicle Maintenance > Add</td>
