				...
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
										<c:if test='${access.add}'>
                                        	<a class="item-button-new" href="<c:url value='/page/productpreadd.htm?categoryId=2' />"><span>New Product</span></a>
                                        </c:if>
							  			<div dojoType="Toggler" targetId="filter">
											<a class="item-button-search" href="javascript:return;"><span>Filter</span></a>
										</div>
										<a class="item-button-print" href="<c:url value='/page/productprintoption.htm?categoryId=2' />"><span>Print</span></a>
									</div>
								</td>
						...
						<tr>
							...
							<td nowrap="nowrap">${product.quality}</td>
							<td nowrap="nowrap">${product.brand}</td>
							<td nowrap="nowrap">${product.primaryColors}</td>
							<td>${product.note}</td>
						</tr>
						</c:forEach>
