					...
					<div id="se-contents">
						...
						<h1 class="page-title">${pageTitle}</h1>
					  	...
					  	<div class="toolbar">
							...
							<a id="submitButton" class="item-button-generate-report" href="javascript:generateReport();"><span>Generate</span></a>
					  	</div>
						<div class="main-box">
							<form name="reportForm" id="reportForm" method="post" onsubmit="submitButton.disabled = true;">
                                ...
                                <tr>
									...
									<td>:</td>
                                    <td>
										<select multiple="multiple" name="accounts" size="10" style="height:200px;" >
...
<script type="text/javascript">
	function generateReport()
	{
		...
		document.reportForm.action = "<c:url value='/page/glregisterreportnewview.htm'/>";
