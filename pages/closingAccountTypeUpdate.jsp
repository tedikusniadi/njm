...
<html>
<head>
	<title>Closing Account Type >> Edit</title>
...
<div id="se-containers">
	...
	<tr>
		<td width="60%">Financial Accounting > Accounting Setting > Closing Account Type > Edit</td>
			...
			<div id="r13">
				<div id="r14">
					...
					<div class="main-box">
						...
						<form:form cssClass="edit-form" id="editForm" name="editForm" method="post" modelAttribute="closingAccountType_edit">
						<table width="714" border="0" cellpadding="0" cellspacing="0">
 						<tr><td colspan="3">&nbsp;</td></tr>
 						<tr>
 							<td width="169" align="right"><div class="form-label">Type Name :</div></td>
					  		<td width="531"><form:input path="name" cssClass="inputbox" maxlength="50"/></td>
						  	<td width="14"><form:errors path="name" cssClass="error"/></td>
 						</tr>
 						<tr>
 							<td align="right"><div class="form-label">Group :</div></td>
							<td>
