		...
		function setclient(id,name,amount,uom,rate)
		{
			if(id && name)
			{
				...
				if(_client)
				{
					...
					if(_price)
						_price.value = new Number(amount).numberFormat('#.00');
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<tr>
					  		<td class="tools">
					  			<a class="item-button-add-row" href="javascript:setclient('${com.productPrice.id}','${com.productPrice.product.name}','${com.productPrice.money.amount*com.exchange.rate}','${com.productPrice.product.unitOfMeasure.measureId}','${com.defExchange.rate}')"  title="Edit"><span>Edit</span></a>
					  		</td>
							...
							<td><fmt:formatNumber value='${com.productPrice.money.amount*com.exchange.rate}' pattern=',##0.00'/></td>
					  	</tr>
						</c:forEach>
