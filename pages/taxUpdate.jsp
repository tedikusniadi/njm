...
<head>
	...
	<script type="text/javascript">
		function save()
		{			
			document.addForm.action = "<c:url value='/page/taxUpdate.htm'/>";
...
<div id="se-containers">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td width="60%">Company Administration > Financial Information > Tax > Edit</td>
			...
			<div id="r13">
				<div id="r14">
					...
					<!-- main contents goes here -->
						...
						<div class="main-box">
							<form:form cssClass="edit-form" id="addForm" name="addForm" method="post" modelAttribute="tax_edit">
