...
<html>
<head>
	<title>Inter Journal Schema</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">	
		...
		<tr>
			<td width="60%">Financial Accounting > Accounting Setting > Inter Journal Schema > List</td>
					...
					<div id="se-contents">
							  ...
							  <table border="0" cellpadding="0" cellspacing="0" width="99%" align="center">
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
										<a class="item-button-new" href="<c:url value='/page/interjournalschemapreadd.htm' />"><span>New Schema</span></a>
						...
						<tr>
							<th width="5%"><div style="width:40px"></div></th>
					  	  	<th width="9%">ID</th>
					  	  	<th width="17%">Name</th>
					  	  	<th width="24%">From Company</th>
                            <th width="21%">To Company</th>
					  	  	<th width="24%">Note</th>
						</tr>
						<c:forEach items="${journalSchemas}" var="schema">
						<tr>
						 	<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/interjournalschemapreedit.htm?id=${schema.id}'/>" title="Edit"><span>Edit</span></a>
                                <a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/interjournalschemadelete.htm?id=${schema.id}'/>');" title="Delete"><span>Delete</span></a>
						 	</td>
						 	<td>${schema.code}</td>
							<td>${schema.name}</td>
							<td>${schema.from.firstName} ${schema.from.middleName} ${schema.from.lastName}</td>
                            <td>${schema.to.firstName} ${schema.to.middleName} ${schema.to.lastName}</td>
							<td>${schema.note}</td>
						</tr>
						</c:forEach>
