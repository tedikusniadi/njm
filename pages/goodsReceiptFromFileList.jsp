...
<head>
	...
	<%@ include file="/filter/goodsReceiptFromFileFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/goodsreceiptfromfilepreadd1.htm'/>"><span>New Goods Receipt</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/goodsreceiptfromfilepreedit.htm?id=${rec.id}'/>"  title="Edit"><span>Edit</span></a>
                                <c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/goodsreceiptfromfiledelete.htm?id=${rec.id}'/>');" title="Del"><span>Del</span></a>
                                </c:if>
							</td>
