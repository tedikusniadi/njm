...
<html>
<head>
	<title>Inter From Journal >> Edit</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Journal Entrys > Inter From Journal > Edit</td>
			...
			<div id="r13">
				<div id="r14">
					...
					<!-- main contents goes here -->
						...
						<h1 class="page-title">F44 - Inter From Journal Entry</h1>
						...
						<div class="main-box">
							...
							<tr valign="top">
                                    ...
                                    <tr>
										...
										<td>
											<form:select path="entryFrom.currency">
                                            	<option selected>${interJournal.entryFrom.currency.symbol}</option>
											</form:select>
                                            &nbsp;
								...
								<td width="50%">
									<table width="100%">
                                    <c:if test='${not empty interJournal.entryFrom.indexes}'>
                                    <tr>
                                    	<td>
                                        	<fieldset>
