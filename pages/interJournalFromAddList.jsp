			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<tr>
							<th width="2%"><div style="width:30px"></div></th>
						  	<th width="12%">ID</th>
                            <th width="9%">Date</th>
                            <th width="24%">From</th>
                            <th width="19%">To</th>
						...
						<c:forEach items="${interJournals}" var="journal">
						<tr>
							<td class="tools">
								<a class="item-button-add-row" href="<c:url value='/page/interjournalfrompreadd.htm?id=${journal.id}'/>" title="Edit"><span>Edit</span></a>
							</td>
