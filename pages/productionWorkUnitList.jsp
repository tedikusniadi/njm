...
<html>
<head>
	<title>Production Work Unit >> Home</title>
	<%@ include file="/common/sirius-header.jsp"%>
	<script type="text/javascript" src="assets/dialog.js"></script>
	<%@ include file="/filter/productionWorkUnitFilter.jsp"%>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Production > Master > Work Unit</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/productionworkunitpreadd.htm'/>"><span>New Work Unit</span></a>
                                        </c:if>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/productionworkunitpreedit.htm?id=${unit.id}'/>" title="Edit"><span>Edit</span></a>
                                <c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/productionworkunitdelete.htm?id=${unit.id}'/>');" title="Del"><span>Del</span></a>
                                </c:if>
							</td>
							<td><c:out value='${unit.code}'/></td>
                            <td><c:out value='${unit.name}'/></td>
							<td><fmt:formatDate value='${unit.validFrom}' pattern='dd-MM-yyyy'/></td> 
							<td><fmt:formatDate value='${unit.validTo}' pattern='dd-MM-yyyy'/></td> 
                            <td><c:out value='${unit.note}'/></td>
						</tr>
						</c:forEach>
