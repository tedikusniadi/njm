...
<html>
<head>
	<title><spring:message code="customer.htmltitle"/></title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%"><spring:message code="customer.breadcrumb"/></td>
	...
	<div id="r11">
		<div id="r12">
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<h1 class="page-title"><spring:message code="customer.title"/></h1>
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/customerview.htm'/>"><span><spring:message code="list"/></span></a>
                            <c:if test='${access.add}'>
								<a class="item-button-save" style="cursor:pointer;"><span><spring:message code="save"/></span></a>
							</c:if>
					  	</div>
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="customer_add" enctype="multipart/form-data">
 								<table style="border:none" width="100%">
 								<tr>
 									<td align="right">No.Pelanggan</td>
                                    <td width="1%" align="center">:</td>
									<td><input value="Auto Number" class="input-disabled" disabled/></td>
	                            ...
	                            <tr>
 								...
 								<tr>
	 							  	...
	 							  	<td align="center">:</td>
	 							  	<td>
										<form:radiobutton path='indonesian' value='true' label='WNI' checked="checked"/>
                                        <form:radiobutton path='indonesian' value='false' label='WNA'/>
									</td>
	 							  	<td></td>
	 							</tr>
	 							<tr>
                                    ...
                                    <td width="1%" align="center">:</td>
									<td><input inputId="dateFromId" id="dateFrom" name="partyRoles[0].fromDate" value="<fmt:formatDate value='${now}' pattern='MM/dd/yyyy'/>" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
									<td>&nbsp;</td>
	 							</tr>
                                <%-- <tr>
