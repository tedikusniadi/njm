...
<head>
	...
	<%@ include file="/filter/platFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
							...
							<tr>
								<td width="30%" height="30" align="left" valign="middle">
									...
									<c:if test='${access.add}'>
										<a class="item-button-new" href="<c:url value='/page/platpreaddone.htm'/>"><span>New Plat Nomor</span></a>
                                    </c:if>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/platpreedit.htm?id=${plat.id}'/>" title="Edit"><span>Edit</span></a>
								<c:if test="${access.delete && plat.price.bpkb != 'RECEIVED' && plat.price.plat != 'DELIVERED'}">
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/platdelete.htm?id=${plat.id}'/>')" title="Delete"><span>Delete</span></a>
								</c:if>
							</td>
