                                        	...
                                        	<td>
                                           	  <fieldset>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="60%"><input  value="<fmt:formatDate value='${bpkb_edit.receivedDate}' pattern='dd-MM-yyyy'/>" disabled class='input-disabled' size="10"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="40%"align="right">Nomor BPKB :</td>
                                                        <td width="60%"><input value="${bpkb_edit.referenceNo}" disabled class='input-disabled' size="40"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">Keterangan Tambahan :</td>
                                                        <td><textarea id="note" name="note1" cols="29" rows="5">${bpkb_edit.note1}</textarea></td>
                                                    </tr>
                                                    </table>
                                                </fieldset>
                                            </td>
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		$('.b_save').hide();
		$.ajax({
			url:"<c:url value='/page/bpkbedit.htm'/>",
			...
			{
				$dialog.empty();
				$dialog.html('Updating BPKB data......');
				$dialog.dialog('open');
			},
