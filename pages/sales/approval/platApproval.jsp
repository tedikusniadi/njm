				...
				<div id="r14">
					<div id="se-contents">
                        ...
                        <c:forEach items="${sales}" var="order" varStatus="status">
	                       	...
	                       	<c:if test="${item.price.plat == 'UNAPPROVED'}">
	                        	<tr>
	                        		<td>
...
$(document).ready(function(){
	$(".item-button-process").click(function()
	{
		...
		.html('Approval Plat Nomor sebanyak '+total+', lanjutkan Approval ?');
		...
		$dialog_confirm.dialog({
			...
			buttons: {
				...
				{
					$( this ).dialog( "close" );
					document.formData.action="<c:url value='/page/platapprovalprocess.htm'/>";
