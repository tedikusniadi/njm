				...
				<div id="r14">
					<div id="se-contents">
                        ...
                        <c:forEach items="${sales}" var="order" varStatus="status">
	                       	...
	                       	<c:if test="${item.price.bpkb == 'UNAPPROVED' && item.price.stnk == 'RECEIVED' && item.price.plat == 'RECEIVED'}">
	                        	<tr>
	                        		<td>
...
$(document).ready(function(){
	$(".item-button-process").click(function()
	{
		...
		.html('Approval BPKB sebanyak '+total+', lanjutkan Approval ?');
		...
		$dialog_confirm.dialog({
			...
			buttons: {
				...
				{
					$( this ).dialog( "close" );
					document.formData.action="<c:url value='/page/bpkbapprovalprocess.htm'/>";
