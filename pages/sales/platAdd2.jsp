			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="plat_add">
                                        	...
                                        	<td>
                                           	  <fieldset>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="60%"><input inputId="platDateId" id="platDate" name="receivedDate" value="<fmt:formatDate value='${now}' pattern='MM/dd/yyyy'/>" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="40%"align="right">Nomor Plat :</td>
                                                        <td width="60%"><input id="platNo" name="referenceNo" size="40"/></td>
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		...
		$('.b_save').hide();
		$.ajax({
			url:"<c:url value='/page/platadd.htm'/>",
			...
			{
				$dialog.empty();
				$dialog.html('Saving Plat Nomor data......');
				$dialog.dialog('open');
			},
