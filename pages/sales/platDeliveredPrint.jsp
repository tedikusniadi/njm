			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                    	<div class="area" dojoType="Container" id="quick_link_container">
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/platdeliveredpreedit.htm?id=${plat_edit.id}'/>"><span>Back</span></a>
						...
						<div class="main-box">
							<div class="main_container">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td colspan="8"><div align="center" class="CSS3" valign="middle"><strong>BUKTI PENYERAHAN PLAT</strong></div></td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td width="337">: 
                                    <c:out value='${plat_edit.code}'/></td>
                                  </tr>
                                  <tr>
                                    <td colspan="3"><c:out value='${profile.organization.fixAddress}'/></td>
                                    <td>&nbsp;</td>
                                    <td>Tanggal</td>
                                    <td>: <fmt:formatDate value='${plat_edit.deliveredDate}' pattern='dd-MM-yyyy'/></td>
                                  </tr>
                                  <tr>
                                    ...
                                    <table cellspacing="0" cellpadding="2" width="100%">
                                      ...
                                      <tbody>
                                       <tr>
                                         ...
                                         <td style="border-bottom:solid 1px black;border-right:solid 1px black;"><c:out value='${plat_edit.price.serial}'/></td>
                                         <td style="border-bottom:solid 1px black;border-right:solid 1px black;"><c:out value='${plat_edit.price.serialExt1}'/></td>
                                         <td style="border-bottom:solid 1px black;border-right:solid 1px black;"><c:out value='${plat_edit.referenceNo}'/></td>
                                       </tr>
                                    </table>
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td>Nama</td>
                                    <td colspan="2">: <c:out value='${plat_edit.customerName}'/></td>
                                    <td>&nbsp;</td>
                                    <td>No KTP/SIM</td>
                                    <td>:
                                    	<c:if test="${orderItem.unitSalesOrder.customer.name == plat_edit.customerName}"><c:out value='${orderItem.unitSalesOrder.customer.nppkp}'/></c:if>
                                    	<c:if test="${orderItem.unitSalesOrder.customer.name != plat_edit.customerName}"><c:out value=''/></c:if>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Alamat</td>
                                    <td colspan="2">:
                                    	<c:if test="${orderItem.unitSalesOrder.customer.name == plat_edit.customerName}">
                                  ...
                                  <tr>
                                    <td>No. Tlp</td>
                                    <td colspan="2">: <c:out value='${plat_edit.phone}'/></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>Keterangan</td>
                                    <td colspan="2">: <c:out value='${plat_edit.note2}'/></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                  </tr>
