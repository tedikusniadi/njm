...
<head>
	...
	<%@ include file="/filter/bpkbFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
							...
							<tr>
								<td width="30%" height="30" align="left" valign="middle">
									...
									<c:if test='${access.add}'>
										<a class="item-button-new" href="<c:url value='/page/bpkbpreaddone.htm'/>"><span>New BPKB</span></a>
                                    </c:if>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/bpkbpreedit.htm?id=${bpkb.id}'/>" title="Edit"><span>Edit</span></a>
								<c:if test="${access.delete && bpkb.price.bpkb != 'DELIVERED'}">
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/bpkbdelete.htm?id=${bpkb.id}'/>')" title="Delete"><span>Delete</span></a>
								</c:if>
							</td>
							<td><fmt:formatDate value='${bpkb.receivedDate}' pattern='dd-MM-yyyy'/></td>
