...
<head>
	...
	<%@ include file="/filter/unitSalesOrderBPKBFilter.jsp"%>
					...
					<div id="se-contents">
						...
						<tr>
							<th width="1%"><div style="width:40px"></div></th>
						  	...
						  	<th nowrap="nowrap" width="12%">No Mesin</th>
						  	<th nowrap="nowrap" width="12%">No Rangka</th>
						  	<th nowrap="nowrap" width="12%">Pengurus BBN</th>
						</tr>
						<c:forEach items="${sales}" var="item">
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/bpkbpreaddtwo.htm?id=${item.unitSalesOrder.id}'/>" title="Edit"><span>Edit</span></a>
							</td>
