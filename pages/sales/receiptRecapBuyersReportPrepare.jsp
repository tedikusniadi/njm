...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/receiptrecapreport.htm'/>";
			document.reportForm.submit();
		}
		
		function resetform()
		{
			var url = "<c:url value='/page/receiptrecapreportprepare.htm'/>";
			window.location = url;
		}
	</script>
</head>
					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form:form name="reportForm" id="reportForm" method="post">
								...
								<tr>
                                    <td align="right"&nbsp;</td>
                                    <td><input type="checkbox" name="receipt" value="true"/>Tampilkan Receipt</td>
                                </tr>
								<tr>
