                                	...
                                	<td width="56%" valign="top" align="left">
                              		...
                              		<td width="44%" valign="top">
                                        ...
                                        <tr>
                                        	<td>
                                           	  <fieldset>
                                                    <legend><strong>Status BPKB Nomor</strong></legend>
                                                    <table width="100%" style="border:none">
                                                    <tr>
                                                        <td width="40%"align="right">Tanggal Penyerahan BPKB :</td>
                                                        <td width="60%"><input inputId="bpkbDateId" id="bpkbDate" name="deliveredDate" value="<fmt:formatDate value='${now}' pattern='MM/dd/yyyy'/>" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="right">Informasi BPKB :</td>
                                                        <td><input value="${orderItem.unitSalesOrder.bpkbInfo.name}" disabled class='input-disabled' size="40"/></td>
                                                    </tr>
                                                    <tr>
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		$('.b_save').hide();
		$.ajax({
			url:"<c:url value='/page/bpkbdeliveredadd.htm'/>",
