                                ...
                                <tr>
                                	<td width="56%" valign="top" align="left">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td width="27%" nowrap="nowrap" align="right">Nama Pemohon :</td>
                                          	<td width="73%">
                                          		<input class="inputbox input-disabled" disabled value="${orderItem.unitSalesOrder.customer.name}"/>
                                          	</td>
                                        </tr>
                                         <tr>
                                            <td width="27%" nowrap="nowrap" align="right">Nama STNK :</td>
                                          	<td width="73%">
                                        	...
                                        	<td>
                                           	  <fieldset>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="60%"><input inputId="stnkDateId" id="stnkDate" name="deliveredDate" value="<fmt:formatDate value='${now}' pattern='MM/dd/yyyy'/>" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
                                                    </tr>
                                                    <tr>
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		if(validation())
		{
			$('.b_save').hide();
			$.ajax({
				url:"<c:url value='/page/stnkdeliveredadd.htm'/>",
