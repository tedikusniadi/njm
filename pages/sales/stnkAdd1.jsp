...
<head>
	...
	<%@ include file="/filter/unitSalesOrderSTNKFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/stnkpreaddtwo.htm?id=${item.unitSalesOrder.id}'/>" title="Edit"><span>Edit</span></a>
							</td>
