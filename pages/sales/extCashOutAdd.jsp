                                ...
                                <tr>
                                	<td width="53%" align="left" valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td><input value="<fmt:formatDate value='${cash_out.date}' pattern='dd-MM-yyyy'/>" disabled class="input-disabled"/></td>
                                        </tr>
                                        <tr>
                                            <td nowrap="nowrap" align="right">Tgl Pendapatan :</td>
                                            <td><input id="cashOutDate" name="realDate" inputId="inputCashOutDate" value="<fmt:formatDate value='${now}' pattern='MM/dd/yyyy'/>" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
                                        </tr>
                                        <tr>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('.b_save').click(function(e)
		{
			...
			{
				$.ajax({
					url:"<c:url value='/page/extcashoutadd.htm'/>",
	...
	function validation()
	{
		...
		var date = document.getElementById('inputCashOutDate').value;
