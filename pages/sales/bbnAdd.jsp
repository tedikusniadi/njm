                                            ...
                                            <td>
                                                <form:select id="org" path="organization" cssClass="combobox-ext">
                                                    <c:if test='${not empty bbn_add.organization}'>
                                                        <form:option value='${bbn_add.organization.id}' label='${bbn_add.organization.firstName} ${bbn_add.organization.middleName} ${bbn_add.organization.lastName}' />
                                                    </c:if>
                                                </form:select>
...
function getregion(target){
	...
	if($("#city option:selected").text().indexOf('KODYA') >= 0 || $("#city option:selected").text().indexOf('KOTA') >= 0)
		$("#cityRegion").val("CITY");
	else
		$("#cityRegion").val("REGION");
}
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		...
		{
			$.ajax({
				url:"<c:url value='/page/bbnadd.htm'/>",
...
function addLineItem()
{
	...
	$.get("<c:url value='/page/bbnremote.getitem.json'/>",{organization:org,type:serviceType,cityId:city,regionId:region,pengajuan:'N'},
	function(json)
	{
		//clearTable();
