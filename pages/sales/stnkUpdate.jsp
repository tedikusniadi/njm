                                        	...
                                        	<td>
                                           	  <fieldset>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="60%"><input  value="<fmt:formatDate value='${stnk_edit.receivedDate}' pattern='dd-MM-yyyy'/>" disabled class='input-disabled' size="10"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">Nomor STNK :</td>
                                                        <td><input value="${stnk_edit.referenceNo}" disabled class='input-disabled' size="30"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">Nomor Plat :</td>
                                                        <td><input value="${stnk_edit.referenceNoExt}" disabled class='input-disabled' size="30"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">Nomor BPKB :</td>
                                                        <td><input value="${stnk_edit.referenceNoExt2}" disabled class='input-disabled' size="30"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">Notice Pokok :</td>
                                                        <td><input value="<fmt:formatNumber value='${stnk_edit.noticeAmount}' pattern='#,###'/>" disabled class='input-disabled' size="20"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">Keterangan Tambahan :</td>
                                                        <td><textarea id="note" name="note1" cols="32" rows="5">${stnk_edit.note1}</textarea></td>
                                                    </tr>
                                                    </table>
                                                </fieldset>
                                            </td>
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		$('.b_save').hide();
		$.ajax({
			url:"<c:url value='/page/stnkedit.htm'/>",
			...
			{
				$dialog.empty();
				$dialog.html('Updating STNK data......');
				$dialog.dialog('open');
			},
