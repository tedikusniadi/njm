						...
						<h1 class="page-title">${pageTitle}</h1>
					  	...
					  	<div class="toolbar">
							...
							<c:if test='${access.print}'>
								<a class="item-button-print" href="<c:url value='/page/platdeliveredprint.htm?id=${plat_edit.id}'/>"><span>Print</span></a>
							</c:if>
					  	</div>
                                        	...
                                        	<td>
                                           	  <fieldset>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="60%"><input  value="<fmt:formatDate value='${plat_edit.deliveredDate}' pattern='dd-MM-yyyy'/>" disabled class='input-disabled' size="10"/></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input value="${plat_edit.customerName}" size="40" disabled class='input-disabled' /></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">Telp. Pengambil :</td>
                                                        <td><input value="${plat_edit.phone}" size="40" disabled class='input-disabled' /></td>
                                                    </tr>
                                                    <tr>
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		$('.b_save').hide();
		$.ajax({
			url:"<c:url value='/page/platdeliverededit.htm'/>",
