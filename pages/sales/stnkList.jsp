...
<head>
	...
	<%@ include file="/filter/stnkFilter.jsp"%>
					...
					<div id="se-contents">
							...
							<tr>
								<td width="30%" height="30" align="left" valign="middle">
									...
									<c:if test='${access.add}'>
										<a class="item-button-new" href="<c:url value='/page/stnkpreaddone.htm'/>"><span>New STNK</span></a>
                                    </c:if>
						...
						<tr>
							<th width="1%"><div style="width:45px"></div></th>
						  	<th nowrap="nowrap" width="8%">Received Date</th>
						  	<th nowrap="nowrap" width="15%">Nama Pemesan</th>
						  	<th nowrap="nowrap" width="15%">Nama STNK</th>
						  	<th nowrap="nowrap" width="8%">Tipe</th>
						  	<th nowrap="nowrap" width="12%">Nama Tipe</th>
						  	<th nowrap="nowrap" width="10%">No Mesin</th>
						  	<th nowrap="nowrap" width="10%">No Rangka</th>
						  	<th nowrap="nowrap" width="8%">No STNK</th>
						  	<th nowrap="nowrap" width="20%">Note</th>
						</tr>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/stnkpreedit.htm?id=${stnk.id}'/>" title="Edit"><span>Edit</span></a>
								<c:if test="${access.delete && stnk.price.bpkb != 'RECEIVED' && stnk.price.stnk != 'DELIVERED'}">
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/stnkdelete.htm?id=${stnk.id}'/>')" title="Delete"><span>Delete</span></a>
								</c:if>
							</td>
							<td nowrap="nowrap"><fmt:formatDate value='${stnk.receivedDate}' pattern='dd-MM-yyyy'/></td>
