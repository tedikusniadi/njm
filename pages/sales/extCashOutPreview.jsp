                                ...
                                <tr>
                                	<td width="56%" align="left" valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td><input size="15" disabled class="input-disabled" value="<fmt:formatDate value='${cash_out.realDate}' pattern='dd-MM-yyyy'/>"/></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td width="24%" align="right"> Note : </td>
                                          	<td><form:textarea path='note' cols='45' rows='6' value='${cash_out.note}' readonly="true" class="input-disabled"/></td>
                                        </tr>
                                        </table>
                                    </td>
                                    <td valign="top">
