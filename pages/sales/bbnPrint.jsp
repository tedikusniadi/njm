			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
                    	<div class="area" dojoType="Container" id="quick_link_container">
                            <div class="toolbar">
                                <a class="item-button-back" href="<c:url value='/page/bbnpreedit.htm?id=${bbn_edit.id}'/>"><span>Back</span></a>
						...
						<div class="main-box">
							<div class="main_container">
                                ...
                                <tr>
                                    <td colspan="12"><div align="center" class="CSS3" valign="middle"><strong>TANDA TERIMA BBN</strong></div></td>
                                </tr><tr>
                                    <td colspan="9"><strong>
                                  ...
                                  <tr>
                                    <td colspan="12">Telp. <c:out value='${profile.organization.fixPhone}'/></td>
                                  </tr>
                                  <tr>
                                    <td colspan="12" style="border-bottom:solid 1px black;">Fax. <c:out value='${profile.organization.fixFax}'/></td>
                                  </tr>
								...
								<tr>
									<th colspan="12" align="left" style="font-size: 11px"><c:out value="${data.salesItem.unitSalesOrder.customer.name}"/> - <c:forEach items="${data.salesItem.unitSalesOrder.customer.postalAddresses}" var="add"><c:out value='${add.address}'/></c:forEach></th>
								</tr>
								<tr>
									...
									<th width="8%" align="left" style="border-top:solid 1px black;border-bottom:solid 1px black;border-right:solid 1px black;" nowrap="nowrap">Notice</th>
									<th width="8%" align="left" style="border-top:solid 1px black;border-bottom:solid 1px black;border-right:solid 1px black;" nowrap="nowrap">Jasa</th>
									<th width="8%" align="left" style="border-top:solid 1px black;border-bottom:solid 1px black;border-right:solid 1px black;" nowrap="nowrap">Acc Tahun</th>
									<th width="8%" align="left" style="border-top:solid 1px black;border-bottom:solid 1px black;border-right:solid 1px black;" nowrap="nowrap">Stck</th>
									<th width="8%" align="left" style="border-top:solid 1px black;border-bottom:solid 1px black;border-right:solid 1px black;" nowrap="nowrap">Biaya 1</th>
									<th width="8%" align="left" style="border-top:solid 1px black;border-bottom:solid 1px black;border-right:solid 1px black;" nowrap="nowrap">Biaya 2</th>
