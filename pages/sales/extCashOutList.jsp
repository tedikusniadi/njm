...
<head>
	...
	<%@ include file="/filter/extCashOutFilter.jsp"%>
                            	...
                            	<td width="35%" height="30" align="left" valign="middle">
                            		<div class="toolbar-clean">
                            			<c:if test='${access.add}'>
                                			<a class="item-button-new" href="<c:url value='/page/extcashoutpreadd.htm'/>"><span>New</span></a>
                                		</c:if>
                        ...
                        <tr>
                             <td class="tools">
                                <c:if test="${access.edit}">
                                	<a class="item-button-edit" href="<c:url value='/page/extcashoutpreedit.htm?id=${cash.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                               	<a class="item-button-search" href="<c:url value='/page/extcashoutpreview.htm?id=${cash.id}'/>" title="Preview"><span>Preview</span></a>
                                <c:if test="${access.delete}">
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/extcashoutdelete.htm?id=${cash.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
                             </td>
