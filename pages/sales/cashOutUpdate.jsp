                                ...
                                <tr>
                                	<td width="56%" align="left" valign="top">
                                        ...
                                        <tr>
											...
											<td>
												<form:select id="shiftManagement" path="shiftManagement" cssClass="combobox-ext" disabled="true">
                                        ...
                                        <tr>
                                            <td align="right">Cashier :</td>
                                          	<td><input id="cashier" size="25" value="${cash_out.shiftManagement.cashierPerson.name}" class="input-disabled" disabled/></td>
                                        </tr>
                                        <tr>
...
$(function()
{
	...
	{
		$.ajax({
			url:"<c:url value='/page/cashoutedit.htm'/>",
