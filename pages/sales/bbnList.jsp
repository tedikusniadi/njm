...
<head>
	...
	<%@ include file="/filter/bbnFilter.jsp"%>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
							...
							<tr>
								<td width="30%" height="30" align="left" valign="middle">
									...
									<c:if test='${access.add}'>
										<a class="item-button-new" href="<c:url value='/page/bbnpreadd.htm'/>"><span>New BBN</span></a>
                                    </c:if>
						...
						<tr>
							<td class="tools">
								<a class="item-button-edit" href="<c:url value='/page/bbnpreedit.htm?id=${bbnAdapter.bbn.id}'/>" title="Edit"><span>Edit</span></a>
								<c:if test='${access.delete && bbnAdapter.deleteAble}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/bbndelete.htm?id=${bbnAdapter.bbn.id}'/>')" title="Delete"><span>Delete</span></a>
								</c:if>
							</td>
