...
<div id="se-containers">
	...
	<div id="se-navigator">
		<div class="area" dojoType="Container" id="quick_link_container">
			...
			<tr>
				<td width="60%">
					Reports > Financial Accounting > Account Receiveables > Tax Invoice </td>
		...
		<div id="r12">
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">
							<h1 class="page-title">F36 - Tax Invoice <br>
							</h1>
						
					  		<div class="toolbar">
								<a class="item-button-back" href="<c:url value='/page/taxinvoicereportprepare.htm'/>"><span>Back</span></a>
						...
						<br>
							<div class="report"><strong>REPORT TAX INVOICE</strong></div>
                    		<br>
	    					<table width="498">	
		   						<tr>	
								...
								<tr class="CSS">
									...
									<td width="15%" align="center" valign="middle" class="border_Right_Bottom">Tax Invoice No </td>
									...
									<td width="15%" align="center" valign="middle" class="border_Right_Bottom">Tax Amount </td>
								  </tr>
								<c:forEach  items='${report}' var='rpt'> 
								<tr>
									<td align="left" class="border_Right_Bottom">&nbsp;<fmt:formatDate value='${rpt.tax.billing.date}' pattern="dd MMM yyyy"/></td>	
									<td align="left" class="border_Right_Bottom">&nbsp;<c:out value='${rpt.tax.code}'/>&nbsp;</td>
									<td align="left" class="border_Right_Bottom">&nbsp;<c:out value='${rpt.tax.billing.code}'/>&nbsp;</td>	
									<td align="left" class="border_Right_Bottom">&nbsp;<c:out value='${rpt.tax.billing.customer.firstName}'/>&nbsp;</td>
									<td align="right" class="border_Right_Bottom">&nbsp;<fmt:formatNumber value='${rpt.invoiceAmount}' pattern=',##0.00'/>&nbsp;</td>
									<td align="right" class="border_Right_Bottom">&nbsp;<fmt:formatNumber value='${rpt.taxAmount}' pattern=',##0.00'/>&nbsp;</td>
								</tr>
							  </c:forEach>
							  <tr>
									...
									<td align="right" class="border_Right"><strong><fmt:formatNumber value='${totalInvoice}' groupingUsed='true'/></strong>&nbsp;</td>
									<td align="right" class="border_Right"><strong><fmt:formatNumber value='${totalTax}' groupingUsed='true'/></strong>&nbsp;</td>
								  </tr>
							</table>
							<br>
							<br>
