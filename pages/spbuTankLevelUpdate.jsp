...
<head>
	...
	<script type="text/javascript">
		function save()
		{			
			document.addForm.action = "<c:url value='/page/spbutankleveledit.htm'/>";
...
<div id="se-containers">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td width="60%">SPBU > Tank > Level > Edit</td>
			...
			<div id="r13">
				<div id="r14">
					...
					<!-- main contents goes here -->
						...
						<!-- Top toolbar -->
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/spbutankpreedit.htm?id=${level_edit.tank.id}'/>"><span>List</span></a>
							<a class="item-button-save" href="javascript:save();"><span>Save</span></a>
					 	</div>
					  
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="level_edit">
