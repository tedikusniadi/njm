								...
								<td width="52%">
								  <table width="100%" style="border:none">
									<tr>
									  ...
									  <td width="80%"><input  value="Auto Number" size="30" disabled/></td>
									</tr>
                                    <tr>
										<td nowrap="nowrap" align="right">Date :</td>
										<td><input id="date" name="entryFrom.entryDate" formatLength="long" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
									</tr>
                                    <tr>
					  ...
					  <table width="100%">
                                    <tr>
										<td width="19%" align="right" nowrap="nowrap">Amount :</td>
									  	<td width="81%"><form:input id="amount" path="amount" size="20"/></td>
									</tr>
                                    <tr>
                                    ...
                                    <tr>
										...
										<td>
											...
											&nbsp;
											<img src="assets/icons/list_extensions.gif" onclick="javascript:openpopup('<c:url value='/page/popupcompanystructureview.htm?target=orgto'/>');" style="CURSOR:pointer;" title="Company Structure" />
										</td>
									</tr>
                                    </table>
								</td>
								...
								<td width="52%">
								  <table width="100%" style="border:none">
                                    <tr>
									  ...
									  <td width="77%"><form:input path="entryFrom.name" size="50"/> </td>
									</tr>
									<tr>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
										...
										<td>
											<select id="schema" name="entryFrom.journalSchema" class="combobox-ext">
											</select>
                                            &nbsp;
                                    	...
                                    	<td>
                                        	<fieldset>
												...
												<tr>
													...
													<td><input value="0" id="txtBalanceDebet" size="20" disabled class="input-disabled" style="text-align:right"/></td>
													<td><input value="0" id="txtBalanceCredit" size="20" disabled class="input-disabled" style="text-align:right"/></td>
												</tr>
												</table>
											</fieldset>
                                        </td>
	...
	{		
		...
		var _event = function(data)
		{
			if(data.id != null)
			{
				...
				document.addForm.action = "<c:url value='/page/interjournaltoadd.htm'/>";
	...
	{		
		...
		var _event = function(data)
		{
			if(data.id != null)
			{
				...
				document.addForm.action = "<c:url value='/page/interjournaltoaddnew.htm'/>";
				document.addForm.submit();
			}
			else
			{
...
<script type="text/javascript" language="javascript">
	...
	function popup(target)
	{
		...
		openpopup("<c:url value='/page/popupjournalschemaaccountview.htm?postingType=INTER_TO&target='/>"+target+"&schema="+coa.value);
	}
	...
	function openschema()
	{
		...
		if(org.value == '')
		{
			alert('Please select valid Organization From first!');
			return;
		}
		
		if(orgto.value == '')
		{
			alert('Please select valid Organization To first!');
			return;
		}
		
		openpopup("<c:url value='/page/popupinterjournalschemaview.htm?render=true&target=schema&from='/>"+org.value+"&to="+orgto.value);
	}
