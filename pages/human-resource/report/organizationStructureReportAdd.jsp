...
<head>
	...
	<script type="text/javascript">
		function generate()
		{
			...
			document.reportForm.action = "<c:url value='/page/organizationstructurereportview.htm'/>";
					...
					<div id="se-contents">
                    	...
                    	<div class="main-box">
							<form name="reportForm" id="reportForm" method="post" modelAttribute="criteria">
								...
								<tr>
                                    <td><div align="right">Organization Structure :</div></td>
                                    <td>
                                        <select id="org" name="organizationStructureId" class="combobox-ext">
                                        </select>
                                        <img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="javascript:openpopup('<c:url value='/page/popuporganizationstructureview.htm?target=org&superStructure=true'/>');" style="CURSOR:pointer;" title="Company Structure" />
                                    </td>
                                </tr>
                                <!-- <tr>
