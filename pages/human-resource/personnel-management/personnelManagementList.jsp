...
<head>
	...
	<%-- <%@ include file="/filter/unitSalesOrderFilter.jsp"%> --%>
								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
										<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/personnelmanagementpreadd.htm'/>"><span><spring:message code='new'/></span></a>
										</c:if>
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/personnelmanagementpreedit.htm?id=${person.id}'/>" title="Edit"><span>Edit</span></a>
								</c:if>
								<c:if test='${access.delete}'>
									<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/personnelmanagementdelete.htm?id=${person.id}'/>');"><span>Delete</span></a>
								</c:if>
							</td>
