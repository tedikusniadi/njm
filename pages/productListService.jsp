								...
								<td width="30%" height="30" align="left" valign="middle">
									<div class="toolbar-clean">
										<c:if test='${access.add}'>
                                        	<a class="item-button-new" href="<c:url value='/page/productpreadd.htm?categoryId=4' />"><span>New Product</span></a>
                                        </c:if>
							  			<div dojoType="Toggler" targetId="filter">
											<a class="item-button-search" href="javascript:return;"><span>Filter</span></a>
										</div>
										<a class="item-button-print" href="<c:url value='/page/productprintoption.htm?categoryId=4' />"><span>Print</span></a>
									</div>
								</td>
