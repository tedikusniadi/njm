...
<html>
<head>
	<title>Balance Sheet Trial Filter</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Reports > Financial Accounting > Accounting > Balance Sheet Trial</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">RF79 - Balance Sheet Trial Report</h1>
