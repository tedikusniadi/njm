...
<html>
<head>
	<title>Delivery Order Realization >> Home</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="60%">Sales > Delivery Order Realization</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<tr>
							<th width="5%"><div style="width:15px"></div></th>
  	  	  	  	  	  	  	<th width="12%">ID</th>
  	  	  	  	  	  	  	<th width="14%">DO</th>
						...
						<tr>
							<td class="tools">
								<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/deliveryorderrealizationpreedit.htm?id=${order.id}'/>"><span>Edit</span></a>
                                </c:if>
                                <c:if test='${access.delete and order.deleteable and empty order.issueds}'>
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/deliveryorderrealizationdelete.htm?id=${order.id}'/>');"><span>Delete</span></a>
                                </c:if>
							</td>
