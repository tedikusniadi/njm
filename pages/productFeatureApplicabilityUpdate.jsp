...
<html>
<head>
	<title>Product >> Product Feature Applicability >> Edit</title>
	...
	<script type="text/javascript">
		function save()
		{			
			document.editForm.action = "<c:url value='/page/productfeatureapplicabilityedit.htm'/>";
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Inventory > Product Management > Product > Product Feature Applicability > Edit</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="editForm" name="editForm" method="post" modelAttribute="applicability">
 								<table width="100%" border="0" cellpadding="0" cellspacing="3" id="tableRecord">
 								<tr>
									<td nowrap="nowrap" align="right">Valid From :</td>
									<td><input id="validFrom" name="validFrom" formatLength="long" value="${applicability.validFrom}" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
                                    <form:errors path="validFrom"/>
								</tr>
                                <tr>
									<td nowrap="nowrap" align="right">Valid To :</td>
									<td><input id="validTo" name="validTo" formatLength="long" value="${applicability.validFrom}" dojoType="dropdowndatepicker" lang="en-us" displayFormat="dd-MM-yyyy" saveFormat="dd-MM-yyyy"/></td>
