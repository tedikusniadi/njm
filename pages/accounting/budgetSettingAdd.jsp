						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="budget_add">
                                	...
                                	<td width="56%" valign="top" align="left">
		                                ...
		                                <tr>
			 							...
			 							<tr>
			 							  	...
			 							  	<td>
					  					  		<form:select id="budgetType" path="budgetType" class="combobox">
		                                ...
		                                <tr>
		                                    ...
		                                    <td>
		                                        <form:select path="department" id="department" class="combobox-ext">
		                                        </form:select>
		                                        <img src="assets/icons/list_extensions.gif" onclick="javascript:openpopup('<c:url value='/page/departmentpopup.htm?target=department'/>');" style="CURSOR:pointer;" title="Department" />
		                                    </td>
		                                </tr>
		                                <tr>
	                            ...
	                            <tr>
	                                ...
	                                <th width="25%" colspan="2">Account</th>
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		...
		{
			$.ajax({
				url:"<c:url value='/page/budgetsettingadd.htm'/>",
