			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form id="addForm" name="addForm" method="post" modelAttribute="department_add">
                                	...
                                	<td width="56%" valign="top" align="left">
                                        ...
                                        <tr>
                                            <td width="27%" nowrap="nowrap" align="right">ID :</td>
                                       	  	<td width="73%"><input id="code" name="code" size='25'/></td>
                                        </tr>
                                        <tr>
                                            <td nowrap="nowrap" align="right">Department Name :</td>
                                       	  	<td><input id="name" name="name" size='76'/></td>
                                        </tr>
		                                <tr>
...
$(function()
{
	...
	$('.b_save').click(function(e)
	{
		...
		{
			$.ajax({
				url:"<c:url value='/page/departmentadd.htm'/>",
