...
<head>
	...
	<%@ include file="/filter/plafonFilter.jsp"%>
				...
				<div id="r14">
					<div id="se-contents">
								...
								<td width="30%" height="30" align="left" valign="middle">
                                	<div class="toolbar-clean">
                                    	<c:if test='${access.add}'>
											<a class="item-button-new" href="<c:url value='/page/plafonpreadd.htm' />"><span><spring:message code="new"/></span></a>
							   			</c:if>
                        ...
                        <tr>
                            ...
                            <th width="12%"><spring:message code="id"/></th>
                          	<th width="20%"><spring:message code="name"/></th>
                          	<th width="20%"><spring:message code="facility"/></th>
                          	<th width="10%"><spring:message code="plafon"/></th>
                          	<th width="10%"><spring:message code="plafon"/> Account</th>
                          	<th width="15%"><spring:message code="available"/></th>
                          	<th width="17%"><spring:message code="currency"/></th>
                        </tr>
                        <c:forEach items="${plafons}" var="data">
                        <tr>
                            <td class="tools">
                            	<c:if test='${access.edit}'>
                                	<a class="item-button-edit" href="<c:url value='/page/plafonpreedit.htm?id=${data.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                            </td>
                            <td>${data.code}</td>
                            <td>${data.name}</td>
                            <td>${data.partyRelationship.fromRole.party.firstName}</td>
                            <td><fmt:formatNumber value="${data.plafon}"/></td>
                            <td><fmt:formatNumber value="${data.plafonAccount}"/></td>
                            <td><fmt:formatNumber value="${data.available}"/></td>
