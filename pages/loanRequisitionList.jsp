...
<html>
    <head>
        <title>Loan Requisition >> Home</title>
        <%@ include file="/common/sirius-header.jsp"%>
        <style type="text/css" media="screen"><!-- @import url("assets/sirius.css"); --></style>
        <script type="text/javascript" src="assets/dialog.js"></script>
        <%@ include file="/filter/loanRequisitionFilter.jsp"%>
    </head>
...
<div id="se-containers">
	...
	<div id="se-navigator">	
		...
		<tr>
			<td width="60%">Financial Accounting > Cash Bank Management > Inter Facility Transaction > Loan Requisition</td>
							  ...
							  <table border="0" cellpadding="0" cellspacing="0" width="99%" align="center">
								...
								<td width="30%" height="30" align="left" valign="middle">															
									<div class="toolbar-clean">
										<a class="item-button-new" href="<c:url value='/page/loanrequisitionpreadd.htm' />"><span>New Loan Requisition</span></a>
						...
						<tr>
						 	<td class="tools">
                            	 <c:if test='${access.edit}'>
									<a class="item-button-edit" href="<c:url value='/page/loanrequisitionpreedit.htm?id=${requisition.id}'/>" title="Edit"><span>Edit</span></a>
                                </c:if>
                                <c:if test='${access.delete and requisition.acknowledgement == null}'>
                                	<a class="item-button-delete" href="javascript:deleteDialog('<c:url value='/page/loanrequisitiondelete.htm?id=${requisition.id}'/>');" title="Delete"><span>Delete</span></a>
                                </c:if>
						 	</td>
							...
							<td><c:out value='${requisition.duration}'/></td>
							<td><fmt:formatNumber value='${requisition.amount}' pattern=',##0.00'/></td>
						</tr>
						</c:forEach>
