				...
				<div id="r14">
					<div id="se-contents">
						...
						<h1 class="page-title">${pageTitle}</h1>
					  	...
					  	<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/customermediatorview.htm'/>"><span>List</span></a>
                        ...
                        <div class="main-box">
                        	<form:form id="addForm" name="addForm" method="post" modelAttribute="customer_edit">
	                            ...
	                            <tr>
	                                ...
	                                <td><input disabled size="15" value="<fmt:formatDate value='${party.dateOfBirth}' pattern='dd-MM-yyyy'/>"/></td>
	                            </tr>
	                            <c:if test="${party.type=='person'}">
	                            <tr>
                                ...
                                <div id="address" dojoType="ContentPane" label="Postal Address" class="tab-pages" refreshOnShow="true">
                                    ...
                                    <c:set var="email" value="-"/>
			                            ...
			                            <tr>
			                                ...
			                                <td width="30%"><form:input path="postalAddresses[0].village" type="text" value="${postal.village}" size="30"/></td>
			                                <td width="15%">&nbsp;</td>
			                                <td width="20%">&nbsp;</td>
			                            </tr>
			                            <tr>
