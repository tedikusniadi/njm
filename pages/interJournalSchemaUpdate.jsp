...
<html>
<head>
	<title>Inter Journal Schema >> Edit</title>
...
<div id="se-containers">
	...
	<div id="se-navigator">
		...
		<tr>
			<td width="60%">Financial Accounting > Accounting Setting > Inter Journal Schema > Edit</td>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="main-box">
							<form:form name="editForm" method="post" modelAttribute="journalSchema_edit">
							<table style="border:none" width="100%">
							<tr>
								<td width="21%" align="right">Accounting Schema ID</td>
							  	<td width="1%">:</td>
						  	  	<td width="33%"><form:input path="code" cssClass="inputbox" /></td>
    				  	 		<td width="45%" rowspan="6" valign="top" align="left">
									<fieldset>
                                        ...
                                        <tr>
                                            ...
                                            <td width="2%">:</td>
                                      		<td width="70%">
   											  	<form:select id="org" path="from" cssClass="combobox" disabled='true'>
                                              		<form:option value='${journalSchema_edit.from.id}' label='${journalSchema_edit.from.firstName} ${journalSchema_edit.from.middleName} ${journalSchema_edit.from.lastName}'/>
                                              	</form:select>
                                          </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="2%">:</td>
											<td>
                                                <form:select id="to" path="to" cssClass="combobox" disabled='true'>
                                                	<form:option value='${journalSchema_edit.to.id}' label='${journalSchema_edit.to.firstName} ${journalSchema_edit.to.middleName} ${journalSchema_edit.to.lastName}'/>
                                                </form:select>
                                            </td>
                                        </tr>
                                        </table>
							...
							<tr>
								...
								<td width="1%">:</td>
						  	  	<td width="33%"><form:input path="name" cssClass="inputbox" /></td>
		    				</tr>
							<tr>
...
<script type="text/javascript">
	function save()
	{
		document.editForm.action = "<c:url value='/page/interjournalschemaedit.htm'/>";
