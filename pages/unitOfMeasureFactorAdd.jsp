			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						...
						<div class="toolbar">
							<a class="item-button-list" href="<c:url value='/page/uomPrepareUpdate.htm?id=${unit_of_measure_factor_add.from.id}'/>"><span>List</span></a>
							<a class="item-button-save" style="cursor:pointer;"><span>Save</span></a>
					 	</div>
					  
						<div class="main-box">
							<form:form id="uomForm" name="uomForm" method="post" modelAttribute="unit_of_measure_factor_add">
 							<table width="100%" border="0" cellpadding="3" cellspacing="0">
 							<tr>
							  <td width="247" align="right">From</td>
                              	<td width="4" align="center">:</td>
						  	  <td width="962"><input class="input-disabled" disabled size="35" value="${unit_of_measure_factor_add.from.name}"/></td>
 							</tr>
 							<tr>
                            ...
                            <tr>
                              	...
                              	<td width="4" align="center">:</td>
						  	  	<td width="962"><form:input id='factor' path='factor' size="20" value="1"/></td>
 							</tr>
 							</table>
 							</form:form>
						</div>
	...
	$(function(){
		...
		$('.item-button-save').click(function(){
			...
			$.ajax({
				...
				{
					$dialog.empty();
					$dialog.html('Saving UoM Factor data......');
					$dialog.dialog('open');
				},
