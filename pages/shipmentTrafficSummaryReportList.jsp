...
<html>
<head>
	<title>Shipment Traffic Summary</title>
			...
			<div id="r13">
				<div id="r14">
					<div id="se-contents">
						<div class="area" dojoType="Container" id="quick_link_container">
                            <div class="toolbar">
                                <a class="item-button-back" href="<c:url value='/page/shipmenttrafficreportsummaryadd.htm'/>"><span>Back</span></a>
                                <a class="item-button-print" href="javascript:window.print();"><span>Print</span></a>
                                <a class="item-button-export-xls" href="<c:url value='/page/shipmenttrafficreportsummaryexcel.xls'/>"><span>Export</span></a>
                            </div>
                        </div>
    
                        <div class='main-box'>
                            <div id="main_container">
                                <div class="pageTitle">Traffic Summary Report</div>
                            ...
                            <thead>
                            <tr>
                                <th width="73%" align="left" valign="middle" class="bottom_left_right">Customer</th>
                            ...
                            <tr>
                            	<td><c:out value='${report.customer.firstName} ${report.customer.middleName} ${report.customer.lastName}'/></td>
                            	<td align="right"><fmt:formatNumber value='${report.price}' pattern=',##0.00'/></td>
                            </tr>
                            <c:set var='t_price' value='${t_price+report.price}'/>
                            </c:forEach>
                            <tr>
