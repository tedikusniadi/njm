...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/transferordersparepartview.htm?mode=search'/>";
	...
	function resets()
	{
		window.location = "<c:url value='/page/transferordersparepartview.htm'/>";
	}
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/transferordersparepartview.htm?page='/>"+page;
		document.filterForm.submit();
	}
