...
<script type="text/javascript">		
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/clearreceiptview.htm'/>";
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/clearreceiptview.htm?page='/>"+page;
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 47%; height: 230px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			...
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input id="code" name="code" value="${filterCriteria.code}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
			<td align="right" style="WIDTH:130px;">Receipt ID &nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input id="receipt" name="receipt" value="${filterCriteria.receipt}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
			<td align="right" style="WIDTH:130px;">Customer Name &nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input id="customer" name="customer" value="${filterCriteria.customer}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
