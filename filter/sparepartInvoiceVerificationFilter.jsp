<script type="text/javascript">		
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/sparepartinvoiceverificationview.htm'/>";
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/sparepartinvoiceverificationview.htm?page='/>"+page;
