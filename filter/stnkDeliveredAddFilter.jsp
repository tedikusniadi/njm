...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/stnkdeliveredpreaddone.htm'/>";
	...
	function resets()
	{
		window.location = "<c:url value='/page/stnkdeliveredpreaddone.htm'/>";
	}
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/stnkdeliveredpreaddone.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
