...
<script type="text/javascript">		
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/pphview.htm'/>";
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/pphview.htm?page='/>"+page;
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 47%; height: 220px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			<td align="right" style="WIDTH:130px;">Billing &nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input type="text" id="billing" name="billing" value="${filterCriteria.billing}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
