<script type="text/javascript">		
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/unitinvoiceverificationdealerview.htm'/>";
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/unitinvoiceverificationdealerview.htm?page='/>"+page;
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 47%; height: 230px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			<td align="right" style="WIDTH:130px;">Supplier Name &nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input id="supplier" name="supplier" value="${filterCriteria.supplier}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
