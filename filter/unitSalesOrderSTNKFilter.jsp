...
<script type="text/javascript">
	function searchs()
	{
		document.filterFormStnk.action = "<c:url value='/page/stnkpreaddone.htm'/>";
		document.filterFormStnk.submit();
	}

	function resets()
	{	
		var url = "<c:url value='/page/stnkpreaddone.htm'/>";
		window.location = url;
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/stnkpreaddone.htm?page='/>"+page;

		document.filterFormStnk.action = url;
		document.filterFormStnk.submit();
	}
	...
	function opensalescustomer(target)
	{
		/* var org = document.getElementById('org');
		if(org.value == '')
		{
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 47%; height: 250px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterFormStnk" name="filterFormStnk" method="post">
		...
		<tr>
			...
			<td width="310" height="28">
            	...
            	&nbsp;
				<img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="opensalescustomer('customer');" style="CURSOR:pointer;" title="Customer" />
			</td>
		</tr>
		<tr>
			<td align="right" style="WIDTH:130px;">Nama STNK&nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td width="310" height="28">
				<select id="customerUnit" name="customerUnit" class="combobox-ext">
				</select>
            	&nbsp;
				<img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="opensalescustomer('customerUnit');" style="CURSOR:pointer;" title="Customer" />
			</td>
		</tr>
		<tr>
