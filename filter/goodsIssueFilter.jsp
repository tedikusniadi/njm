...
<script type="text/javascript">
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/goodsissueview.htm'/>";
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 35%; height: 230px; left: 425px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			...
			<td>:</td>
			<td width="304" height="28"><input id="reference" name="reference" value="${filterCriteria.reference}" size="35"/></td>
		</tr>
		<tr>
