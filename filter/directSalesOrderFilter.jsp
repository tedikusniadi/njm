...
<script type="text/javascript">
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/directsalesorderview.htm'/>";
		document.filterForm.submit();
	}

	function resets()
	{	
		var url = "<c:url value='/page/directsalesorderview.htm'/>";
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/directsalesorderview.htm?page='/>"+page;
