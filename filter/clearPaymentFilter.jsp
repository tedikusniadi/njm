...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/clearpaymentview.htm'/>";
	...
	function resets()
	{
		window.location = "<c:url value='/page/clearpaymentview.htm'/>";
	}
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/clearpaymentview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 48%; height: 300px; left: 350px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			...
			<td>:&nbsp;</td>
			<td><input type="text" id="payment" name="payment" value="${filterCriteria.payment}" size="35" class="inputbox"/></td>
		</tr>
		<tr>
