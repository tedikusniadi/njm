...
<script type="text/javascript">
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/productstandardpriceserviceview.htm'/>";
		document.filterForm.submit();
	}

	function resets()
	{	
		var url = "<c:url value='/page/productstandardpriceserviceview.htm'/>";
		window.location = url;
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/productstandardpriceserviceview.htm?page='/>"+page;
