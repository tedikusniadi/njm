...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/unitsalesordersubdealerview.htm?mode=search'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/unitsalesordersubdealerview.htm?page='/>"+page;
		document.filterForm.submit();
	}
