...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/prepaymentview.htm'/>";
	...
	function resets()
	{
		window.location = "<c:url value='/page/prepaymentview.htm'/>";
	}
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/prepaymentview.htm?page="+page+"'/>";
		document.filterForm.submit();
	}
</script>	
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 48%; height: 200px; left: 350px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
        ...
        <tr>
			...
			<td>:&nbsp;</td>
			<td><input type="text" id="supplier" name="customer" value="${filterCriteria.customer}" size="35" class="inputbox"/></td>
		</tr>
		<tr>
