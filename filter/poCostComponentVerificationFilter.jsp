...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/purchaseordercostcomponentverificationview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/purchaseordercostcomponentverificationview.htm?page='/>"+page;
		document.filterForm.submit();
	}
