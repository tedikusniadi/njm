...
<script type="text/javascript">
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/unitsalesordersubdictionview.htm'/>";
		document.filterForm.submit();
	}

	function resets()
	{	
		var url = "<c:url value='/page/unitsalesordersubdictionview.htm'/>";
		window.location = url;
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/unitsalesordersubdictionview.htm?page='/>"+page;
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 47%; height: 250px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			...
			<td width="4">:&nbsp;</td>
			<td width="310" height="28">
				<select id="unitType" name="unitType" class="combobox-ext">
				</select>
            	&nbsp;
		...
		<tr>
			<td align="right" style="WIDTH:130px;">Tipe Subsidi</td>
			<td width="4">:&nbsp;</td>
			<td width="310" height="28">
				<select id="categoryType" name="categoryType" class="combobox-ext">
					<option value="" label=""/>
					<option value="DISC_DEALER">Diskon Dealer</option>
					<option value="DISC_PROGRAM">Diskon Program</option>
