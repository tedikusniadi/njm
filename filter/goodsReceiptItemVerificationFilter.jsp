...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/goodsreceiptitemverificationview.htm?mode=search'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/goodsreceiptitemverificationview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 35%; height: 230px; left: 425px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			...
			<td>:</td>
			<td width="304" height="28"><input type="text" id="serial" name="serial" value="${filterCriteria.serial}" size="35" class="inputbox"/></td>
		</tr>
		<tr>
			<td align="right">No Rangka&nbsp;&nbsp;</td>
			<td>:</td>
			<td width="304" height="28"><input type="text" id="serialExt1" name="serialExt1" value="${filterCriteria.serialExt1}" size="35" class="inputbox"/></td>
		</tr>
		<tr>
