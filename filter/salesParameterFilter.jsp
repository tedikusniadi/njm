...
<script type="text/javascript">
	function searchs()
	{
		document.filterSalesForm.action = "<c:url value='/page/salesparameterview.htm'/>";
		document.filterSalesForm.submit();
	}

	function resets()
	{
		var url = "<c:url value='/page/salesparameterview.htm'/>";
		window.location = url;
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/salesparameterview.htm?page='/>"+page;
