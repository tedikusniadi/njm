...
<script type="text/javascript">
	function searchs()
	{
		document.filterSalesForm.action = "<c:url value='/page/unitsalesorderview.htm'/>";
		document.filterSalesForm.submit();
	}

	function resets()
	{
		var url = "<c:url value='/page/unitsalesorderview.htm'/>";
		window.location = url;
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/unitsalesorderview.htm?page='/>"+page;

		document.filterSalesForm.action = url;
		document.filterSalesForm.submit();
	}
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 35%; height: 270px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterSalesForm" name="filterSalesForm" method="post">
		<table width="100%" cellspacing="0" cellpadding="0" align="right">
		<tr>
			<td align="right" style="WIDTH:170px;">ID &nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
		...
		<tr>
			<td align="right" style="WIDTH:170px;">Company &nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input type="text" id="organizationName" name="organizationName" value="${filterCriteria.organizationName}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
			<td align="right" style="WIDTH:170px;">Sales Person &nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input type="text" id="salesPersonName" name="salesPersonName" value="${filterCriteria.salesPersonName}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
			<td align="right" style="WIDTH:170px;">Customer &nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
