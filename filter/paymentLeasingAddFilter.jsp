...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/paymentleasingpreprocessone.htm'/>";
	...
	function resets()
	{
		window.location = "<c:url value='/page/paymentleasingpreprocessone.htm'/>";
	}
	...
	function step(action)
	{
		...
		document.filterFormleasing.action = "<c:url value='/page/paymentleasingpreprocessone.htm?page='/>"+page;
		document.filterFormleasing.submit();
	}
</script>
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 40%; height: 220px; left: 100px; display:none;" toggle="explode" bg>
