<div dojoType="FloatingPane" id="filter" title='Filter' constrainToContainer="true" style="width: 30%; height: 200px; left: 350px; display:none;" toggle="explode" bg>
	...
	<tr>
		<td align="right">Address Name</td>
		<td align="center">:&nbsp;</td>
		<td ><input name="subject" class="inputbox" style="font-weight: bold;" value="${filterCriteria.addressName}"/></td>
	</tr>
	<tr>
...
<script type="text/javascript">
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/sendmailaddressview.htm'/>";
		document.filterForm.submit();
	}

	function resets()
	{
		var url = "<c:url value='/page/sendmailaddressview.htm'/>";
		window.location = url;
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/sendmailaddressview.htm?page='/>"+page;
