...
<script type="text/javascript">
	function searchs()
	{
		document.filterPriceForm.action = "<c:url value='/page/noticeandserviceview.htm?service=true'/>";
		document.filterPriceForm.submit();
	}

	function resets()
	{	
		var url = "<c:url value='/page/noticeandserviceview.htm?service=true'/>";
		window.location = url;
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/noticeandserviceview.htm?service=true&page='/>"+page;
