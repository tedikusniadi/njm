...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/unitservicetransactionbillingview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/unitservicetransactionbillingview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 48%; height: 230px; left: 350px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			<td align="right">Billing Code&nbsp;&nbsp;</td>
			<td>:&nbsp;</td>
