...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/bbnapproval.htm'/>";
	...
	function resets()
	{
		window.location = "<c:url value='/page/bbnapproval.htm'/>";
	}
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/bbnapproval.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 38%; height: 240px; left: 350px; display:none;" toggle="explode" bg>
