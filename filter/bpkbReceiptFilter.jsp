...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/bpkbreceiptview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/bpkbreceiptview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 38%; height: 160px; left: 350px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			<td align="right">Nama STNK / BPKB&nbsp;&nbsp;</td>
			<td>:&nbsp;</td>
			<td><input type="text" id="customerUnit" name="customerUnitName" value="${filterCriteria.customerUnitName}" size="35" class="inputbox"/></td>
		</tr>
		<%-- <tr>
