...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/stnkdeliveredview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/stnkdeliveredview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 38%; height: 320px; left: 350px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			<td align="right">Nama Tipe / Tipe&nbsp;&nbsp;</td>
			<td>:&nbsp;</td>
