...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/vehicleview.htm?mode=search'/>";
	...
	function resets()
	{
		...
		var url = "<c:url value='/page/vehicleview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/vehicleview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
