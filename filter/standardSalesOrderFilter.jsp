...
<script type="text/javascript">
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/standardsalesorderview.htm'/>";
	...
	function resets()
	{
		...
		var url = "<c:url value='/page/standardsalesorderview.htm'/>";
		window.location = url;
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/standardsalesorderview.htm?page='/>"+page;
	...
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			...
			<td width="310" height="28">
            	...
            	&nbsp;
				<img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="opensalesperson();" style="CURSOR:pointer;" title="Company Structure" />
			</td>
		</tr>
		<tr>
