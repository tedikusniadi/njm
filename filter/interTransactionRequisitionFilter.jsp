...
<script type="text/javascript">		
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/intertransactionrequisitionview.htm'/>";
		document.filterForm.submit();
	}
		
	function resets()
	{
		window.location = "<c:url value='/page/intertransactionrequisitionview.htm'/>";
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/intertransactionrequisitionview.htm?page='/>"+page;
