...
<script type="text/javascript">		
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/interfacilitypaymentclearingview.htm'/>";
		document.filterForm.submit();
	}
		
	function resets()
	{
		window.location = "<c:url value='/page/interfacilitypaymentclearingview.htm'/>";
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/interfacilitypaymentclearingview.htm?page='/>"+page;
		
		document.filterForm.action = url;
		document.filterForm.submit();
	}
</script>
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 47%; height: 200px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			<td align="right" style="WIDTH:130px;">Payment ID &nbsp;&nbsp;</td>
			<td width="4">:&nbsp;</td>
			<td width="411" height="28"><input type="text" id="payment" name="payment" value="${filterCriteria.payment}" size="30" class="inputbox"/></td>
		</tr>
		<tr>
