<script type="text/javascript">
			function searchs()
			{
				document.filterForm.action = "<c:url value='/page/organizationview.htm?mode=search'/>";
			...
			function resets()
			{
				...
				document.filterForm.action = "<c:url value='/page/organizationview.htm'/>";
				document.filterForm.submit();
			}
			...
			function step(action)
			{
				...
				document.filterForm.action = "<c:url value='/page/organizationview.htm?mode=${mode}&page='/>"+page;
				document.filterForm.submit();
			}
		</script>
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 55%; height: 150px; left: 300px; display:none;" toggle="explode" bg>
