...
<script type="text/javascript">
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/salesreturnview.htm'/>";
	...
	function resets()
	{
		...
		var url = "<c:url value='/page/salesreturnview.htm'/>";
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/salesreturnview.htm?page='/>"+page;
		document.filterForm.action = url;
		document.filterForm.submit();
	}
</script>	
