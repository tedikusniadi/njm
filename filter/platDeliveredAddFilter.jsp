...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/platdeliveredpreaddone.htm'/>";
	...
	function resets()
	{
		window.location = "<c:url value='/page/platdeliveredpreaddone.htm'/>";
	}
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/platdeliveredpreaddone.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
