...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/ext1purchaseorderview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/ext1purchaseorderview.htm?page='/>"+page;
		document.filterForm.submit();
	}
	...
	function openpurchaser()
	{
		...
		openpopup("<c:url value='/page/popuppurchaserview.htm?target=supplier&organization='/>"+org.value);
	}
	...
	<form id="filterForm" name="filterForm" method="post">
        ...
        <tr>
			...
			<td>
            	...
            	&nbsp;
				<img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="openpurchaser();" style="CURSOR:pointer;" title="Supplier" />
            </td>
		</tr>
		<tr>
