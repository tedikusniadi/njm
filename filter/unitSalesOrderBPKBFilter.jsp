...
<script type="text/javascript">
	function searchs()
	{
		document.filterFormBpkb.action = "<c:url value='/page/bpkbpreaddone.htm'/>";
		document.filterFormBpkb.submit();
	}

	function resets()
	{	
		var url = "<c:url value='/page/bpkbpreaddone.htm'/>";
		window.location = url;
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/bpkbpreaddone.htm?page='/>"+page;

		document.filterFormBpkb.action = url;
		document.filterFormBpkb.submit();
	}
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 47%; height: 250px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterFormBpkb" name="filterFormBpkb" method="post">
