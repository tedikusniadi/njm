...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/unitinvoicemaindealerapprovalview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/unitinvoicemaindealerapprovalview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
