...
<script type="text/javascript">		
		function searchs()
		{
			var url = "<c:url value='/page/interjournalfromview.htm?mode=search'/>";
		...
		function resets()
		{
			...
			var url = "<c:url value='/page/interjournalfromview.htm'/>";
		...
		function step(action)
		{
			...
			var url = "<c:url value='/page/interjournalfromview.htm?mode=${mode}&page='/>"+page;
			
			document.filterForm.action = url;
			document.filterForm.submit();
		}
	</script>
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 40%; height: 230px; left: 370px; display:none;" toggle="explode" bg>
<form id="filterForm" name="filterForm" method="post">
	...
	<tr>
		...
		<td width="310" height="28">
            ...
            &nbsp;
			<img src="<c:url value='/assets/icons/list_extensions.gif'/>" onclick="javascript:openpopup('<c:url value='/page/popupcompanystructurerolebasedview.htm?target=orgfrom'/>');" style="CURSOR:pointer;" title="Company Structure" />
		</td>
	</tr>
	<tr>
