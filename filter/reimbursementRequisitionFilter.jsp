...
<script type="text/javascript">		
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/reimbursementrequisitionview.htm'/>";
		document.filterForm.submit();
	}
		
	function resets()
	{
		window.location = "<c:url value='/page/reimbursementrequisitionview.htm'/>";
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/reimbursementrequisitionview.htm?page='/>"+page;
		
		document.filterForm.action = url;
		document.filterForm.submit();
	}
</script>
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 47%; height: 150px; left: 400px; display:none;" toggle="explode" bg>
