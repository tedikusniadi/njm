...
<script type="text/javascript">		
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/reimbursementview.htm'/>";
		document.filterForm.submit();
	}
		
	function resets()
	{
		window.location = "<c:url value='/page/reimbursementview.htm'/>";
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/reimbursementview.htm?page='/>"+page;
