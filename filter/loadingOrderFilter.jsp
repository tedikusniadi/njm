...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/loadingorderview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/loadingorderview.htm?page='/>"+page;
		document.filterForm.submit();
	}
</script>	
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 35%; height: 230px; left: 425px; display:none;" toggle="explode" bg>
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			...
			<td>:</td>
			<td width="304" height="28"><input type="text" id="po" name="po" value="${filterCriteria.po}" size="35" class="inputbox"/></td>
		</tr>
		<tr>
