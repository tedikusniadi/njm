...
<script type="text/javascript">		
	function searchs()
	{
		document.filterForm.action = "<c:url value='/page/loanrequisitionview.htm'/>";
		document.filterForm.submit();
	}
		
	function resets()
	{
		window.location = "<c:url value='/page/loanrequisitionview.htm'/>";
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/loanrequisitionview.htm?page='/>"+page;
