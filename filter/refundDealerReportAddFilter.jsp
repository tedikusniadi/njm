...
<script type="text/javascript">
	function searchs()
	{
		document.filterFormRefund.action = "<c:url value='/page/refunddealerreportpreaddtwo.htm'/>";
		document.filterFormRefund.submit();
	}

	function resets()
	{	
		var url = "<c:url value='/page/refunddealerreportpreaddtwo.htm'/>";
		window.location = url;
	}
	...
	function step(action)
	{
		...
		var url = "<c:url value='/page/refunddealerreportpreaddtwo.htm?page='/>"+page;

		document.filterFormRefund.action = url;
		document.filterFormRefund.submit();
	}
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 35%; height: 200px; left: 400px; display:none;" toggle="explode" bg>
	<form id="filterFormRefund" name="filterFormRefund" method="post">
