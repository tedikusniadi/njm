...
<script type="text/javascript">
	function searchs()
	{
		var url = "<c:url value='/page/sparepartpurchaserequisitionview.htm'/>";
	...
	function step(action)
	{
		...
		document.filterForm.action = "<c:url value='/page/sparepartpurchaserequisitionview.htm?page='/>"+page;
		document.filterForm.submit();
	}
...
<div dojoType="FloatingPane" id="filter" title="Filter" constrainToContainer="true" style="width: 48%; height: 250px; left: 350px; display:none;" toggle="explode">
	<form id="filterForm" name="filterForm" method="post">
		...
		<tr>
			<td align="right" height="28">ID&nbsp;&nbsp;</td>
			<td>:&nbsp;</td>
		...
		<tr>
            <td align="right" height="28">Date From &nbsp;&nbsp;</td>
            <td>:&nbsp;</td>
            <td>
